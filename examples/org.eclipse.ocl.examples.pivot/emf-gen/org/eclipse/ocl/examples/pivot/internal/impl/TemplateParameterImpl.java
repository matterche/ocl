...
import org.eclipse.ocl.examples.pivot.bodies.TemplateParameterBodies;
	...
	public boolean validateMustBeCompatible(DiagnosticChain diagnostics,
		...
		*/
		try {
			...
			final Value result = TemplateParameterBodies._invariant_must_be_compatible.INSTANCE.evaluate(evaluator, returnType, self);
			...
			if (diagnostics != null) {
			    ...
			    diagnostics.add(new BasicDiagnostic(severity, PivotValidator.DIAGNOSTIC_SOURCE, PivotValidator.TEMPLATE_PARAMETER__MUST_BE_COMPATIBLE, message, new Object [] { this }));
			}
			return false;
		} catch (InvalidValueException e) {
			throw new WrappedException("Failed to evaluate org.eclipse.ocl.examples.pivot.bodies.TemplateParameterBodies", e);
		}
