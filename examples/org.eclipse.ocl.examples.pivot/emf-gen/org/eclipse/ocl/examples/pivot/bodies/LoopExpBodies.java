	...
	public static class _invariant_NoInitializers extends AbstractUnaryOperation
	{
		...
		*/
		public Value evaluate(DomainEvaluator evaluator, DomainType returnType, final Value self) throws InvalidValueException {
			...
			Value A_symbol_329 = IP_LoopExp_iterator.evaluate(evaluator, T_OrderedSet_Pivot_ecore__pivot__Variable_, self, P_LoopExp_iterator);
			
			
			/** 
			 * Implementation of the iterator body.
			 */
			AbstractBinaryOperation body_A_symbol_330 = new AbstractBinaryOperation()
			{
			/*
			...
			*/
				public Value evaluate(DomainEvaluator evaluator, DomainType returnType, Value sourceValue, Value iterator1) throws InvalidValueException {
					...
					Value A_symbol_331 = IP_Variable_initExpression.evaluate(evaluator, T_Pivot_ecore__pivot__OclExpression, V_1_, P_Variable_initExpression);
					
					DomainType static_A_symbol_332 = valueFactory.typeOf(A_symbol_331);
					LibraryUnaryOperation dynamic_A_symbol_332 = (LibraryUnaryOperation)static_A_symbol_332.lookupImplementation(standardLibrary, O_OclAny_oclAsSet);
					Value A_symbol_332 = dynamic_A_symbol_332.evaluate(evaluator, T_Set_Pivot_ecore__pivot__OclExpression_, A_symbol_331);
					DomainType static_A_symbol_333 = valueFactory.typeOf(A_symbol_332);
					LibraryUnaryOperation dynamic_A_symbol_333 = (LibraryUnaryOperation)static_A_symbol_333.lookupImplementation(standardLibrary, O_Collection_isEmpty);
					Value A_symbol_333 = dynamic_A_symbol_333.evaluate(evaluator, T_Boolean, A_symbol_332);
					return A_symbol_333;
				}
			};
			DomainType static_A_symbol_330 = A_symbol_329.getType();
			LibraryIteration dynamic_A_symbol_330 = (LibraryIteration)static_A_symbol_330.lookupImplementation(standardLibrary, O_Collection_forAll);
			Value acc_A_symbol_330 = dynamic_A_symbol_330.createAccumulatorValue(evaluator, T_Boolean, T_Boolean);
			ExecutorSingleIterationManager manager_A_symbol_330 = new ExecutorSingleIterationManager(evaluator, T_Boolean, body_A_symbol_330, (CollectionValue)A_symbol_329, acc_A_symbol_330);
			Value A_symbol_330 = dynamic_A_symbol_330.evaluateIteration(manager_A_symbol_330);
			return A_symbol_330;
		}
	}
	...
	public static class _invariant_SourceIsCollection extends AbstractUnaryOperation
	{
		...
		*/
		public Value evaluate(DomainEvaluator evaluator, DomainType returnType, final Value self) throws InvalidValueException {
			...
			LibraryBinaryOperation dynamic_A_symbol_336 = (LibraryBinaryOperation)static_A_symbol_336.lookupImplementation(standardLibrary, O_OclAny_oclIsKindOf);
			Value A_symbol_336 = dynamic_A_symbol_336.evaluate(evaluator, T_Boolean, A_symbol_335, T_ClassClassifier_Pivot_ecore__pivot__CollectionType_);
			return A_symbol_336;
		}
	}
