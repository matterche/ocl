 ...
 * </copyright>
 *
 * $Id: IterateExpImpl.java,v 1.1.2.1 2010/10/01 13:49:57 ewillink Exp $
 */
 ...
 *   <li>{@link org.eclipse.ocl.examples.pivot.internal.impl.IterateExpImpl#getReferredIterate <em>Referred Iterate</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IterateExpImpl extends LoopExpImpl implements IterateExp
{
	...
	/**
	 * The cached value of the '{@link #getReferredIterate() <em>Referred Iterate</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected Iterate referredIterate;
	...
	public Iterate getReferredIterate()
	{
		if (referredIterate != null && ((EObject)referredIterate).eIsProxy())
		{
			...
			referredIterate = (Iterate)eResolveProxy(oldReferredIterate);
			if (referredIterate != oldReferredIterate)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PivotPackage.ITERATE_EXP__REFERRED_ITERATE, oldReferredIterate, referredIterate));
			}
		}
	...
	public void setReferredIterate(Iterate newReferredIterate)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PivotPackage.ITERATE_EXP__REFERRED_ITERATE, oldReferredIterate, referredIterate));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			...
			case PivotPackage.ITERATE_EXP__REFERRED_ITERATE:
				if (resolve) return getReferredIterate();
				return basicGetReferredIterate();
		}
	...
	public void eSet(int featureID, Object newValue)
	{
		switch (featureID)
		{
			...
			case PivotPackage.ITERATE_EXP__RESULT:
				...
				return;
			case PivotPackage.ITERATE_EXP__REFERRED_ITERATE:
				setReferredIterate((Iterate)newValue);
				return;
		}
	...
	public void eUnset(int featureID)
	{
		switch (featureID)
		{
			...
			case PivotPackage.ITERATE_EXP__RESULT:
				...
				return;
			case PivotPackage.ITERATE_EXP__REFERRED_ITERATE:
				setReferredIterate((Iterate)null);
				return;
		}
