	...
	public static class _isCompatibleWith_body_ extends AbstractBinaryOperation
	{
		...
		*/
		public Value evaluate(DomainEvaluator evaluator, DomainType returnType, final Value self, final Value p) throws InvalidValueException {
			...
			DomainType static_A_symbol_169 = valueFactory.typeOf(self);
			LibraryUnaryOperation dynamic_A_symbol_169 = (LibraryUnaryOperation)static_A_symbol_169.lookupImplementation(standardLibrary, O_OclAny_oclType);
			Value A_symbol_169 = dynamic_A_symbol_169.evaluate(evaluator, T_AnyClassifier_Pivot_ecore__pivot__ParameterableElement_, self);
			DomainType static_A_symbol_170 = valueFactory.typeOf(p);
			...
			Value A_symbol_170 = dynamic_A_symbol_170.evaluate(evaluator, T_Boolean, p, A_symbol_169);
			return A_symbol_170;
		}
	}
