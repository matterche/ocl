	...
	public static class _isCompatibleWith_body_ extends AbstractBinaryOperation
	{
		...
		*/
		public Value evaluate(DomainEvaluator evaluator, DomainType returnType, final Value self, final Value p) throws InvalidValueException {
			...
			LibraryUnaryOperation dynamic_A_symbol_388 = (LibraryUnaryOperation)static_A_symbol_388.lookupImplementation(standardLibrary, O_OclAny_oclType);
			Value A_symbol_388 = dynamic_A_symbol_388.evaluate(evaluator, T_AnyClassifier_Pivot_ecore__pivot__ParameterableElement_, self);
			DomainType static_A_symbol_389 = valueFactory.typeOf(p);
			LibraryBinaryOperation dynamic_A_symbol_389 = (LibraryBinaryOperation)static_A_symbol_389.lookupImplementation(standardLibrary, O_OclAny_oclIsKindOf);
			Value A_symbol_389 = dynamic_A_symbol_389.evaluate(evaluator, T_Boolean, p, A_symbol_388);
			return A_symbol_389;
		}
	}
