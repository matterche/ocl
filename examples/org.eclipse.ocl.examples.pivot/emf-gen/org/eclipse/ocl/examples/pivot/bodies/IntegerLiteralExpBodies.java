	...
	public static class _invariant_TypeIsInteger extends AbstractUnaryOperation
	{
		...
		*/
		public Value evaluate(DomainEvaluator evaluator, DomainType returnType, final Value self) throws InvalidValueException {
			...
			DomainType static_A_symbol_387 = valueFactory.typeOf(A_symbol_386, T_ClassClassifier_Integer_);
			LibraryBinaryOperation dynamic_A_symbol_387 = (LibraryBinaryOperation)static_A_symbol_387.lookupImplementation(standardLibrary, O_OclAny__eq_);
			Value A_symbol_387 = dynamic_A_symbol_387.evaluate(evaluator, T_Boolean, A_symbol_386, T_ClassClassifier_Integer_);
			return A_symbol_387;
		}
	}
