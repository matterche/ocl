 ...
 * Do not edit it.
 *
 * $Id: OclMetaModel.java,v 1.1.2.7 2011/01/13 20:19:04 ewillink Exp $
 */
...
public class OclMetaModel extends XMLResourceImpl
{
	...
	public static Package create(StandardLibrary standardLibrary)
	{
		...
		Class symbol_21 = PivotFactory.eINSTANCE.createClass(); // pivot|CallableImplementation
		...
		Class symbol_31 = PivotFactory.eINSTANCE.createClass(); // pivot|CollectionKind
		...
		Class symbol_44 = PivotFactory.eINSTANCE.createClass(); // pivot|CompleteEnvironment
		
		Class symbol_45 = PivotFactory.eINSTANCE.createClass(); // pivot|CompleteIteration
		Property symbol_46 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::CompleteIteration::completeAccumulator pivot|CompleteIteration|completeAccumulator
		Property symbol_47 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::CompleteIteration::completeEnvironment pivot|CompleteIteration|completeEnvironment
		Property symbol_48 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::CompleteIteration::completeIterator pivot|CompleteIteration|completeIterator
		Property symbol_49 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::CompleteIteration::completeParameter pivot|CompleteIteration|completeParameter
		Property symbol_50 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::CompleteIteration::model pivot|CompleteIteration|model
		
		Class symbol_51 = PivotFactory.eINSTANCE.createClass(); // pivot|CompleteOperation
		Property symbol_52 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::CompleteOperation::completeEnvironment pivot|CompleteOperation|completeEnvironment
		Property symbol_53 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::CompleteOperation::completeParameter pivot|CompleteOperation|completeParameter
		Property symbol_54 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::CompleteOperation::model pivot|CompleteOperation|model
		
		Class symbol_55 = PivotFactory.eINSTANCE.createClass(); // pivot|CompletePackage
		Property symbol_56 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::CompletePackage::completeEnvironment pivot|CompletePackage|completeEnvironment
		Property symbol_57 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::CompletePackage::completePackage pivot|CompletePackage|completePackage
		Property symbol_58 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::CompletePackage::completeType pivot|CompletePackage|completeType
		Property symbol_59 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::CompletePackage::model pivot|CompletePackage|model
		
		Class symbol_60 = PivotFactory.eINSTANCE.createClass(); // pivot|CompleteProperty
		Property symbol_61 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::CompleteProperty::completeEnvironment pivot|CompleteProperty|completeEnvironment
		Property symbol_62 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::CompleteProperty::model pivot|CompleteProperty|model
		
		Class symbol_63 = PivotFactory.eINSTANCE.createClass(); // pivot|CompleteType
		Property symbol_64 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::CompleteType::completeEnvironment pivot|CompleteType|completeEnvironment
		Property symbol_65 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::CompleteType::completeOperation pivot|CompleteType|completeOperation
		Property symbol_66 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::CompleteType::completeProperty pivot|CompleteType|completeProperty
		Property symbol_67 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::CompleteType::completeSuperType pivot|CompleteType|completeSuperType
		Property symbol_68 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::CompleteType::model pivot|CompleteType|model
		
		Class symbol_69 = PivotFactory.eINSTANCE.createClass(); // pivot|Constraint
		Property symbol_70 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::Constraint::constrainedElement pivot|Constraint|constrainedElement
		Property symbol_71 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::Constraint::context pivot|Constraint|context
		Property symbol_72 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::Constraint::specification pivot|Constraint|specification
		Property symbol_73 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::Constraint::stereotype pivot|Constraint|stereotype
		
		Class symbol_74 = PivotFactory.eINSTANCE.createClass(); // pivot|DataType
		...
		Property symbol_90 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::ExpressionInOcl::parameterVariable pivot|ExpressionInOcl|parameterVariable
		Property symbol_91 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::ExpressionInOcl::resultVariable pivot|ExpressionInOcl|resultVariable
		
		Class symbol_92 = PivotFactory.eINSTANCE.createClass(); // pivot|Feature
		Property symbol_93 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::Feature::featuringClass pivot|Feature|featuringClass
		
		Class symbol_94 = PivotFactory.eINSTANCE.createClass(); // pivot|FeatureCallExp
		Property symbol_95 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::FeatureCallExp::isPre pivot|FeatureCallExp|isPre
		
		Class symbol_96 = PivotFactory.eINSTANCE.createClass(); // pivot|IfExp
		Property symbol_97 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::IfExp::condition pivot|IfExp|condition
		Property symbol_98 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::IfExp::elseExpression pivot|IfExp|elseExpression
		Property symbol_99 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::IfExp::thenExpression pivot|IfExp|thenExpression
		
		Class symbol_100 = PivotFactory.eINSTANCE.createClass(); // pivot|ImplementableElement
		Property symbol_101 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::ImplementableElement::implementation pivot|ImplementableElement|implementation
		Property symbol_102 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::ImplementableElement::implementationClass pivot|ImplementableElement|implementationClass
		...
		Property symbol_193 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::Property::isComposite pivot|Property|isComposite
		Property symbol_194 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::Property::isDerived pivot|Property|isDerived
		Property symbol_195 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::Property::isID pivot|Property|isID
		Property symbol_196 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::Property::isReadOnly pivot|Property|isReadOnly
		Property symbol_197 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::Property::isResolveProxies pivot|Property|isResolveProxies
		Property symbol_198 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::Property::isTransient pivot|Property|isTransient
		Property symbol_199 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::Property::isUnsettable pivot|Property|isUnsettable
		Property symbol_200 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::Property::isVolatile pivot|Property|isVolatile
		Property symbol_201 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::Property::keys pivot|Property|keys
		Property symbol_202 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::Property::opposite pivot|Property|opposite
		
		Class symbol_203 = PivotFactory.eINSTANCE.createClass(); // pivot|PropertyCallExp
		Property symbol_204 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::PropertyCallExp::referredProperty pivot|PropertyCallExp|referredProperty
		
		PrimitiveType symbol_205 = standardLibrary.getRealType(); // pivot|Real
		Class symbol_206 = PivotFactory.eINSTANCE.createClass(); // pivot|RealLiteralExp
		Property symbol_207 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::RealLiteralExp::realSymbol pivot|RealLiteralExp|realSymbol
		
		Class symbol_208 = PivotFactory.eINSTANCE.createClass(); // pivot|SendSignalAction
		Property symbol_209 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::SendSignalAction::signal pivot|SendSignalAction|signal
		
		Class symbol_210 = PivotFactory.eINSTANCE.createClass(); // pivot|SequenceType
		
		Class symbol_211 = PivotFactory.eINSTANCE.createClass(); // pivot|SetType
		
		Class symbol_212 = PivotFactory.eINSTANCE.createClass(); // pivot|Signal
		
		Class symbol_213 = PivotFactory.eINSTANCE.createClass(); // pivot|State
		
		Class symbol_214 = PivotFactory.eINSTANCE.createClass(); // pivot|StateExp
		Property symbol_215 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::StateExp::referredState pivot|StateExp|referredState
		
		PrimitiveType symbol_216 = standardLibrary.getStringType(); // pivot|String
		Class symbol_217 = PivotFactory.eINSTANCE.createClass(); // pivot|StringLiteralExp
		Property symbol_218 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::StringLiteralExp::stringSymbol pivot|StringLiteralExp|stringSymbol
		
		Class symbol_219 = PivotFactory.eINSTANCE.createClass(); // pivot|TemplateBinding
		Property symbol_220 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::TemplateBinding::boundElement pivot|TemplateBinding|boundElement
		Property symbol_221 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::TemplateBinding::parameterSubstitution pivot|TemplateBinding|parameterSubstitution
		Property symbol_222 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::TemplateBinding::signature pivot|TemplateBinding|signature
		
		Class symbol_223 = PivotFactory.eINSTANCE.createClass(); // pivot|TemplateParameter
		Property symbol_224 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::TemplateParameter::default pivot|TemplateParameter|default
		Property symbol_225 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::TemplateParameter::ownedDefault pivot|TemplateParameter|ownedDefault
		Property symbol_226 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::TemplateParameter::ownedParameteredElement pivot|TemplateParameter|ownedParameteredElement
		Property symbol_227 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::TemplateParameter::parameteredElement pivot|TemplateParameter|parameteredElement
		Property symbol_228 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::TemplateParameter::signature pivot|TemplateParameter|signature
		
		Class symbol_229 = PivotFactory.eINSTANCE.createClass(); // pivot|TemplateParameterSubstitution
		Property symbol_230 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::TemplateParameterSubstitution::actual pivot|TemplateParameterSubstitution|actual
		Property symbol_231 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::TemplateParameterSubstitution::formal pivot|TemplateParameterSubstitution|formal
		Property symbol_232 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::TemplateParameterSubstitution::ownedActual pivot|TemplateParameterSubstitution|ownedActual
		Property symbol_233 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::TemplateParameterSubstitution::templateBinding pivot|TemplateParameterSubstitution|templateBinding
		
		Class symbol_234 = PivotFactory.eINSTANCE.createClass(); // pivot|TemplateParameterType
		Property symbol_235 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::TemplateParameterType::specification pivot|TemplateParameterType|specification
		
		Class symbol_236 = PivotFactory.eINSTANCE.createClass(); // pivot|TemplateSignature
		Property symbol_237 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::TemplateSignature::ownedParameter pivot|TemplateSignature|ownedParameter
		Property symbol_238 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::TemplateSignature::parameter pivot|TemplateSignature|parameter
		Property symbol_239 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::TemplateSignature::template pivot|TemplateSignature|template
		
		Class symbol_240 = PivotFactory.eINSTANCE.createClass(); // pivot|TemplateableElement
		Property symbol_241 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::TemplateableElement::ownedTemplateSignature pivot|TemplateableElement|ownedTemplateSignature
		Property symbol_242 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::TemplateableElement::templateBinding pivot|TemplateableElement|templateBinding
		
		Class symbol_243 = PivotFactory.eINSTANCE.createClass(); // pivot|Throwable
		
		Class symbol_244 = PivotFactory.eINSTANCE.createClass(); // pivot|TupleLiteralExp
		Property symbol_245 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::TupleLiteralExp::part pivot|TupleLiteralExp|part
		
		Class symbol_246 = PivotFactory.eINSTANCE.createClass(); // pivot|TupleLiteralPart
		Property symbol_247 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::TupleLiteralPart::initExpression pivot|TupleLiteralPart|initExpression
		
		Class symbol_248 = PivotFactory.eINSTANCE.createClass(); // pivot|TupleType
		
		Class symbol_249 = PivotFactory.eINSTANCE.createClass(); // pivot|Type
		Property symbol_250 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::Type::instanceClassName pivot|Type|instanceClassName
		Property symbol_251 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::Type::package pivot|Type|package
		
		Class symbol_252 = PivotFactory.eINSTANCE.createClass(); // pivot|TypeExp
		Property symbol_253 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::TypeExp::referredType pivot|TypeExp|referredType
		
		Class symbol_254 = PivotFactory.eINSTANCE.createClass(); // pivot|TypeTemplateParameter
		Property symbol_255 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::TypeTemplateParameter::allowSubstitutable pivot|TypeTemplateParameter|allowSubstitutable
		Property symbol_256 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::TypeTemplateParameter::constrainingType pivot|TypeTemplateParameter|constrainingType
		
		Class symbol_257 = PivotFactory.eINSTANCE.createClass(); // pivot|TypedElement
		Property symbol_258 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::TypedElement::type pivot|TypedElement|type
		
		Class symbol_259 = PivotFactory.eINSTANCE.createClass(); // pivot|TypedMultiplicityElement
		
		PrimitiveType symbol_260 = standardLibrary.getUnlimitedNaturalType(); // pivot|UnlimitedNatural
		Class symbol_261 = PivotFactory.eINSTANCE.createClass(); // pivot|UnlimitedNaturalLiteralExp
		Property symbol_262 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::UnlimitedNaturalLiteralExp::unlimitedNaturalSymbol pivot|UnlimitedNaturalLiteralExp|unlimitedNaturalSymbol
		
		Class symbol_263 = PivotFactory.eINSTANCE.createClass(); // pivot|UnspecifiedValueExp
		
		Class symbol_264 = PivotFactory.eINSTANCE.createClass(); // pivot|ValueSpecification
		
		Class symbol_265 = PivotFactory.eINSTANCE.createClass(); // pivot|Variable
		Property symbol_266 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::Variable::implicit pivot|Variable|implicit
		Property symbol_267 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::Variable::initExpression pivot|Variable|initExpression
		Property symbol_268 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::Variable::representedParameter pivot|Variable|representedParameter
		
		Class symbol_269 = PivotFactory.eINSTANCE.createClass(); // pivot|VariableDeclaration
		
		Class symbol_270 = PivotFactory.eINSTANCE.createClass(); // pivot|VariableExp
		Property symbol_271 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::VariableExp::implicit pivot|VariableExp|implicit
		Property symbol_272 = PivotFactory.eINSTANCE.createProperty(); // pivot.ecore::pivot::VariableExp::referredVariable pivot|VariableExp|referredVariable
		
		Class symbol_273 = PivotFactory.eINSTANCE.createClass(); // pivot|Visitable
		
		Class symbol_274 = PivotFactory.eINSTANCE.createClass(); // pivot|Visitor{R,C}
		TemplateSignature symbol_275 = PivotFactory.eINSTANCE.createTemplateSignature(); // pivot|Visitor{R,C}|
		TypeTemplateParameter symbol_276 = PivotFactory.eINSTANCE.createTypeTemplateParameter();
		Class symbol_277 = PivotFactory.eINSTANCE.createClass(); // pivot|Visitor{R,C}?R
		TypeTemplateParameter symbol_278 = PivotFactory.eINSTANCE.createTypeTemplateParameter();
		Class symbol_279 = PivotFactory.eINSTANCE.createClass(); // pivot|Visitor{R,C}?C
		
		
		Class symbol_280 = PivotFactory.eINSTANCE.createClass(); // pivot|VoidType
		...
		symbol_2.getSuperClasses().add(symbol_144);
		...
		symbol_6.getSuperClasses().add(symbol_22);
		...
		symbol_7.getSuperClasses().add(symbol_22);
		...
		symbol_9.getSuperClasses().add(symbol_150);
		...
		symbol_12.getSuperClasses().add(symbol_39);
		...
		symbol_14.getSuperClasses().add(symbol_187);
		...
		symbol_16.getSuperClasses().add(symbol_156);
		...
		{ // pivot.ecore::pivot::CallExp::source pivot|CallExp|source
			...
			symbol_18.setType(symbol_156);  // pivot|OclExpression
		...
		symbol_22.getSuperClasses().add(symbol_149);
		symbol_22.getSuperClasses().add(symbol_249);
		...
		{ // pivot.ecore::pivot::Class::ownedAttribute pivot|Class|ownedAttribute
			...
			symbol_25.setType(symbol_189);  // pivot|Property
			...
			symbol_25.setOpposite(symbol_191);
		...
		{ // pivot.ecore::pivot::Class::ownedOperation pivot|Class|ownedOperation
			...
			symbol_26.setType(symbol_160);  // pivot|Operation
			...
			symbol_26.setOpposite(symbol_161);
		...
		symbol_29.getSuperClasses().add(symbol_35);
		{ // pivot.ecore::pivot::CollectionItem::item pivot|CollectionItem|item
			symbol_30.setName("item");
			symbol_30.setType(symbol_156);  // pivot|OclExpression
		...
		symbol_32.getSuperClasses().add(symbol_123);
		...
		symbol_35.getSuperClasses().add(symbol_257);
		...
		{ // pivot.ecore::pivot::Comment::body pivot|Comment|body
			...
			symbol_43.setType(symbol_216);  // pivot|String
		...
		//
		symbol_44.setName("CompleteEnvironment");
		symbol_44.getSuperClasses().add(symbol_170);
		{	// pivot.ecore::pivot::CompleteEnvironment::getCompleteIteration() pivot|CompleteEnvironment|getCompleteIteration(pivot|Iteration)
			...
			symbol_281.setName("getCompleteIteration");
			symbol_281.setType(symbol_45);  // pivot|CompleteIteration
			
			Parameter symbol_282 = PivotFactory.eINSTANCE.createParameter();
			symbol_282.setName("model");
			symbol_282.setType(symbol_115);  // pivot|Iteration
			
			symbol_281.getOwnedParameters().add(symbol_282);
			symbol_44.getOwnedOperations().add(symbol_281);
		}
		{	// pivot.ecore::pivot::CompleteEnvironment::getCompleteOperation() pivot|CompleteEnvironment|getCompleteOperation(pivot|Operation)
			...
			symbol_283.setName("getCompleteOperation");
			symbol_283.setType(symbol_51);  // pivot|CompleteOperation
			
			Parameter symbol_284 = PivotFactory.eINSTANCE.createParameter();
			symbol_284.setName("model");
			symbol_284.setType(symbol_160);  // pivot|Operation
			
			symbol_283.getOwnedParameters().add(symbol_284);
			symbol_44.getOwnedOperations().add(symbol_283);
		}
		{	// pivot.ecore::pivot::CompleteEnvironment::getCompletePackage() pivot|CompleteEnvironment|getCompletePackage(pivot|Package)
			...
			symbol_285.setName("getCompletePackage");
			symbol_285.setType(symbol_55);  // pivot|CompletePackage
			
			Parameter symbol_286 = PivotFactory.eINSTANCE.createParameter();
			symbol_286.setName("model");
			symbol_286.setType(symbol_170);  // pivot|Package
			
			symbol_285.getOwnedParameters().add(symbol_286);
			symbol_44.getOwnedOperations().add(symbol_285);
		}
		{	// pivot.ecore::pivot::CompleteEnvironment::getCompleteProperty() pivot|CompleteEnvironment|getCompleteProperty(pivot|Property)
			...
			symbol_287.setName("getCompleteProperty");
			symbol_287.setType(symbol_60);  // pivot|CompleteProperty
			
			Parameter symbol_288 = PivotFactory.eINSTANCE.createParameter();
			symbol_288.setName("model");
			symbol_288.setType(symbol_189);  // pivot|Property
			
			symbol_287.getOwnedParameters().add(symbol_288);
			symbol_44.getOwnedOperations().add(symbol_287);
		}
		...
		{ // pivot.ecore::pivot::CompleteIteration::completeEnvironment pivot|CompleteIteration|completeEnvironment
			...
			symbol_47.setType(symbol_44);  // pivot|CompleteEnvironment
		...
		{ // pivot.ecore::pivot::CompleteIteration::completeIterator pivot|CompleteIteration|completeIterator
			symbol_48.setName("completeIterator");
			symbol_48.setType(symbol_178);  // pivot|Parameter
		...
		{ // pivot.ecore::pivot::CompleteIteration::completeParameter pivot|CompleteIteration|completeParameter
			symbol_49.setName("completeParameter");
		...
		{ // pivot.ecore::pivot::CompleteIteration::model pivot|CompleteIteration|model
			symbol_50.setName("model");
			symbol_50.setType(symbol_115);  // pivot|Iteration
		...
		//
		symbol_51.setName("CompleteOperation");
		symbol_51.getSuperClasses().add(symbol_160);
		{ // pivot.ecore::pivot::CompleteOperation::completeEnvironment pivot|CompleteOperation|completeEnvironment
			...
			symbol_52.setType(symbol_44);  // pivot|CompleteEnvironment
		...
		{ // pivot.ecore::pivot::CompleteOperation::completeParameter pivot|CompleteOperation|completeParameter
			symbol_53.setName("completeParameter");
			symbol_53.setType(symbol_178);  // pivot|Parameter
			symbol_53.setLower(BigInteger.valueOf(0));
			symbol_53.setUpper(BigInteger.valueOf(-1));
			
			symbol_53.setIsDerived(true);
			symbol_53.setIsReadOnly(true);
			symbol_53.setIsResolveProxies(true);
			symbol_53.setIsVolatile(true);
			symbol_51.getOwnedAttributes().add(symbol_53);
		}
		{ // pivot.ecore::pivot::CompleteOperation::model pivot|CompleteOperation|model
			symbol_54.setName("model");
			symbol_54.setType(symbol_160);  // pivot|Operation
		...
		//
		symbol_55.setName("CompletePackage");
		symbol_55.getSuperClasses().add(symbol_170);
		{ // pivot.ecore::pivot::CompletePackage::completeEnvironment pivot|CompletePackage|completeEnvironment
			symbol_56.setName("completeEnvironment");
			symbol_56.setType(symbol_44);  // pivot|CompleteEnvironment
		...
		{ // pivot.ecore::pivot::CompletePackage::completePackage pivot|CompletePackage|completePackage
			symbol_57.setName("completePackage");
			symbol_57.setType(symbol_55);  // pivot|CompletePackage
			symbol_57.setLower(BigInteger.valueOf(0));
			symbol_57.setUpper(BigInteger.valueOf(-1));
			
			symbol_57.setIsDerived(true);
			symbol_57.setIsReadOnly(true);
			symbol_57.setIsResolveProxies(true);
			symbol_57.setIsVolatile(true);
		...
		{ // pivot.ecore::pivot::CompletePackage::completeType pivot|CompletePackage|completeType
			symbol_58.setName("completeType");
			symbol_58.setType(symbol_63);  // pivot|CompleteType
		...
		{ // pivot.ecore::pivot::CompleteProperty::model pivot|CompleteProperty|model
			symbol_62.setName("model");
			symbol_62.setType(symbol_189);  // pivot|Property
		...
		//
		symbol_63.setName("CompleteType");
		symbol_63.getSuperClasses().add(symbol_22);
		{ // pivot.ecore::pivot::CompleteType::completeEnvironment pivot|CompleteType|completeEnvironment
			symbol_64.setName("completeEnvironment");
			symbol_64.setType(symbol_44);  // pivot|CompleteEnvironment
		...
		{ // pivot.ecore::pivot::CompleteType::completeOperation pivot|CompleteType|completeOperation
			symbol_65.setName("completeOperation");
			symbol_65.setType(symbol_51);  // pivot|CompleteOperation
			symbol_65.setLower(BigInteger.valueOf(0));
			symbol_65.setUpper(BigInteger.valueOf(-1));
			
			symbol_65.setIsDerived(true);
			symbol_65.setIsReadOnly(true);
			symbol_65.setIsResolveProxies(true);
			symbol_65.setIsVolatile(true);
		...
		{ // pivot.ecore::pivot::CompleteType::completeProperty pivot|CompleteType|completeProperty
			symbol_66.setName("completeProperty");
			symbol_66.setType(symbol_60);  // pivot|CompleteProperty
		...
		{ // pivot.ecore::pivot::CompleteType::completeSuperType pivot|CompleteType|completeSuperType
			symbol_67.setName("completeSuperType");
			symbol_67.setType(symbol_63);  // pivot|CompleteType
		...
		{ // pivot.ecore::pivot::CompleteType::model pivot|CompleteType|model
			symbol_68.setName("model");
			symbol_68.setType(symbol_249);  // pivot|Type
		...
		{	// pivot.ecore::pivot::CompleteType::conformsTo() pivot|CompleteType|conformsTo(pivot|CompleteType)
			...
			symbol_291.setName("conformsTo");
			symbol_291.setType(symbol_13);  // pivot|Boolean
			
			Parameter symbol_292 = PivotFactory.eINSTANCE.createParameter();
			symbol_292.setName("aType");
			symbol_292.setType(symbol_63);  // pivot|CompleteType
			
			symbol_291.getOwnedParameters().add(symbol_292);
			symbol_63.getOwnedOperations().add(symbol_291);
		}
		{	// pivot.ecore::pivot::CompleteType::getCompleteIterations() pivot|CompleteType|getCompleteIterations(pivot|String)
			...
			symbol_293.setName("getCompleteIterations");
			symbol_293.setType(symbol_45);  // pivot|CompleteIteration
			...
			symbol_294.setName("name");
			symbol_294.setType(symbol_216);  // pivot|String
			
			symbol_293.getOwnedParameters().add(symbol_294);
			symbol_63.getOwnedOperations().add(symbol_293);
		}
		{	// pivot.ecore::pivot::CompleteType::getCompleteOperations() pivot|CompleteType|getCompleteOperations(pivot|String)
			...
			symbol_295.setName("getCompleteOperations");
			symbol_295.setType(symbol_51);  // pivot|CompleteOperation
			...
			symbol_296.setType(symbol_216);  // pivot|String
			
			symbol_295.getOwnedParameters().add(symbol_296);
			symbol_63.getOwnedOperations().add(symbol_295);
		}
		{	// pivot.ecore::pivot::CompleteType::getDynamicIteration() pivot|CompleteType|getDynamicIteration(pivot|CompleteIteration)
			...
			symbol_297.setName("getDynamicIteration");
			symbol_297.setType(symbol_45);  // pivot|CompleteIteration
			
			Parameter symbol_298 = PivotFactory.eINSTANCE.createParameter();
			symbol_298.setName("staticOperation");
			symbol_298.setType(symbol_45);  // pivot|CompleteIteration
			
			symbol_297.getOwnedParameters().add(symbol_298);
			symbol_63.getOwnedOperations().add(symbol_297);
		}
		...
		{ // pivot.ecore::pivot::Constraint::context pivot|Constraint|context
			symbol_71.setName("context");
			symbol_71.setType(symbol_144);  // pivot|NamedElement
		...
		{ // pivot.ecore::pivot::Constraint::specification pivot|Constraint|specification
			symbol_72.setName("specification");
			symbol_72.setType(symbol_264);  // pivot|ValueSpecification
		...
		{ // pivot.ecore::pivot::Constraint::stereotype pivot|Constraint|stereotype
			symbol_73.setName("stereotype");
			symbol_73.setType(symbol_216);  // pivot|String
			symbol_73.setLower(BigInteger.valueOf(0));
			
			symbol_73.setIsResolveProxies(true);
			symbol_69.getOwnedAttributes().add(symbol_73);
		}
		symbol_1.getOwnedTypes().add(symbol_69);
		//
		// pivot.ecore::pivot::DataType pivot|DataType
		//
		symbol_74.setName("DataType");
		symbol_74.getSuperClasses().add(symbol_22);
		...
		symbol_76.getSuperClasses().add(symbol_144);
		{ // pivot.ecore::pivot::Detail::value pivot|Detail|value
			symbol_77.setName("value");
			symbol_77.setType(symbol_216);  // pivot|String
		...
		symbol_80.getSuperClasses().add(symbol_123);
		...
		symbol_82.getSuperClasses().add(symbol_74);
		...
		symbol_84.getSuperClasses().add(symbol_144);
		...
		{ // pivot.ecore::pivot::EnumerationLiteral::value pivot|EnumerationLiteral|value
			...
			symbol_86.setType(symbol_104);  // pivot|Integer
		...
		{ // pivot.ecore::pivot::ExpressionInOcl::contextVariable pivot|ExpressionInOcl|contextVariable
			...
			symbol_89.setType(symbol_265);  // pivot|Variable
		...
		{ // pivot.ecore::pivot::ExpressionInOcl::parameterVariable pivot|ExpressionInOcl|parameterVariable
			symbol_90.setName("parameterVariable");
			symbol_90.setType(symbol_265);  // pivot|Variable
			symbol_90.setLower(BigInteger.valueOf(0));
			symbol_90.setUpper(BigInteger.valueOf(-1));
			symbol_90.setIsOrdered(true);
		...
		{ // pivot.ecore::pivot::ExpressionInOcl::resultVariable pivot|ExpressionInOcl|resultVariable
			symbol_91.setName("resultVariable");
			symbol_91.setType(symbol_265);  // pivot|Variable
		...
		//
		symbol_92.setName("Feature");
		symbol_92.getSuperClasses().add(symbol_144);
		symbol_92.getSuperClasses().add(symbol_259);
		{ // pivot.ecore::pivot::Feature::featuringClass pivot|Feature|featuringClass
			symbol_93.setName("featuringClass");
			symbol_93.setType(symbol_22);  // pivot|Class
			symbol_93.setLower(BigInteger.valueOf(0));
			
			symbol_93.setIsDerived(true);
			symbol_93.setIsReadOnly(true);
			symbol_93.setIsTransient(true);
			symbol_93.setIsVolatile(true);
		...
		//
		symbol_94.setName("FeatureCallExp");
		symbol_94.getSuperClasses().add(symbol_16);
		{ // pivot.ecore::pivot::FeatureCallExp::isPre pivot|FeatureCallExp|isPre
			symbol_95.setName("isPre");
			symbol_95.setType(symbol_13);  // pivot|Boolean
		...
		//
		symbol_96.setName("IfExp");
		symbol_96.getSuperClasses().add(symbol_156);
		{ // pivot.ecore::pivot::IfExp::condition pivot|IfExp|condition
			symbol_97.setName("condition");
			symbol_97.setType(symbol_156);  // pivot|OclExpression
		...
		{ // pivot.ecore::pivot::IfExp::elseExpression pivot|IfExp|elseExpression
			symbol_98.setName("elseExpression");
			symbol_98.setType(symbol_156);  // pivot|OclExpression
		...
		{ // pivot.ecore::pivot::IfExp::thenExpression pivot|IfExp|thenExpression
			symbol_99.setName("thenExpression");
			symbol_99.setType(symbol_156);  // pivot|OclExpression
		...
		{ // pivot.ecore::pivot::ImplementableElement::implementationClass pivot|ImplementableElement|implementationClass
			symbol_102.setName("implementationClass");
			symbol_102.setType(symbol_216);  // pivot|String
		...
		symbol_105.getSuperClasses().add(symbol_154);
		...
		symbol_107.getSuperClasses().add(symbol_123);
		...
		{ // pivot.ecore::pivot::InvalidLiteralExp::reason pivot|InvalidLiteralExp|reason
			...
			symbol_110.setType(symbol_216);  // pivot|String
		...
		{ // pivot.ecore::pivot::InvalidLiteralExp::throwable pivot|InvalidLiteralExp|throwable
			...
			symbol_111.setType(symbol_243);  // pivot|Throwable
		...
		symbol_115.getSuperClasses().add(symbol_160);
		...
		{ // pivot.ecore::pivot::LetExp::variable pivot|LetExp|variable
			...
			symbol_121.setType(symbol_265);  // pivot|Variable
		...
		{ // pivot.ecore::pivot::LoopExp::iterator pivot|LoopExp|iterator
			...
			symbol_126.setType(symbol_265);  // pivot|Variable
		...
		symbol_128.getSuperClasses().add(symbol_156);
		...
		{ // pivot.ecore::pivot::MessageExp::calledOperation pivot|MessageExp|calledOperation
			...
			symbol_130.setType(symbol_19);  // pivot|CallOperationAction
		...
		{ // pivot.ecore::pivot::MessageExp::sentSignal pivot|MessageExp|sentSignal
			...
			symbol_131.setType(symbol_208);  // pivot|SendSignalAction
		...
		symbol_133.getSuperClasses().add(symbol_249);
		...
		{ // pivot.ecore::pivot::MessageType::referredSignal pivot|MessageType|referredSignal
			...
			symbol_135.setType(symbol_212);  // pivot|Signal
		...
		{	// pivot.ecore::pivot::MonikeredElement::hasMoniker() pivot|MonikeredElement|hasMoniker()
			...
			symbol_301.setName("hasMoniker");
			symbol_301.setType(symbol_13);  // pivot|Boolean
			
			symbol_136.getOwnedOperations().add(symbol_301);
		}
		...
		symbol_138.getSuperClasses().add(symbol_136);
		...
		{ // pivot.ecore::pivot::MultiplicityElement::upper pivot|MultiplicityElement|upper
			...
			symbol_142.setType(symbol_260);  // pivot|UnlimitedNatural
		...
		{	// pivot.ecore::pivot::MultiplicityElement::includesCardinality() pivot|MultiplicityElement|includesCardinality(pivot|Integer)
			...
			symbol_302.setName("includesCardinality");
			symbol_302.setType(symbol_13);  // pivot|Boolean
			
			Parameter symbol_303 = PivotFactory.eINSTANCE.createParameter();
			symbol_303.setName("C");
			symbol_303.setType(symbol_104);  // pivot|Integer
			
			symbol_302.getOwnedParameters().add(symbol_303);
			symbol_138.getOwnedOperations().add(symbol_302);
		}
		{	// pivot.ecore::pivot::MultiplicityElement::includesMultiplicity() pivot|MultiplicityElement|includesMultiplicity(pivot|MultiplicityElement)
			...
			symbol_304.setName("includesMultiplicity");
			symbol_304.setType(symbol_13);  // pivot|Boolean
			
			Parameter symbol_305 = PivotFactory.eINSTANCE.createParameter();
			symbol_305.setName("M");
			symbol_305.setType(symbol_138);  // pivot|MultiplicityElement
		...
		{	// pivot.ecore::pivot::MultiplicityElement::isMultivalued() pivot|MultiplicityElement|isMultivalued()
			...
			symbol_306.setName("isMultivalued");
		...
		{	// pivot.ecore::pivot::MultiplicityElement::lowerBound() pivot|MultiplicityElement|lowerBound()
			...
			symbol_307.setType(symbol_104);  // pivot|Integer
			
			symbol_138.getOwnedOperations().add(symbol_307);
		}
		{	// pivot.ecore::pivot::MultiplicityElement::upperBound() pivot|MultiplicityElement|upperBound()
			...
			symbol_308.setType(symbol_260);  // pivot|UnlimitedNatural
		...
		symbol_144.getSuperClasses().add(symbol_143);
		symbol_144.getSuperClasses().add(symbol_136);
		...
		{ // pivot.ecore::pivot::NamedElement::name pivot|NamedElement|name
			...
			symbol_146.setType(symbol_216);  // pivot|String
		...
		{ // pivot.ecore::pivot::NamedElement::ownedRule pivot|NamedElement|ownedRule
			...
			symbol_148.setType(symbol_69);  // pivot|Constraint
		...
		symbol_149.getSuperClasses().add(symbol_144);
		...
		symbol_150.getSuperClasses().add(symbol_94);
		...
		symbol_153.getSuperClasses().add(symbol_187);
		...
		symbol_154.getSuperClasses().add(symbol_187);
		...
		symbol_156.getSuperClasses().add(symbol_257);
		...
		{ // pivot.ecore::pivot::OpaqueExpression::language pivot|OpaqueExpression|language
			...
			symbol_159.setType(symbol_216);  // pivot|String
		...
		symbol_160.getSuperClasses().add(symbol_149);
		symbol_160.getSuperClasses().add(symbol_257);
		symbol_160.getSuperClasses().add(symbol_138);
		symbol_160.getSuperClasses().add(symbol_100);
		symbol_160.getSuperClasses().add(symbol_240);
		symbol_160.getSuperClasses().add(symbol_180);
		symbol_160.getSuperClasses().add(symbol_92);
		{ // pivot.ecore::pivot::Operation::class pivot|Operation|class
			symbol_161.setName("class");
			symbol_161.setType(symbol_22);  // pivot|Class
			symbol_161.setLower(BigInteger.valueOf(0));
			
			symbol_161.setIsResolveProxies(true);
			symbol_161.setOpposite(symbol_26);
		...
		{ // pivot.ecore::pivot::Operation::raisedException pivot|Operation|raisedException
			...
			symbol_164.setType(symbol_249);  // pivot|Type
		...
		symbol_165.getSuperClasses().add(symbol_94);
		...
		symbol_168.getSuperClasses().add(symbol_223);
		...
		symbol_169.getSuperClasses().add(symbol_39);
		symbol_1.getOwnedTypes().add(symbol_169);
		//
		// pivot.ecore::pivot::Package pivot|Package
		//
		symbol_170.setName("Package");
		symbol_170.getSuperClasses().add(symbol_149);
		symbol_170.getSuperClasses().add(symbol_240);
		...
		{ // pivot.ecore::pivot::Package::nsPrefix pivot|Package|nsPrefix
			...
			symbol_173.setType(symbol_216);  // pivot|String
		...
		{ // pivot.ecore::pivot::Package::nsURI pivot|Package|nsURI
			...
			symbol_174.setType(symbol_216);  // pivot|String
		...
		{ // pivot.ecore::pivot::Package::ownedType pivot|Package|ownedType
			...
			symbol_176.setType(symbol_249);  // pivot|Type
			...
			symbol_176.setOpposite(symbol_251);
		...
		symbol_177.getSuperClasses().add(symbol_180);
		symbol_1.getOwnedTypes().add(symbol_177);
		//
		// pivot.ecore::pivot::Parameter pivot|Parameter
		//
		symbol_178.setName("Parameter");
		symbol_178.getSuperClasses().add(symbol_269);
		symbol_178.getSuperClasses().add(symbol_259);
		...
		symbol_180.getSuperClasses().add(symbol_136);
		{ // pivot.ecore::pivot::ParameterableElement::owningTemplateParameter pivot|ParameterableElement|owningTemplateParameter
			...
			symbol_181.setType(symbol_223);  // pivot|TemplateParameter
			symbol_181.setLower(BigInteger.valueOf(0));
			
			symbol_181.setIsResolveProxies(true);
			symbol_181.setOpposite(symbol_226);
		...
		{ // pivot.ecore::pivot::ParameterableElement::templateParameter pivot|ParameterableElement|templateParameter
			...
			symbol_182.setType(symbol_223);  // pivot|TemplateParameter
			symbol_182.setLower(BigInteger.valueOf(0));
			
			symbol_182.setIsResolveProxies(true);
			symbol_182.setOpposite(symbol_227);
		...
		{	// pivot.ecore::pivot::ParameterableElement::isTemplateParameter() pivot|ParameterableElement|isTemplateParameter()
			...
			symbol_309.setName("isTemplateParameter");
			symbol_309.setType(symbol_13);  // pivot|Boolean
			
			symbol_180.getOwnedOperations().add(symbol_309);
		}
		...
		symbol_184.getSuperClasses().add(symbol_144);
		...
		symbol_187.getSuperClasses().add(symbol_123);
		symbol_1.getOwnedTypes().add(symbol_187);
		//
		// pivot.ecore::pivot::PrimitiveType pivot|PrimitiveType
		//
		symbol_188.setName("PrimitiveType");
		symbol_188.getSuperClasses().add(symbol_74);
		symbol_1.getOwnedTypes().add(symbol_188);
		//
		// pivot.ecore::pivot::Property pivot|Property
		//
		symbol_189.setName("Property");
		symbol_189.getSuperClasses().add(symbol_257);
		symbol_189.getSuperClasses().add(symbol_138);
		symbol_189.getSuperClasses().add(symbol_100);
		symbol_189.getSuperClasses().add(symbol_180);
		symbol_189.getSuperClasses().add(symbol_92);
		...
		{ // pivot.ecore::pivot::Property::default pivot|Property|default
			...
			symbol_192.setType(symbol_216);  // pivot|String
		...
		{ // pivot.ecore::pivot::Property::isComposite pivot|Property|isComposite
			symbol_193.setName("isComposite");
		...
		{ // pivot.ecore::pivot::Property::isResolveProxies pivot|Property|isResolveProxies
			symbol_197.setName("isResolveProxies");
		...
		{ // pivot.ecore::pivot::Property::isTransient pivot|Property|isTransient
			symbol_198.setName("isTransient");
		...
		{ // pivot.ecore::pivot::Property::isUnsettable pivot|Property|isUnsettable
			symbol_199.setName("isUnsettable");
		...
		{ // pivot.ecore::pivot::Property::keys pivot|Property|keys
			symbol_201.setName("keys");
			symbol_201.setType(symbol_189);  // pivot|Property
		...
		//
		symbol_203.setName("PropertyCallExp");
		symbol_203.getSuperClasses().add(symbol_150);
		{ // pivot.ecore::pivot::PropertyCallExp::referredProperty pivot|PropertyCallExp|referredProperty
			symbol_204.setName("referredProperty");
			symbol_204.setType(symbol_189);  // pivot|Property
		...
		//
		symbol_206.setName("RealLiteralExp");
		symbol_206.getSuperClasses().add(symbol_154);
		{ // pivot.ecore::pivot::RealLiteralExp::realSymbol pivot|RealLiteralExp|realSymbol
			symbol_207.setName("realSymbol");
			symbol_207.setType(symbol_205);  // pivot|Real
			
			symbol_207.setIsResolveProxies(true);
			symbol_206.getOwnedAttributes().add(symbol_207);
		}
		symbol_1.getOwnedTypes().add(symbol_206);
		//
		// pivot.ecore::pivot::SendSignalAction pivot|SendSignalAction
		//
		symbol_208.setName("SendSignalAction");
		symbol_208.getSuperClasses().add(symbol_144);
		{ // pivot.ecore::pivot::SendSignalAction::signal pivot|SendSignalAction|signal
			symbol_209.setName("signal");
			symbol_209.setType(symbol_212);  // pivot|Signal
		...
		//
		symbol_210.setName("SequenceType");
		symbol_210.getSuperClasses().add(symbol_39);
		symbol_1.getOwnedTypes().add(symbol_210);
		//
		// pivot.ecore::pivot::SetType pivot|SetType
		//
		symbol_211.setName("SetType");
		symbol_211.getSuperClasses().add(symbol_39);
		symbol_1.getOwnedTypes().add(symbol_211);
		//
		// pivot.ecore::pivot::Signal pivot|Signal
		//
		symbol_212.setName("Signal");
		symbol_212.getSuperClasses().add(symbol_144);
		symbol_1.getOwnedTypes().add(symbol_212);
		//
		// pivot.ecore::pivot::State pivot|State
		//
		symbol_213.setName("State");
		symbol_213.getSuperClasses().add(symbol_144);
		symbol_1.getOwnedTypes().add(symbol_213);
		//
		// pivot.ecore::pivot::StateExp pivot|StateExp
		//
		symbol_214.setName("StateExp");
		symbol_214.getSuperClasses().add(symbol_156);
		{ // pivot.ecore::pivot::StateExp::referredState pivot|StateExp|referredState
			symbol_215.setName("referredState");
			symbol_215.setType(symbol_213);  // pivot|State
		...
		//
		symbol_217.setName("StringLiteralExp");
		symbol_217.getSuperClasses().add(symbol_187);
		{ // pivot.ecore::pivot::StringLiteralExp::stringSymbol pivot|StringLiteralExp|stringSymbol
			symbol_218.setName("stringSymbol");
			symbol_218.setType(symbol_216);  // pivot|String
			
			symbol_218.setIsResolveProxies(true);
			symbol_217.getOwnedAttributes().add(symbol_218);
		}
		symbol_1.getOwnedTypes().add(symbol_217);
		//
		// pivot.ecore::pivot::TemplateBinding pivot|TemplateBinding
		//
		symbol_219.setName("TemplateBinding");
		symbol_219.getSuperClasses().add(symbol_78);
		{ // pivot.ecore::pivot::TemplateBinding::boundElement pivot|TemplateBinding|boundElement
			symbol_220.setName("boundElement");
			symbol_220.setType(symbol_240);  // pivot|TemplateableElement
			
			symbol_220.setIsResolveProxies(true);
			symbol_220.setOpposite(symbol_242);
		...
		{ // pivot.ecore::pivot::TemplateBinding::parameterSubstitution pivot|TemplateBinding|parameterSubstitution
			symbol_221.setName("parameterSubstitution");
			symbol_221.setType(symbol_229);  // pivot|TemplateParameterSubstitution
			symbol_221.setLower(BigInteger.valueOf(0));
			symbol_221.setUpper(BigInteger.valueOf(-1));
			
			symbol_221.setIsComposite(true);
			symbol_221.setIsResolveProxies(true);
			symbol_221.setOpposite(symbol_233);
			symbol_219.getOwnedAttributes().add(symbol_221);
		}
		{ // pivot.ecore::pivot::TemplateBinding::signature pivot|TemplateBinding|signature
			symbol_222.setName("signature");
			symbol_222.setType(symbol_236);  // pivot|TemplateSignature
			
			symbol_222.setIsResolveProxies(true);
			symbol_219.getOwnedAttributes().add(symbol_222);
		}
		symbol_1.getOwnedTypes().add(symbol_219);
		//
		// pivot.ecore::pivot::TemplateParameter pivot|TemplateParameter
		//
		symbol_223.setName("TemplateParameter");
		symbol_223.getSuperClasses().add(symbol_78);
		{ // pivot.ecore::pivot::TemplateParameter::default pivot|TemplateParameter|default
			symbol_224.setName("default");
			symbol_224.setType(symbol_180);  // pivot|ParameterableElement
		...
		{ // pivot.ecore::pivot::TemplateParameter::ownedDefault pivot|TemplateParameter|ownedDefault
			symbol_225.setName("ownedDefault");
			symbol_225.setType(symbol_180);  // pivot|ParameterableElement
		...
		{ // pivot.ecore::pivot::TemplateParameterSubstitution::formal pivot|TemplateParameterSubstitution|formal
			symbol_231.setName("formal");
			symbol_231.setType(symbol_223);  // pivot|TemplateParameter
		...
		{ // pivot.ecore::pivot::TemplateSignature::parameter pivot|TemplateSignature|parameter
			symbol_238.setName("parameter");
			symbol_238.setType(symbol_223);  // pivot|TemplateParameter
			symbol_238.setUpper(BigInteger.valueOf(-1));
			symbol_238.setIsOrdered(true);
			
			symbol_238.setIsResolveProxies(true);
			symbol_236.getOwnedAttributes().add(symbol_238);
		}
		{ // pivot.ecore::pivot::TemplateSignature::template pivot|TemplateSignature|template
			symbol_239.setName("template");
			symbol_239.setType(symbol_240);  // pivot|TemplateableElement
			
			symbol_239.setIsResolveProxies(true);
			symbol_239.setOpposite(symbol_241);
			symbol_236.getOwnedAttributes().add(symbol_239);
		}
		symbol_1.getOwnedTypes().add(symbol_236);
		//
		// pivot.ecore::pivot::TemplateableElement pivot|TemplateableElement
		//
		symbol_240.setName("TemplateableElement");
		symbol_240.getSuperClasses().add(symbol_136);
		{ // pivot.ecore::pivot::TemplateableElement::ownedTemplateSignature pivot|TemplateableElement|ownedTemplateSignature
			symbol_241.setName("ownedTemplateSignature");
			symbol_241.setType(symbol_236);  // pivot|TemplateSignature
			symbol_241.setLower(BigInteger.valueOf(0));
			
			symbol_241.setIsComposite(true);
			symbol_241.setIsResolveProxies(true);
			symbol_241.setOpposite(symbol_239);
		...
		{	// pivot.ecore::pivot::TemplateableElement::isTemplate() pivot|TemplateableElement|isTemplate()
			...
			symbol_310.setName("isTemplate");
			symbol_310.setType(symbol_13);  // pivot|Boolean
			
			symbol_240.getOwnedOperations().add(symbol_310);
		}
		{	// pivot.ecore::pivot::TemplateableElement::parameterableElements() pivot|TemplateableElement|parameterableElements()
			...
			symbol_311.setName("parameterableElements");
			symbol_311.setType(symbol_180);  // pivot|ParameterableElement
			symbol_311.setLower(BigInteger.valueOf(0));
			symbol_311.setUpper(BigInteger.valueOf(-1));
			
			symbol_240.getOwnedOperations().add(symbol_311);
		}
		symbol_1.getOwnedTypes().add(symbol_240);
		//
		// pivot.ecore::pivot::Throwable pivot|Throwable
		//
		symbol_243.setName("Throwable");
		symbol_1.getOwnedTypes().add(symbol_243);
		//
		// pivot.ecore::pivot::TupleLiteralExp pivot|TupleLiteralExp
		//
		symbol_244.setName("TupleLiteralExp");
		symbol_244.getSuperClasses().add(symbol_123);
		{ // pivot.ecore::pivot::TupleLiteralExp::part pivot|TupleLiteralExp|part
			symbol_245.setName("part");
			symbol_245.setType(symbol_246);  // pivot|TupleLiteralPart
			symbol_245.setLower(BigInteger.valueOf(0));
			symbol_245.setUpper(BigInteger.valueOf(-1));
			symbol_245.setIsOrdered(true);
		...
		//
		symbol_246.setName("TupleLiteralPart");
		symbol_246.getSuperClasses().add(symbol_269);
		{ // pivot.ecore::pivot::TupleLiteralPart::initExpression pivot|TupleLiteralPart|initExpression
			symbol_247.setName("initExpression");
			symbol_247.setType(symbol_156);  // pivot|OclExpression
		...
		//
		symbol_248.setName("TupleType");
		symbol_248.getSuperClasses().add(symbol_74);
		symbol_1.getOwnedTypes().add(symbol_248);
		//
		// pivot.ecore::pivot::Type pivot|Type
		//
		symbol_249.setName("Type");
		symbol_249.getSuperClasses().add(symbol_144);
		symbol_249.getSuperClasses().add(symbol_240);
		symbol_249.getSuperClasses().add(symbol_180);
		{ // pivot.ecore::pivot::Type::instanceClassName pivot|Type|instanceClassName
			symbol_250.setName("instanceClassName");
			symbol_250.setType(symbol_216);  // pivot|String
		...
		{ // pivot.ecore::pivot::Type::package pivot|Type|package
			symbol_251.setName("package");
			symbol_251.setType(symbol_170);  // pivot|Package
			symbol_251.setLower(BigInteger.valueOf(0));
			
			symbol_251.setIsResolveProxies(true);
			symbol_251.setOpposite(symbol_176);
			symbol_249.getOwnedAttributes().add(symbol_251);
		}
		symbol_1.getOwnedTypes().add(symbol_249);
		//
		// pivot.ecore::pivot::TypeExp pivot|TypeExp
		//
		symbol_252.setName("TypeExp");
		symbol_252.getSuperClasses().add(symbol_156);
		{ // pivot.ecore::pivot::TypeExp::referredType pivot|TypeExp|referredType
			symbol_253.setName("referredType");
			symbol_253.setType(symbol_249);  // pivot|Type
		...
		//
		symbol_254.setName("TypeTemplateParameter");
		symbol_254.getSuperClasses().add(symbol_223);
		{ // pivot.ecore::pivot::TypeTemplateParameter::allowSubstitutable pivot|TypeTemplateParameter|allowSubstitutable
			symbol_255.setName("allowSubstitutable");
			symbol_255.setType(symbol_13);  // pivot|Boolean
		...
		{ // pivot.ecore::pivot::TypeTemplateParameter::constrainingType pivot|TypeTemplateParameter|constrainingType
			symbol_256.setName("constrainingType");
			symbol_256.setType(symbol_249);  // pivot|Type
		...
		//
		symbol_257.setName("TypedElement");
		symbol_257.getSuperClasses().add(symbol_144);
		{ // pivot.ecore::pivot::TypedElement::type pivot|TypedElement|type
			symbol_258.setName("type");
			symbol_258.setType(symbol_249);  // pivot|Type
		...
		//
		symbol_259.setName("TypedMultiplicityElement");
		symbol_259.getSuperClasses().add(symbol_257);
		symbol_259.getSuperClasses().add(symbol_138);
		symbol_1.getOwnedTypes().add(symbol_259);
		//
		// pivot.ecore::pivot::UnlimitedNaturalLiteralExp pivot|UnlimitedNaturalLiteralExp
		//
		symbol_261.setName("UnlimitedNaturalLiteralExp");
		symbol_261.getSuperClasses().add(symbol_154);
		{ // pivot.ecore::pivot::UnlimitedNaturalLiteralExp::unlimitedNaturalSymbol pivot|UnlimitedNaturalLiteralExp|unlimitedNaturalSymbol
			symbol_262.setName("unlimitedNaturalSymbol");
			symbol_262.setType(symbol_260);  // pivot|UnlimitedNatural
		...
		//
		symbol_263.setName("UnspecifiedValueExp");
		symbol_263.getSuperClasses().add(symbol_156);
		symbol_1.getOwnedTypes().add(symbol_263);
		//
		// pivot.ecore::pivot::ValueSpecification pivot|ValueSpecification
		//
		symbol_264.setName("ValueSpecification");
		symbol_264.getSuperClasses().add(symbol_257);
		symbol_264.getSuperClasses().add(symbol_180);
		{	// pivot.ecore::pivot::ValueSpecification::booleanValue() pivot|ValueSpecification|booleanValue()
			...
			symbol_312.setName("booleanValue");
			symbol_312.setType(symbol_13);  // pivot|Boolean
			
			symbol_264.getOwnedOperations().add(symbol_312);
		}
		{	// pivot.ecore::pivot::ValueSpecification::integerValue() pivot|ValueSpecification|integerValue()
			...
			symbol_313.setName("integerValue");
			symbol_313.setType(symbol_104);  // pivot|Integer
			
			symbol_264.getOwnedOperations().add(symbol_313);
		}
		{	// pivot.ecore::pivot::ValueSpecification::isComputable() pivot|ValueSpecification|isComputable()
			...
			symbol_314.setName("isComputable");
			symbol_314.setType(symbol_13);  // pivot|Boolean
			
			symbol_264.getOwnedOperations().add(symbol_314);
		}
		{	// pivot.ecore::pivot::ValueSpecification::isNull() pivot|ValueSpecification|isNull()
			...
			symbol_315.setName("isNull");
			symbol_315.setType(symbol_13);  // pivot|Boolean
			
			symbol_264.getOwnedOperations().add(symbol_315);
		}
		{	// pivot.ecore::pivot::ValueSpecification::stringValue() pivot|ValueSpecification|stringValue()
			...
			symbol_316.setName("stringValue");
			symbol_316.setType(symbol_216);  // pivot|String
			
			symbol_264.getOwnedOperations().add(symbol_316);
		}
		{	// pivot.ecore::pivot::ValueSpecification::unlimitedValue() pivot|ValueSpecification|unlimitedValue()
			...
			symbol_317.setName("unlimitedValue");
			symbol_317.setType(symbol_260);  // pivot|UnlimitedNatural
			
			symbol_264.getOwnedOperations().add(symbol_317);
		}
		symbol_1.getOwnedTypes().add(symbol_264);
		//
		// pivot.ecore::pivot::Variable pivot|Variable
		//
		symbol_265.setName("Variable");
		symbol_265.getSuperClasses().add(symbol_269);
		{ // pivot.ecore::pivot::Variable::implicit pivot|Variable|implicit
			symbol_266.setName("implicit");
			symbol_266.setType(symbol_13);  // pivot|Boolean
		...
		{ // pivot.ecore::pivot::Variable::initExpression pivot|Variable|initExpression
			symbol_267.setName("initExpression");
			symbol_267.setType(symbol_156);  // pivot|OclExpression
		...
		{ // pivot.ecore::pivot::Variable::representedParameter pivot|Variable|representedParameter
			symbol_268.setName("representedParameter");
			symbol_268.setType(symbol_178);  // pivot|Parameter
		...
		//
		symbol_269.setName("VariableDeclaration");
		symbol_269.getSuperClasses().add(symbol_257);
		symbol_1.getOwnedTypes().add(symbol_269);
		//
		// pivot.ecore::pivot::VariableExp pivot|VariableExp
		//
		symbol_270.setName("VariableExp");
		symbol_270.getSuperClasses().add(symbol_156);
		...
		{ // pivot.ecore::pivot::VariableExp::referredVariable pivot|VariableExp|referredVariable
			symbol_272.setName("referredVariable");
			symbol_272.setType(symbol_269);  // pivot|VariableDeclaration
		...
		//
		symbol_273.setName("Visitable");
		symbol_1.getOwnedTypes().add(symbol_273);
		//
		// pivot.ecore::pivot::Visitor pivot|Visitor{R,C}
		//
		symbol_274.setName("Visitor");
		symbol_277.setName("R");
		symbol_276.setOwnedParameteredElement(symbol_277);
		symbol_275.getOwnedParameters().add(symbol_276);
		symbol_279.setName("C");
		symbol_278.setOwnedParameteredElement(symbol_279);
		symbol_275.getOwnedParameters().add(symbol_278);
		
		symbol_274.setOwnedTemplateSignature(symbol_275);
		symbol_1.getOwnedTypes().add(symbol_274);
		//
		// pivot.ecore::pivot::VoidType pivot|VoidType
		//
		symbol_280.setName("VoidType");
		symbol_280.getSuperClasses().add(symbol_22);
		symbol_1.getOwnedTypes().add(symbol_280);
