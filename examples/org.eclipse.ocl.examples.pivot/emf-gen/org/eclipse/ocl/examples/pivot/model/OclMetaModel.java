...
public class OclMetaModel extends XMLResourceImpl
{
	...
	public static Package create(PivotStandardLibrary standardLibrary)
	{
		...
		{ // Pivot.ecore::pivot::Annotation::ownedContent
			...
			symbol_3.setOpposite(symbol_59);
		...
		{ // Pivot.ecore::pivot::Class::isAbstract
			...
			symbol_24.setIsResolveProxies(true);
			{
				...
				symbol_328.setBody("True when a class is abstract.");
				symbol_24.getOwnedComments().add(symbol_328);
			}
		...
		}
		{
			...
			symbol_329.setBody("A class is a type that has objects as its instances.");
			symbol_23.getOwnedComments().add(symbol_329);
		}
		...
		{
			EnumerationLiteral symbol_330 = PivotFactory.eINSTANCE.createEnumerationLiteral(); // Pivot.ecore::pivot::CollectionKind::Collection http://www.eclipse.org/ocl/3.1.0/Pivot!CollectionKind!Collection
			symbol_330.setName("Collection");
			symbol_30.getOwnedLiterals().add(symbol_330);
			EnumerationLiteral symbol_331 = PivotFactory.eINSTANCE.createEnumerationLiteral(); // Pivot.ecore::pivot::CollectionKind::Set http://www.eclipse.org/ocl/3.1.0/Pivot!CollectionKind!Set
			symbol_331.setName("Set");
			symbol_30.getOwnedLiterals().add(symbol_331);
			EnumerationLiteral symbol_332 = PivotFactory.eINSTANCE.createEnumerationLiteral(); // Pivot.ecore::pivot::CollectionKind::OrderedSet http://www.eclipse.org/ocl/3.1.0/Pivot!CollectionKind!OrderedSet
			symbol_332.setName("OrderedSet");
			symbol_30.getOwnedLiterals().add(symbol_332);
			EnumerationLiteral symbol_333 = PivotFactory.eINSTANCE.createEnumerationLiteral(); // Pivot.ecore::pivot::CollectionKind::Bag http://www.eclipse.org/ocl/3.1.0/Pivot!CollectionKind!Bag
			symbol_333.setName("Bag");
			symbol_30.getOwnedLiterals().add(symbol_333);
			EnumerationLiteral symbol_334 = PivotFactory.eINSTANCE.createEnumerationLiteral(); // Pivot.ecore::pivot::CollectionKind::Sequence http://www.eclipse.org/ocl/3.1.0/Pivot!CollectionKind!Sequence
			symbol_334.setName("Sequence");
			symbol_30.getOwnedLiterals().add(symbol_334);
		}
		...
		{ // Pivot.ecore::pivot::Comment::annotatedElement
			...
			symbol_43.setOpposite(symbol_60);
			{
				...
				symbol_335.setBody("References the Element(s) being commented.");
				symbol_43.getOwnedComments().add(symbol_335);
			}
		...
		{ // Pivot.ecore::pivot::Comment::body
			...
			symbol_44.setIsResolveProxies(true);
			{
				...
				symbol_336.setBody("Specifies a string that is the comment.");
				symbol_44.getOwnedComments().add(symbol_336);
			}
		...
		}
		{
			...
			symbol_337.setBody("A comment is a textual annotation that can be attached to a set of elements.");
			symbol_41.getOwnedComments().add(symbol_337);
		}
		...
		{ // Pivot.ecore::pivot::Constraint::constrainedElement
			...
			symbol_47.setOpposite(symbol_61);
			{
				...
				symbol_338.setBody("The ordered set of Elements referenced by this Constraint.");
				symbol_47.getOwnedComments().add(symbol_338);
			}
		...
		{ // Pivot.ecore::pivot::Constraint::specification
			...
			symbol_50.setOpposite(symbol_304);
			{
				...
				symbol_339.setBody("A condition that must be true when evaluated in order for the constraint to be satisfied.");
				symbol_50.getOwnedComments().add(symbol_339);
			}
		...
		}
		{
			...
			symbol_340.setBody("A constraint is a condition or restriction expressed in natural language text or in a machine readable language for the purpose of declaring some of the semantics of an element.");
			symbol_45.getOwnedComments().add(symbol_340);
		}
		...
		}
		{
			...
			symbol_341.setBody("DataType is an abstract class that acts as a common superclass for different kinds of data types.");
			symbol_52.getOwnedComments().add(symbol_341);
		}
		...
		{ // Pivot.ecore::pivot::Element::ownedComment
			...
			symbol_62.setOpposite(symbol_42);
			{
				...
				symbol_342.setBody("The Comments owned by this element.");
				symbol_62.getOwnedComments().add(symbol_342);
			}
			
			symbol_58.getOwnedAttributes().add(symbol_62);
		}
		{	// Pivot.ecore::pivot::Element::allOwnedElements()
			Operation symbol_343 = PivotFactory.eINSTANCE.createOperation(); // http://www.eclipse.org/ocl/3.1.0/Pivot!Element!allOwnedElements()
			symbol_343.setName("allOwnedElements");
			symbol_343.setType(symbol_58);  // http://www.eclipse.org/ocl/3.1.0/Pivot!Element
		...
		}
		{
			...
			symbol_344.setBody("An element is a constituent of a model.");
			symbol_58.getOwnedComments().add(symbol_344);
		}
		...
		{ // Pivot.ecore::pivot::Enumeration::ownedLiteral
			...
			symbol_66.setOpposite(symbol_69);
			{
				...
				symbol_345.setBody("The ordered set of literals for this Enumeration.");
				symbol_66.getOwnedComments().add(symbol_345);
			}
		...
		}
		{
			...
			symbol_346.setBody("An enumeration defines a set of literals that can be used as its values.");
			symbol_65.getOwnedComments().add(symbol_346);
		}
		...
		{ // Pivot.ecore::pivot::EnumerationLiteral::enumeration
			...
			symbol_69.setOpposite(symbol_66);
			{
				...
				symbol_347.setBody("The Enumeration that this EnumerationLiteral is a member of.");
				symbol_69.getOwnedComments().add(symbol_347);
			}
		...
		}
		{
			...
			symbol_348.setBody("An enumeration literal is a value of an enumeration.");
		...
		{ // Pivot.ecore::pivot::ExpressionInOcl::bodyExpression
			...
			symbol_72.setOpposite(symbol_144);
		...
		{ // Pivot.ecore::pivot::ExpressionInOcl::parameterVariable
			...
			symbol_75.setOpposite(symbol_306);
		...
		{ // Pivot.ecore::pivot::IfExp::thenExpression
			...
			symbol_85.setOpposite(symbol_145);
		...
		{ // Pivot.ecore::pivot::Iteration::ownedIterator
			...
			symbol_97.setOpposite(symbol_181);
		...
		{ // Pivot.ecore::pivot::LambdaType::contextType
			...
			symbol_100.setOpposite(symbol_276);
		...
		{ // Pivot.ecore::pivot::MultiplicityElement::isOrdered
			...
			symbol_122.setIsResolveProxies(true);
			{
				...
				symbol_349.setBody("For a multivalued multiplicity, this attribute specifies whether the values in an instantiation of this element are sequentially ordered.");
				symbol_122.getOwnedComments().add(symbol_349);
			}
		...
		{ // Pivot.ecore::pivot::MultiplicityElement::isUnique
			...
			symbol_123.setIsResolveProxies(true);
			{
				...
				symbol_350.setBody("For a multivalued multiplicity, this attributes specifies whether the values in an instantiation of this element are unique.");
				symbol_123.getOwnedComments().add(symbol_350);
			}
		...
		{ // Pivot.ecore::pivot::MultiplicityElement::lower
			...
			symbol_124.setIsResolveProxies(true);
			{
				...
				symbol_351.setBody("Specifies the lower bound of the multiplicity interval.");
				symbol_124.getOwnedComments().add(symbol_351);
			}
		...
		{ // Pivot.ecore::pivot::MultiplicityElement::upper
			...
			symbol_125.setIsResolveProxies(true);
			{
				...
				symbol_352.setBody("Specifies the upper bound of the multiplicity interval.");
				symbol_125.getOwnedComments().add(symbol_352);
			}
			
			symbol_121.getOwnedAttributes().add(symbol_125);
		}
		{	// Pivot.ecore::pivot::MultiplicityElement::includesCardinality()
			Operation symbol_353 = PivotFactory.eINSTANCE.createOperation(); // http://www.eclipse.org/ocl/3.1.0/Pivot!MultiplicityElement!includesCardinality(http://www.eclipse.org/ocl/3.1.0/Pivot!Integer)
			symbol_353.setName("includesCardinality");
			symbol_353.setType(symbol_14);  // http://www.eclipse.org/ocl/3.1.0/Pivot!Boolean
			
			Parameter symbol_354 = PivotFactory.eINSTANCE.createParameter(); // http://www.eclipse.org/ocl/3.1.0/Pivot!MultiplicityElement!includesCardinality(http://www.eclipse.org/ocl/3.1.0/Pivot!Integer)!C
			symbol_354.setName("C");
			symbol_354.setType(symbol_87);  // http://www.eclipse.org/ocl/3.1.0/Pivot!Integer
			
			
			symbol_353.getOwnedParameters().add(symbol_354);
			{
				Comment symbol_355 = PivotFactory.eINSTANCE.createComment();
				symbol_355.setBody("The query includesCardinality() checks whether the specified cardinality is valid for this multiplicity.");
				symbol_353.getOwnedComments().add(symbol_355);
			}
			
			symbol_121.getOwnedOperations().add(symbol_353);
		}
		{	// Pivot.ecore::pivot::MultiplicityElement::includesMultiplicity()
			Operation symbol_356 = PivotFactory.eINSTANCE.createOperation(); // http://www.eclipse.org/ocl/3.1.0/Pivot!MultiplicityElement!includesMultiplicity(http://www.eclipse.org/ocl/3.1.0/Pivot!MultiplicityElement)
			symbol_356.setName("includesMultiplicity");
			symbol_356.setType(symbol_14);  // http://www.eclipse.org/ocl/3.1.0/Pivot!Boolean
			
			Parameter symbol_357 = PivotFactory.eINSTANCE.createParameter(); // http://www.eclipse.org/ocl/3.1.0/Pivot!MultiplicityElement!includesMultiplicity(http://www.eclipse.org/ocl/3.1.0/Pivot!MultiplicityElement)!M
			symbol_357.setName("M");
			symbol_357.setType(symbol_121);  // http://www.eclipse.org/ocl/3.1.0/Pivot!MultiplicityElement
			
			
			symbol_356.getOwnedParameters().add(symbol_357);
			{
				Comment symbol_358 = PivotFactory.eINSTANCE.createComment();
				symbol_358.setBody("The query includesMultiplicity() checks whether this multiplicity includes all the cardinalities allowed by the specified multiplicity.");
				symbol_356.getOwnedComments().add(symbol_358);
			}
			
			symbol_121.getOwnedOperations().add(symbol_356);
		}
		{	// Pivot.ecore::pivot::MultiplicityElement::isMultivalued()
			Operation symbol_359 = PivotFactory.eINSTANCE.createOperation(); // http://www.eclipse.org/ocl/3.1.0/Pivot!MultiplicityElement!isMultivalued()
			symbol_359.setName("isMultivalued");
			...
			
			{
				...
				symbol_360.setBody("The query isMultivalued() checks whether this multiplicity has an upper bound greater than one.");
				symbol_359.getOwnedComments().add(symbol_360);
			}
			
			symbol_121.getOwnedOperations().add(symbol_359);
		}
		{	// Pivot.ecore::pivot::MultiplicityElement::lowerBound()
			Operation symbol_361 = PivotFactory.eINSTANCE.createOperation(); // http://www.eclipse.org/ocl/3.1.0/Pivot!MultiplicityElement!lowerBound()
			symbol_361.setName("lowerBound");
			symbol_361.setType(symbol_87);  // http://www.eclipse.org/ocl/3.1.0/Pivot!Integer
			
			{
				Comment symbol_362 = PivotFactory.eINSTANCE.createComment();
				symbol_362.setBody("The query lowerBound() returns the lower bound of the multiplicity as an integer.");
				symbol_361.getOwnedComments().add(symbol_362);
			}
			
			symbol_121.getOwnedOperations().add(symbol_361);
		}
		{	// Pivot.ecore::pivot::MultiplicityElement::upperBound()
			Operation symbol_363 = PivotFactory.eINSTANCE.createOperation(); // http://www.eclipse.org/ocl/3.1.0/Pivot!MultiplicityElement!upperBound()
			symbol_363.setName("upperBound");
			symbol_363.setType(symbol_296);  // http://www.eclipse.org/ocl/3.1.0/Pivot!UnlimitedNatural
			
			{
				Comment symbol_364 = PivotFactory.eINSTANCE.createComment();
				symbol_364.setBody("The query upperBound() returns the upper bound of the multiplicity for a bounded multiplicity as an unlimited natural.");
				symbol_363.getOwnedComments().add(symbol_364);
			}
			
			symbol_121.getOwnedOperations().add(symbol_363);
		}
		{
			Comment symbol_365 = PivotFactory.eINSTANCE.createComment();
			symbol_365.setBody("A multiplicity is a definition of an inclusive interval of non-negative integers beginning with a lower bound and ending with a (possibly infinite) upper bound. A multiplicity element embeds this information to specify the allowable cardinalities for an instantiation of this element.");
			symbol_121.getOwnedComments().add(symbol_365);
		}
		...
		{ // Pivot.ecore::pivot::NamedElement::name
			...
			symbol_130.setIsResolveProxies(true);
			{
				...
				symbol_366.setBody("The name of the NamedElement.");
				symbol_130.getOwnedComments().add(symbol_366);
			}
		...
		}
		{
			...
			symbol_367.setBody("A named element represents an element with a name.");
			symbol_127.getOwnedComments().add(symbol_367);
		}
		...
		{ // Pivot.ecore::pivot::OpaqueExpression::body
			...
			symbol_154.setIsResolveProxies(true);
			{
				...
				symbol_368.setBody("The text of the expression, possibly in multiple languages.");
				symbol_154.getOwnedComments().add(symbol_368);
			}
		...
		{ // Pivot.ecore::pivot::OpaqueExpression::language
			...
			symbol_155.setIsResolveProxies(true);
			{
				...
				symbol_369.setBody("Specifies the languages in which the expression is stated. The interpretation of the expression body depends on the languages. If the languages are unspecified, they might be implicit from the expression body or the context. Languages are matched to body strings by order.");
				symbol_155.getOwnedComments().add(symbol_369);
			}
		...
		}
		{
			...
			symbol_370.setBody("An opaque expression is an uninterpreted textual statement that denotes a (possibly empty) set of values when evaluated in a context.");
			symbol_153.getOwnedComments().add(symbol_370);
		}
		...
		{ // Pivot.ecore::pivot::Operation::class
			...
			symbol_162.setIsVolatile(true);
			{
				...
				symbol_371.setBody("The class that owns the operation.");
				symbol_162.getOwnedComments().add(symbol_371);
			}
		...
		{ // Pivot.ecore::pivot::Operation::ownedParameter
			...
			symbol_163.setOpposite(symbol_183);
			{
				...
				symbol_372.setBody("The parameters to the operation.");
				symbol_163.getOwnedComments().add(symbol_372);
			}
		...
		{ // Pivot.ecore::pivot::Operation::raisedException
			...
			symbol_166.setOpposite(symbol_277);
			{
				...
				symbol_373.setBody("The exceptions that are declared as possible during an invocation of the operation.");
				symbol_166.getOwnedComments().add(symbol_373);
			}
		...
		symbol_170.getSuperClasses().add(symbol_241); // http://www.eclipse.org/ocl/3.1.0/Pivot!TemplateParameter
		{
			...
			symbol_375.setBody("An operation template parameter exposes an operation as a formal parameter for a template.");
			symbol_170.getOwnedComments().add(symbol_375);
		}
		...
		{ // Pivot.ecore::pivot::Package::nestedPackage
			...
			symbol_173.setOpposite(symbol_174);
			{
				...
				symbol_376.setBody("The set of contained packages.");
				symbol_173.getOwnedComments().add(symbol_376);
			}
		...
		{ // Pivot.ecore::pivot::Package::nestingPackage
			...
			symbol_174.setOpposite(symbol_173);
			{
				...
				symbol_377.setBody("The containing package.");
				symbol_174.getOwnedComments().add(symbol_377);
			}
		...
		{ // Pivot.ecore::pivot::Package::ownedType
			...
			symbol_178.setOpposite(symbol_286);
			{
				...
				symbol_378.setBody("The set of contained types.");
				symbol_178.getOwnedComments().add(symbol_378);
			}
		...
		}
		{
			...
			symbol_379.setBody("A package is a container for types and other packages.\r\nPackage specializes TemplateableElement and PackageableElement specializes ParameterableElement to specify that a package can be used as a template and a PackageableElement as a template parameter.");
			symbol_172.getOwnedComments().add(symbol_379);
		}
		...
		symbol_179.getSuperClasses().add(symbol_184); // http://www.eclipse.org/ocl/3.1.0/Pivot!ParameterableElement
		{
			...
			symbol_380.setBody("Packageable elements are able to serve as a template parameter.");
			symbol_179.getOwnedComments().add(symbol_380);
		}
		...
		{ // Pivot.ecore::pivot::Parameter::operation
			...
			symbol_183.setOpposite(symbol_163);
			{
				...
				symbol_381.setBody("The operation that owns the parameter.");
				symbol_183.getOwnedComments().add(symbol_381);
			}
		...
		}
		{
			...
			symbol_382.setBody("A parameter is a typed element that represents a parameter of an operation.");
			symbol_180.getOwnedComments().add(symbol_382);
		}
		...
		{ // Pivot.ecore::pivot::ParameterableElement::owningTemplateParameter
			...
			symbol_187.setOpposite(symbol_246);
			{
				...
				symbol_383.setBody("The formal template parameter that owns this element.");
				symbol_187.getOwnedComments().add(symbol_383);
			}
		...
		{ // Pivot.ecore::pivot::ParameterableElement::templateParameter
			...
			symbol_188.setOpposite(symbol_247);
			{
				...
				symbol_384.setBody("The template parameter that exposes this element as a formal parameter.");
				symbol_188.getOwnedComments().add(symbol_384);
			}
			
			symbol_184.getOwnedAttributes().add(symbol_188);
		}
		{	// Pivot.ecore::pivot::ParameterableElement::isCompatibleWith()
			Operation symbol_385 = PivotFactory.eINSTANCE.createOperation(); // http://www.eclipse.org/ocl/3.1.0/Pivot!ParameterableElement!isCompatibleWith(http://www.eclipse.org/ocl/3.1.0/Pivot!ParameterableElement)
			symbol_385.setName("isCompatibleWith");
			symbol_385.setType(symbol_14);  // http://www.eclipse.org/ocl/3.1.0/Pivot!Boolean
			
			Parameter symbol_386 = PivotFactory.eINSTANCE.createParameter(); // http://www.eclipse.org/ocl/3.1.0/Pivot!ParameterableElement!isCompatibleWith(http://www.eclipse.org/ocl/3.1.0/Pivot!ParameterableElement)!p
			symbol_386.setName("p");
			symbol_386.setType(symbol_184);  // http://www.eclipse.org/ocl/3.1.0/Pivot!ParameterableElement
			
			
			symbol_385.getOwnedParameters().add(symbol_386);
			
			symbol_184.getOwnedOperations().add(symbol_385);
		}
		{	// Pivot.ecore::pivot::ParameterableElement::isTemplateParameter()
			Operation symbol_387 = PivotFactory.eINSTANCE.createOperation(); // http://www.eclipse.org/ocl/3.1.0/Pivot!ParameterableElement!isTemplateParameter()
			symbol_387.setName("isTemplateParameter");
			symbol_387.setType(symbol_14);  // http://www.eclipse.org/ocl/3.1.0/Pivot!Boolean
			
			{
				Comment symbol_388 = PivotFactory.eINSTANCE.createComment();
				symbol_388.setBody("The query isTemplateParameter() determines if this parameterable element is exposed as a formal template parameter.");
				symbol_387.getOwnedComments().add(symbol_388);
			}
			
			symbol_184.getOwnedOperations().add(symbol_387);
		}
		{
			Comment symbol_389 = PivotFactory.eINSTANCE.createComment();
			symbol_389.setBody("A parameterable element is an element that can be exposed as a formal template parameter for a template, or specified as an actual parameter in a binding of a template.");
			symbol_184.getOwnedComments().add(symbol_389);
		}
		...
		symbol_196.getSuperClasses().add(symbol_52); // http://www.eclipse.org/ocl/3.1.0/Pivot!DataType
		{
			...
			symbol_390.setBody("A primitive type is a data type implemented by the underlying infrastructure and made available for modeling.");
			symbol_196.getOwnedComments().add(symbol_390);
		}
		...
		{ // Pivot.ecore::pivot::Property::class
			...
			symbol_202.setIsVolatile(true);
			{
				...
				symbol_391.setBody("The class that owns the property, and of which the property is an attribute.");
				symbol_202.getOwnedComments().add(symbol_391);
			}
		...
		{ // Pivot.ecore::pivot::Property::default
			...
			symbol_203.setIsResolveProxies(true);
			{
				...
				symbol_392.setBody("A string that is evaluated to give a default value for the attribute when an object of the owning class is instantiated.");
				symbol_203.getOwnedComments().add(symbol_392);
			}
		...
		{ // Pivot.ecore::pivot::Property::isComposite
			...
			symbol_205.setIsResolveProxies(true);
			{
				...
				symbol_393.setBody("If isComposite is true, the object containing the attribute is a container for the object or value contained in the attribute.");
				symbol_205.getOwnedComments().add(symbol_393);
			}
		...
		{ // Pivot.ecore::pivot::Property::isDerived
			...
			symbol_206.setIsResolveProxies(true);
			{
				...
				symbol_394.setBody("If isDerived is true, the value of the attribute is derived from information elsewhere.");
				symbol_206.getOwnedComments().add(symbol_394);
			}
		...
		{ // Pivot.ecore::pivot::Property::isReadOnly
			...
			symbol_208.setIsResolveProxies(true);
			{
				...
				symbol_395.setBody("If isReadOnly is true, the attribute may not be written to after initialization.");
				symbol_208.getOwnedComments().add(symbol_395);
			}
		...
		{ // Pivot.ecore::pivot::Property::keys
			...
			symbol_213.setOpposite(symbol_199);
		...
		{ // Pivot.ecore::pivot::Property::opposite
			...
			symbol_214.setIsResolveProxies(true);
			{
				...
				symbol_396.setBody("Two attributes attr1 and attr2 of two objects o1 and o2 (which may be the same object) may be paired with each other so that o1.attr1 refers to o2 if and only if o2.attr2 refers to o1. In such a case attr1 is the opposite of attr2 and attr2 is the opposite of attr1.");
				symbol_214.getOwnedComments().add(symbol_396);
			}
		...
		{	// Pivot.ecore::pivot::Property::isAttribute()
			Operation symbol_397 = PivotFactory.eINSTANCE.createOperation(); // http://www.eclipse.org/ocl/3.1.0/Pivot!Property!isAttribute(http://www.eclipse.org/ocl/3.1.0/Pivot!Property)
			symbol_397.setName("isAttribute");
			symbol_397.setType(symbol_14);  // http://www.eclipse.org/ocl/3.1.0/Pivot!Boolean
			
			Parameter symbol_398 = PivotFactory.eINSTANCE.createParameter(); // http://www.eclipse.org/ocl/3.1.0/Pivot!Property!isAttribute(http://www.eclipse.org/ocl/3.1.0/Pivot!Property)!p
			symbol_398.setName("p");
			symbol_398.setType(symbol_197);  // http://www.eclipse.org/ocl/3.1.0/Pivot!Property
			
			
			symbol_397.getOwnedParameters().add(symbol_398);
			
			symbol_197.getOwnedOperations().add(symbol_397);
		}
		{
			Comment symbol_399 = PivotFactory.eINSTANCE.createComment();
			symbol_399.setBody("A property is a typed element that represents an attribute of a class.\r\nProperty specializes ParameterableElement to specify that a property can be exposed as a formal template parameter, and provided as an actual parameter in a binding of a template.");
			symbol_197.getOwnedComments().add(symbol_399);
		}
		...
		{ // Pivot.ecore::pivot::TemplateBinding::boundElement
			...
			symbol_238.setOpposite(symbol_263);
			{
				...
				symbol_400.setBody("The element that is bound by this binding.");
		...
		{ // Pivot.ecore::pivot::TemplateBinding::parameterSubstitution
			...
			symbol_239.setOpposite(symbol_253);
			{
				...
				symbol_401.setBody("The parameter substitutions owned by this template binding.");
				symbol_239.getOwnedComments().add(symbol_401);
			}
		...
		{ // Pivot.ecore::pivot::TemplateBinding::signature
			...
			symbol_240.setOpposite(symbol_257);
			{
				...
				symbol_402.setBody("The template signature for the template that is the target of the binding.");
				symbol_240.getOwnedComments().add(symbol_402);
			}
		...
		}
		{
			...
			symbol_403.setBody("A template binding represents a relationship between a templateable element and a template. A template binding specifies the substitutions of actual parameters for the formal parameters of the template.");
			symbol_237.getOwnedComments().add(symbol_403);
		}
		...
		{ // Pivot.ecore::pivot::TemplateParameter::default
			...
			symbol_244.setOpposite(symbol_185);
			{
				...
				symbol_404.setBody("The element that is the default for this formal template parameter.");
		...
		{ // Pivot.ecore::pivot::TemplateParameter::ownedDefault
			...
			symbol_245.setIsResolveProxies(true);
			{
				...
				symbol_405.setBody("The element that is owned by this template parameter for the purpose of providing a default.");
		...
		{ // Pivot.ecore::pivot::TemplateParameter::ownedParameteredElement
			...
			symbol_246.setOpposite(symbol_187);
			{
				...
				symbol_406.setBody("The element that is owned by this template parameter.");
		...
		{ // Pivot.ecore::pivot::TemplateParameter::parameteredElement
			...
			symbol_247.setOpposite(symbol_188);
			{
				...
				symbol_407.setBody("The element exposed by this template parameter.");
				symbol_247.getOwnedComments().add(symbol_407);
			}
		...
		{ // Pivot.ecore::pivot::TemplateParameter::signature
			...
			symbol_248.setOpposite(symbol_258);
			{
				...
				symbol_408.setBody("The template signature that owns this template parameter.");
		...
		}
		{
			...
			symbol_409.setBody("A template parameter exposes a parameterable element as a formal template parameter of a template.");
			symbol_241.getOwnedComments().add(symbol_409);
		}
		...
		{ // Pivot.ecore::pivot::TemplateParameterSubstitution::actual
			...
			symbol_250.setOpposite(symbol_186);
			{
				...
				symbol_410.setBody("The element that is the actual parameter for this substitution.");
		...
		{ // Pivot.ecore::pivot::TemplateParameterSubstitution::formal
			...
			symbol_251.setOpposite(symbol_242);
			{
				...
				symbol_411.setBody("The formal template parameter that is associated with this substitution.");
		...
		{ // Pivot.ecore::pivot::TemplateParameterSubstitution::ownedActual
			...
			symbol_252.setIsResolveProxies(true);
			{
				...
				symbol_412.setBody("The actual parameter that is owned by this substitution.");
		...
		{ // Pivot.ecore::pivot::TemplateParameterSubstitution::templateBinding
			...
			symbol_253.setOpposite(symbol_239);
			{
				...
				symbol_413.setBody("The optional bindings from this element to templates.");
		...
		}
		{
			...
			symbol_414.setBody("A template parameter substitution relates the actual parameter to a formal template parameter as part of a template binding.");
			symbol_249.getOwnedComments().add(symbol_414);
		}
		...
		{ // Pivot.ecore::pivot::TemplateSignature::ownedParameter
			...
			symbol_258.setOpposite(symbol_248);
			{
				...
				symbol_415.setBody("The formal template parameters that are owned by this template signature.");
		...
		{ // Pivot.ecore::pivot::TemplateSignature::parameter
			...
			symbol_259.setOpposite(symbol_243);
			{
				...
				symbol_416.setBody("The ordered set of all formal template parameters for this template signature.");
				symbol_259.getOwnedComments().add(symbol_416);
			}
		...
		{ // Pivot.ecore::pivot::TemplateSignature::template
			...
			symbol_260.setOpposite(symbol_262);
			{
				...
				symbol_417.setBody("The element that owns this template signature.");
		...
		}
		{
			...
			symbol_418.setBody("A template signature bundles the set of formal template parameters for a templated element.");
			symbol_256.getOwnedComments().add(symbol_418);
		}
		...
		{ // Pivot.ecore::pivot::TemplateableElement::ownedTemplateSignature
			...
			symbol_262.setOpposite(symbol_260);
			{
				...
				symbol_419.setBody("The optional template signature specifying the formal template parameters.");
				symbol_262.getOwnedComments().add(symbol_419);
			}
		...
		{ // Pivot.ecore::pivot::TemplateableElement::templateBinding
			...
			symbol_263.setOpposite(symbol_238);
			{
				...
				symbol_263.getOwnedComments().add(symbol_420);
			}
		...
		{	// Pivot.ecore::pivot::TemplateableElement::isTemplate()
			Operation symbol_421 = PivotFactory.eINSTANCE.createOperation(); // http://www.eclipse.org/ocl/3.1.0/Pivot!TemplateableElement!isTemplate()
			symbol_421.setName("isTemplate");
			symbol_421.setType(symbol_14);  // http://www.eclipse.org/ocl/3.1.0/Pivot!Boolean
			
			{
				Comment symbol_422 = PivotFactory.eINSTANCE.createComment();
				symbol_422.setBody("The query isTemplate() returns whether this templateable element is actually a template.");
				symbol_421.getOwnedComments().add(symbol_422);
			}
			
			symbol_261.getOwnedOperations().add(symbol_421);
		}
		{	// Pivot.ecore::pivot::TemplateableElement::parameterableElements()
			Operation symbol_423 = PivotFactory.eINSTANCE.createOperation(); // http://www.eclipse.org/ocl/3.1.0/Pivot!TemplateableElement!parameterableElements()
			symbol_423.setName("parameterableElements");
			symbol_423.setType(symbol_184);  // http://www.eclipse.org/ocl/3.1.0/Pivot!ParameterableElement
			symbol_423.setLower(BigInteger.valueOf(0));
			symbol_423.setUpper(BigInteger.valueOf(-1));
			
			{
				Comment symbol_424 = PivotFactory.eINSTANCE.createComment();
				symbol_424.setBody("The query parameterableElements() returns the set of elements that may be used as the parametered elements for a template parameter of this templateable element. By default, this set includes all the owned elements. Subclasses may override this operation if they choose to restrict the set of parameterable elements.");
				symbol_423.getOwnedComments().add(symbol_424);
			}
			
			symbol_261.getOwnedOperations().add(symbol_423);
		}
		{
			Comment symbol_425 = PivotFactory.eINSTANCE.createComment();
			symbol_425.setBody("A templateable element is an element that can optionally be defined as a template and bound to other templates.");
			symbol_261.getOwnedComments().add(symbol_425);
		}
		...
		{ // Pivot.ecore::pivot::Type::package
			...
			symbol_286.setOpposite(symbol_178);
			{
				...
				symbol_426.setBody("Specifies the owning package of this classifier, if any.");
				symbol_286.getOwnedComments().add(symbol_426);
			}
		...
		{ // Pivot.ecore::pivot::TypeTemplateParameter::allowSubstitutable
			...
			symbol_291.setIsResolveProxies(true);
			{
				...
				symbol_428.setBody("Constrains the required relationship between an actual parameter and the parameteredElement for this formal parameter.");
				symbol_291.getOwnedComments().add(symbol_428);
			}
		...
		{ // Pivot.ecore::pivot::TypeTemplateParameter::constrainingType
			...
			symbol_292.setOpposite(symbol_280);
			{
				...
				symbol_429.setBody("The classifiers that constrain the argument that can be used for the parameter. If the allowSubstitutable attribute is true, then any classifier that is compatible with this constraining classifier can be substituted; otherwise, it must be either this classifier or one of its subclasses. If this property is empty, there are no constraints on the classifier that can be used as an argument.");
		...
		}
		{
			...
			symbol_430.setBody("A type template parameter exposes a type as a formal template parameter.");
			symbol_290.getOwnedComments().add(symbol_430);
		}
		...
		{ // Pivot.ecore::pivot::TypedElement::type
			...
			symbol_294.setOpposite(symbol_281);
			{
				...
				symbol_431.setBody("The type of the TypedElement.");
				symbol_294.getOwnedComments().add(symbol_431);
			}
		...
		}
		{
			...
			symbol_432.setBody("A typed element is a kind of named element that represents an element with a type.");
			symbol_293.getOwnedComments().add(symbol_432);
		}
		...
		{ // Pivot.ecore::pivot::UnspecifiedType::upperBound
			...
			symbol_301.setOpposite(symbol_282);
		...
		{	// Pivot.ecore::pivot::ValueSpecification::booleanValue()
			...
			symbol_303.getOwnedOperations().add(symbol_433);
		}
		{	// Pivot.ecore::pivot::ValueSpecification::integerValue()
			...
			symbol_435.setType(symbol_87);  // http://www.eclipse.org/ocl/3.1.0/Pivot!Integer
			...
			symbol_303.getOwnedOperations().add(symbol_435);
		}
		{	// Pivot.ecore::pivot::ValueSpecification::isComputable()
			...
			symbol_303.getOwnedOperations().add(symbol_437);
		}
		{	// Pivot.ecore::pivot::ValueSpecification::isNull()
			...
			symbol_303.getOwnedOperations().add(symbol_439);
		}
		{	// Pivot.ecore::pivot::ValueSpecification::stringValue()
			...
			symbol_441.setType(symbol_234);  // http://www.eclipse.org/ocl/3.1.0/Pivot!String
			...
			symbol_303.getOwnedOperations().add(symbol_441);
		}
		{	// Pivot.ecore::pivot::ValueSpecification::unlimitedValue()
			...
			symbol_443.setType(symbol_296);  // http://www.eclipse.org/ocl/3.1.0/Pivot!UnlimitedNatural
			...
			symbol_303.getOwnedOperations().add(symbol_443);
		}
		{
			...
			symbol_303.getOwnedComments().add(symbol_445);
		}
