	...
	public static class _invariant_ConditionTypeIsBoolean extends AbstractUnaryOperation
	{
		...
		*/
		public Value evaluate(DomainEvaluator evaluator, DomainType returnType, final Value self) throws InvalidValueException {
			...
			Value A_symbol_369 = IP_IfExp_condition.evaluate(evaluator, T_Pivot_ecore__pivot__OclExpression, self, P_IfExp_condition);
			
			Value A_symbol_370 = IP_TypedElement_type.evaluate(evaluator, T_Pivot_ecore__pivot__Type, A_symbol_369, P_TypedElement_type);
			
			DomainType static_A_symbol_371 = valueFactory.typeOf(A_symbol_370, T_ClassClassifier_Boolean_);
			...
			Value A_symbol_371 = dynamic_A_symbol_371.evaluate(evaluator, T_Boolean, A_symbol_370, T_ClassClassifier_Boolean_);
			return A_symbol_371;
		}
	}
