 ...
 * </copyright>
 *
 * $Id: ObjectUtil.java,v 1.1.2.1 2010/10/01 13:51:56 ewillink Exp $
 */
...
/*		// primitive types
		...
		if ((anObject instanceof BigDecimal) && (anotherObject instanceof BigInteger)) {
			anotherObject = new BigDecimal((BigInteger)anotherObject);				
		}
		else if ((anObject instanceof BigInteger) && (anotherObject instanceof BigDecimal)) {
