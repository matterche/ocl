 ...
 * 
 * $Id: TypeChecker.java,v 1.1.2.1 2010/10/01 13:51:56 ewillink Exp $
 */
...
public interface TypeChecker {
	 ...
	 *         the operation
	 */
	Type getResultType(Object problemObject, Type owner, Operation operation,
	 ...
	 *         case
	 */
	Type getPropertyType(Type owner, Property property);
	 ...
	 */
	Type commonSuperType(Object problemObject, Type type1, Type type2);
	 ...
	 */
//	boolean checkMutuallyComparable(Object problemObject, Type type1, Type type2,
//			int opcode);
	 ...
	 */
	boolean exactTypeMatch(Type type1, Type type2);
	 ...
	 */
	boolean compatibleTypeMatch(Type type1, Type type2);
	 ...
	 */
	List<Operation> getOperations(Type owner);
	 ...
	 */
	List<Property> getAttributes(Type owner);
	 ...
	 */
	Operation resolveGenericSignature(Type owner, Operation oper);
	 ...
	 */
	Signal findSignalMatching(Type receiver, List<Signal> signals, String name,
			List<? extends TypedElement> args);
	 ...
	 */
	Operation findOperationMatching(Type owner, String name,
			List<? extends TypedElement> args);
	 ...
	 */
	boolean matchArgs(Type owner, List<?> paramsOrProperties,
			List<? extends TypedElement> args);
	 ...
	 * @return the matching operation, or <code>null</code> if not found
	 */
	Property findAttribute(Type owner, String name);
	 ...
	 */
	boolean isStandardLibraryFeature(Type owner, Object feature);
}
