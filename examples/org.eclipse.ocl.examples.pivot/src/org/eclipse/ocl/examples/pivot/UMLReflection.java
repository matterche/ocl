...
public interface UMLReflection {
     ...
     * @see #isMany(Object)
     */
    Type getOCLType(Object metaElement);
     ...
     */
    Collection<? extends Type> getAllSupertypes(Type classifier);
     ...
     */
    org.eclipse.ocl.examples.pivot.Package getNestingPackage(org.eclipse.ocl.examples.pivot.Package pkg);
     ...
     *    is none
     */
    org.eclipse.ocl.examples.pivot.Package getPackage(Type classifier);
     ...
     */
    List<Type> getClassifiers(org.eclipse.ocl.examples.pivot.Package pkg);
     ...
     *     be <code>null</code>)
     */
    Type getOwningClassifier(Object feature);
     ...
     */     
    List<Signal> getSignals(Type owner);
     ...
     * @see #isQuery(Object)
     */
    Operation createOperation(String name, Type resultType, List<String> paramNames,
     ...
     */
    List<Parameter> getParameters(Operation operation);
     ...
     *    empty list if none
     */
    List<Operation> getOperations(Type classifier);
     ...
     */
    Property createProperty(String name, Type resultType);
     ...
     *    empty list if none
     */
    List<Property> getAttributes(Type classifier);
     ...
     */
    boolean isQuery(Operation operation);
     ...
     */
    List<Property> getQualifiers(Property property);
     ...
     */
    boolean isAssociationClass(Type type);
     ...
     */
    Type getAssociationClass(Property property);
     ...
     */
    List<Property> getMemberEnds(Type associationClass);
     ...
     */
    boolean isStereotype(Type type);
     ...
     */
    Object getStereotypeApplication(Object baseElement, Type stereotype);
     ...
     */
    boolean isEnumeration(Type type);
     ...
     */
    Type getEnumeration(EnumerationLiteral enumerationLiteral);
     ...
     */
    List<EnumerationLiteral> getEnumerationLiterals(Type enumerationType);
     ...
     */
    EnumerationLiteral getEnumerationLiteral(Type enumerationType, String literalName);
     ...
     */
//    COA createCallOperationAction(Operation operation);
     ...
     */
//    SSA createSendSignalAction(Type signal);
     ...
     */
    String getStereotype(Constraint constraint);
     ...
     */
    void setStereotype(Constraint constraint, String stereotype);
     ...
     */
    String getConstraintName(Constraint constraint);
     ...
     */
    void setConstraintName(Constraint constraint, String name);
     ...
     */
    void setSpecification(Constraint constraint, ExpressionInOcl specification);
     ...
     */
    Constraint getConstraint(ExpressionInOcl specification);
     ...
     */
    List<? extends EObject> getConstrainedElements(Constraint constraint);
     ...
     * @since 3.0
     */
    void addConstrainedElement(Constraint constraint, Element constrainedElement);
     ...
     */
    int getRelationship(Type type1, Type type2);
     ...
     */
    void setName(TypedElement element, String name);
     ...
     */
    void setType(TypedElement element, Type type);
}
