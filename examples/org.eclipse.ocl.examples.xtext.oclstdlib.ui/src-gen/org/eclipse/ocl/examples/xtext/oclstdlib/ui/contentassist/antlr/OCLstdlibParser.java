		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getClassCSAccess().getAlternatives_5(), "rule__ClassCS__Alternatives_5");
					...
					put(grammarAccess.getLibIterationCSAccess().getAlternatives_13(), "rule__LibIterationCS__Alternatives_13");
					put(grammarAccess.getLibIterationCSAccess().getAlternatives_13_0_1(), "rule__LibIterationCS__Alternatives_13_0_1");
					...
					put(grammarAccess.getNavigatingArgCSnextAccess().getAlternatives(), "rule__NavigatingArgCSnext__Alternatives");
					...
					put(grammarAccess.getLibIterationCSAccess().getGroup_13_0(), "rule__LibIterationCS__Group_13_0__0");
					...
					put(grammarAccess.getLibOperationCSAccess().getGroup_8(), "rule__LibOperationCS__Group_8__0");
					...
					put(grammarAccess.getNavigatingArgCSfirstAccess().getGroup(), "rule__NavigatingArgCSfirst__Group__0");
					put(grammarAccess.getNavigatingArgCSfirstAccess().getGroup_1(), "rule__NavigatingArgCSfirst__Group_1__0");
					put(grammarAccess.getNavigatingArgCSnextAccess().getGroup_0(), "rule__NavigatingArgCSnext__Group_0__0");
					put(grammarAccess.getNavigatingArgCSnextAccess().getGroup_1(), "rule__NavigatingArgCSnext__Group_1__0");
					put(grammarAccess.getNavigatingArgCSnextAccess().getGroup_1_2(), "rule__NavigatingArgCSnext__Group_1_2__0");
					put(grammarAccess.getNavigatingArgCSnextAccess().getGroup_2(), "rule__NavigatingArgCSnext__Group_2__0");
					...
					put(grammarAccess.getClassCSAccess().getOwnedSuperTypeAssignment_3_1(), "rule__ClassCS__OwnedSuperTypeAssignment_3_1");
					put(grammarAccess.getClassCSAccess().getOwnedSuperTypeAssignment_3_2_1(), "rule__ClassCS__OwnedSuperTypeAssignment_3_2_1");
					put(grammarAccess.getClassCSAccess().getOwnedOperationAssignment_5_0(), "rule__ClassCS__OwnedOperationAssignment_5_0");
					put(grammarAccess.getClassCSAccess().getOwnedPropertyAssignment_5_1(), "rule__ClassCS__OwnedPropertyAssignment_5_1");
					put(grammarAccess.getClassCSAccess().getOwnedAnnotationAssignment_5_2(), "rule__ClassCS__OwnedAnnotationAssignment_5_2");
					...
					put(grammarAccess.getLibIterationCSAccess().getImplementationAssignment_12(), "rule__LibIterationCS__ImplementationAssignment_12");
					...
					put(grammarAccess.getLibOperationCSAccess().getOwnedTemplateSignatureAssignment_2(), "rule__LibOperationCS__OwnedTemplateSignatureAssignment_2");
					put(grammarAccess.getLibOperationCSAccess().getOwnedParameterAssignment_4_0(), "rule__LibOperationCS__OwnedParameterAssignment_4_0");
					put(grammarAccess.getLibOperationCSAccess().getOwnedParameterAssignment_4_1_1(), "rule__LibOperationCS__OwnedParameterAssignment_4_1_1");
					put(grammarAccess.getLibOperationCSAccess().getOwnedTypeAssignment_7(), "rule__LibOperationCS__OwnedTypeAssignment_7");
					put(grammarAccess.getLibOperationCSAccess().getPrecedenceAssignment_8_2(), "rule__LibOperationCS__PrecedenceAssignment_8_2");
					put(grammarAccess.getLibOperationCSAccess().getImplementationAssignment_10(), "rule__LibOperationCS__ImplementationAssignment_10");
					...
					put(grammarAccess.getLibPropertyCSAccess().getOwnedTypeAssignment_3(), "rule__LibPropertyCS__OwnedTypeAssignment_3");
					put(grammarAccess.getLibPropertyCSAccess().getImplementationAssignment_5(), "rule__LibPropertyCS__ImplementationAssignment_5");
					...
					put(grammarAccess.getBinaryOperatorCSAccess().getNameAssignment(), "rule__BinaryOperatorCS__NameAssignment");
					...
					put(grammarAccess.getNavigatingExpCSAccess().getArgumentsAssignment_1_2_0(), "rule__NavigatingExpCS__ArgumentsAssignment_1_2_0");
					put(grammarAccess.getNavigatingExpCSAccess().getArgumentsAssignment_1_2_1(), "rule__NavigatingExpCS__ArgumentsAssignment_1_2_1");
					put(grammarAccess.getNavigatingArgCSfirstAccess().getNameAssignment_0(), "rule__NavigatingArgCSfirst__NameAssignment_0");
					put(grammarAccess.getNavigatingArgCSfirstAccess().getOwnedTypeAssignment_1_1(), "rule__NavigatingArgCSfirst__OwnedTypeAssignment_1_1");
					put(grammarAccess.getNavigatingArgCSnextAccess().getPrefixAssignment_0_0(), "rule__NavigatingArgCSnext__PrefixAssignment_0_0");
					put(grammarAccess.getNavigatingArgCSnextAccess().getNameAssignment_0_1(), "rule__NavigatingArgCSnext__NameAssignment_0_1");
					put(grammarAccess.getNavigatingArgCSnextAccess().getPrefixAssignment_1_0(), "rule__NavigatingArgCSnext__PrefixAssignment_1_0");
					put(grammarAccess.getNavigatingArgCSnextAccess().getNameAssignment_1_1(), "rule__NavigatingArgCSnext__NameAssignment_1_1");
					put(grammarAccess.getNavigatingArgCSnextAccess().getOwnedTypeAssignment_1_2_1(), "rule__NavigatingArgCSnext__OwnedTypeAssignment_1_2_1");
					put(grammarAccess.getNavigatingArgCSnextAccess().getPrefixAssignment_2_0(), "rule__NavigatingArgCSnext__PrefixAssignment_2_0");
					put(grammarAccess.getNavigatingArgCSnextAccess().getNameAssignment_2_1(), "rule__NavigatingArgCSnext__NameAssignment_2_1");
					put(grammarAccess.getNavigatingArgCSnextAccess().getOwnedTypeAssignment_2_3(), "rule__NavigatingArgCSnext__OwnedTypeAssignment_2_3");
					put(grammarAccess.getNavigatingArgCSnextAccess().getInitAssignment_2_5(), "rule__NavigatingArgCSnext__InitAssignment_2_5");
