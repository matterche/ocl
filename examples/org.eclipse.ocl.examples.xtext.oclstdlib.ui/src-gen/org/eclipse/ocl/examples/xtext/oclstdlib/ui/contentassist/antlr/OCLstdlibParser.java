		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getClassCSAccess().getOwnedMetaTypeAssignment_4_1(), "rule__ClassCS__OwnedMetaTypeAssignment_4_1");
					put(grammarAccess.getClassCSAccess().getOwnedSuperTypeAssignment_5_1(), "rule__ClassCS__OwnedSuperTypeAssignment_5_1");
					put(grammarAccess.getClassCSAccess().getOwnedSuperTypeAssignment_5_2_1(), "rule__ClassCS__OwnedSuperTypeAssignment_5_2_1");
					put(grammarAccess.getClassCSAccess().getOwnedOperationAssignment_7_0(), "rule__ClassCS__OwnedOperationAssignment_7_0");
					put(grammarAccess.getClassCSAccess().getOwnedPropertyAssignment_7_1(), "rule__ClassCS__OwnedPropertyAssignment_7_1");
					put(grammarAccess.getClassCSAccess().getOwnedConstraintAssignment_7_2(), "rule__ClassCS__OwnedConstraintAssignment_7_2");
					put(grammarAccess.getClassCSAccess().getOwnedAnnotationAssignment_7_3(), "rule__ClassCS__OwnedAnnotationAssignment_7_3");
					...
					put(grammarAccess.getLibIterationCSAccess().getOwnedParameterAssignment_4(), "rule__LibIterationCS__OwnedParameterAssignment_4");
					put(grammarAccess.getLibIterationCSAccess().getOwnedParameterAssignment_5_1(), "rule__LibIterationCS__OwnedParameterAssignment_5_1");
					put(grammarAccess.getLibIterationCSAccess().getOwnedParameterAssignment_6_1(), "rule__LibIterationCS__OwnedParameterAssignment_6_1");
					put(grammarAccess.getLibIterationCSAccess().getOwnedParameterAssignment_6_2_1(), "rule__LibIterationCS__OwnedParameterAssignment_6_2_1");
