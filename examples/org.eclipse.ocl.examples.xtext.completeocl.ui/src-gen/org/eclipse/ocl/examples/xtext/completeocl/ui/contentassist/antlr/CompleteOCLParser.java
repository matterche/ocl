		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getDefCSAccess().getFeatureAlternatives_4_0(), "rule__DefCS__FeatureAlternatives_4_0");
					...
					put(grammarAccess.getDefOperationCSAccess().getGroup_2(), "rule__DefOperationCS__Group_2__0");
					put(grammarAccess.getDefOperationCSAccess().getGroup_2_1(), "rule__DefOperationCS__Group_2_1__0");
					...
					put(grammarAccess.getDefCSAccess().getFeatureAssignment_4(), "rule__DefCS__FeatureAssignment_4");
					put(grammarAccess.getDefCSAccess().getSpecificationAssignment_6(), "rule__DefCS__SpecificationAssignment_6");
					put(grammarAccess.getDefOperationCSAccess().getNameAssignment_0(), "rule__DefOperationCS__NameAssignment_0");
					put(grammarAccess.getDefOperationCSAccess().getParametersAssignment_2_0(), "rule__DefOperationCS__ParametersAssignment_2_0");
					put(grammarAccess.getDefOperationCSAccess().getParametersAssignment_2_1_1(), "rule__DefOperationCS__ParametersAssignment_2_1_1");
					put(grammarAccess.getDefOperationCSAccess().getOwnedTypeAssignment_5(), "rule__DefOperationCS__OwnedTypeAssignment_5");
					...
					put(grammarAccess.getDefPropertyCSAccess().getNameAssignment_0(), "rule__DefPropertyCS__NameAssignment_0");
					put(grammarAccess.getDefPropertyCSAccess().getOwnedTypeAssignment_2(), "rule__DefPropertyCS__OwnedTypeAssignment_2");
