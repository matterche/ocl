		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getOperationContextDeclCSAccess().getAlternatives_1(), "rule__OperationContextDeclCS__Alternatives_1");
					...
					put(grammarAccess.getClassifierContextDeclCSAccess().getGroup_2_0_2(), "rule__ClassifierContextDeclCS__Group_2_0_2__0");
					...
					put(grammarAccess.getOperationContextDeclCSAccess().getGroup_1_0(), "rule__OperationContextDeclCS__Group_1_0__0");
					put(grammarAccess.getOperationContextDeclCSAccess().getGroup_1_0_2(), "rule__OperationContextDeclCS__Group_1_0_2__0");
					...
					put(grammarAccess.getPackageDeclarationCSAccess().getGroup_1_0(), "rule__PackageDeclarationCS__Group_1_0__0");
					put(grammarAccess.getPackageDeclarationCSAccess().getGroup_1_0_2(), "rule__PackageDeclarationCS__Group_1_0_2__0");
					...
					put(grammarAccess.getPropertyContextDeclCSAccess().getGroup_1_0(), "rule__PropertyContextDeclCS__Group_1_0__0");
					put(grammarAccess.getPropertyContextDeclCSAccess().getGroup_1_0_2(), "rule__PropertyContextDeclCS__Group_1_0_2__0");
					...
					put(grammarAccess.getClassifierContextDeclCSAccess().getNamespaceAssignment_2_0_0(), "rule__ClassifierContextDeclCS__NamespaceAssignment_2_0_0");
					put(grammarAccess.getClassifierContextDeclCSAccess().getNamespaceAssignment_2_0_2_0(), "rule__ClassifierContextDeclCS__NamespaceAssignment_2_0_2_0");
					put(grammarAccess.getClassifierContextDeclCSAccess().getClassifierAssignment_2_0_3(), "rule__ClassifierContextDeclCS__ClassifierAssignment_2_0_3");
					put(grammarAccess.getClassifierContextDeclCSAccess().getClassifierAssignment_2_1(), "rule__ClassifierContextDeclCS__ClassifierAssignment_2_1");
					...
					put(grammarAccess.getDefCSAccess().getSpecificationAssignment_9(), "rule__DefCS__SpecificationAssignment_9");
					...
					put(grammarAccess.getOperationContextDeclCSAccess().getNamespaceAssignment_1_0_0(), "rule__OperationContextDeclCS__NamespaceAssignment_1_0_0");
					put(grammarAccess.getOperationContextDeclCSAccess().getNamespaceAssignment_1_0_2_0(), "rule__OperationContextDeclCS__NamespaceAssignment_1_0_2_0");
					put(grammarAccess.getOperationContextDeclCSAccess().getOperationAssignment_1_0_3(), "rule__OperationContextDeclCS__OperationAssignment_1_0_3");
					put(grammarAccess.getOperationContextDeclCSAccess().getOperationAssignment_1_1(), "rule__OperationContextDeclCS__OperationAssignment_1_1");
					...
					put(grammarAccess.getOperationContextDeclCSAccess().getRulesAssignment_7_0(), "rule__OperationContextDeclCS__RulesAssignment_7_0");
					put(grammarAccess.getOperationContextDeclCSAccess().getRulesAssignment_7_1(), "rule__OperationContextDeclCS__RulesAssignment_7_1");
					put(grammarAccess.getOperationContextDeclCSAccess().getRulesAssignment_7_2(), "rule__OperationContextDeclCS__RulesAssignment_7_2");
					put(grammarAccess.getPackageDeclarationCSAccess().getNamespaceAssignment_1_0_0(), "rule__PackageDeclarationCS__NamespaceAssignment_1_0_0");
					put(grammarAccess.getPackageDeclarationCSAccess().getNamespaceAssignment_1_0_2_0(), "rule__PackageDeclarationCS__NamespaceAssignment_1_0_2_0");
					put(grammarAccess.getPackageDeclarationCSAccess().getPackageAssignment_1_0_3(), "rule__PackageDeclarationCS__PackageAssignment_1_0_3");
					put(grammarAccess.getPackageDeclarationCSAccess().getPackageAssignment_1_1(), "rule__PackageDeclarationCS__PackageAssignment_1_1");
					...
					put(grammarAccess.getPropertyContextDeclCSAccess().getNamespaceAssignment_1_0_0(), "rule__PropertyContextDeclCS__NamespaceAssignment_1_0_0");
					put(grammarAccess.getPropertyContextDeclCSAccess().getNamespaceAssignment_1_0_2_0(), "rule__PropertyContextDeclCS__NamespaceAssignment_1_0_2_0");
					put(grammarAccess.getPropertyContextDeclCSAccess().getPropertyAssignment_1_0_3(), "rule__PropertyContextDeclCS__PropertyAssignment_1_0_3");
					put(grammarAccess.getPropertyContextDeclCSAccess().getPropertyAssignment_1_1(), "rule__PropertyContextDeclCS__PropertyAssignment_1_1");
					...
					put(grammarAccess.getPropertyContextDeclCSAccess().getRulesAssignment_4_0_0(), "rule__PropertyContextDeclCS__RulesAssignment_4_0_0");
