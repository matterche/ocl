		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getOperationContextDeclCSAccess().getGroup_1_2(), "rule__OperationContextDeclCS__Group_1_2__0");
					...
					put(grammarAccess.getPropertyContextDeclCSAccess().getGroup_1(), "rule__PropertyContextDeclCS__Group_1__0");
					put(grammarAccess.getPropertyContextDeclCSAccess().getGroup_1_2(), "rule__PropertyContextDeclCS__Group_1_2__0");
					put(grammarAccess.getPropertyContextDeclCSAccess().getGroup_5_0(), "rule__PropertyContextDeclCS__Group_5_0__0");
					put(grammarAccess.getPropertyContextDeclCSAccess().getGroup_5_1(), "rule__PropertyContextDeclCS__Group_5_1__0");
					...
					put(grammarAccess.getOperationContextDeclCSAccess().getNamespaceAssignment_1_2_0(), "rule__OperationContextDeclCS__NamespaceAssignment_1_2_0");
					...
					put(grammarAccess.getOperationContextDeclCSAccess().getParametersAssignment_4_1_1(), "rule__OperationContextDeclCS__ParametersAssignment_4_1_1");
					...
					put(grammarAccess.getOperationContextDeclCSAccess().getRulesAssignment_8_0(), "rule__OperationContextDeclCS__RulesAssignment_8_0");
					put(grammarAccess.getOperationContextDeclCSAccess().getRulesAssignment_8_1(), "rule__OperationContextDeclCS__RulesAssignment_8_1");
					put(grammarAccess.getOperationContextDeclCSAccess().getRulesAssignment_8_2(), "rule__OperationContextDeclCS__RulesAssignment_8_2");
					...
					put(grammarAccess.getPropertyContextDeclCSAccess().getNamespaceAssignment_1_0(), "rule__PropertyContextDeclCS__NamespaceAssignment_1_0");
					put(grammarAccess.getPropertyContextDeclCSAccess().getNamespaceAssignment_1_2_0(), "rule__PropertyContextDeclCS__NamespaceAssignment_1_2_0");
					put(grammarAccess.getPropertyContextDeclCSAccess().getPropertyAssignment_2(), "rule__PropertyContextDeclCS__PropertyAssignment_2");
					...
					put(grammarAccess.getPropertyContextDeclCSAccess().getRulesAssignment_5_0_0(), "rule__PropertyContextDeclCS__RulesAssignment_5_0_0");
					put(grammarAccess.getPropertyContextDeclCSAccess().getRulesAssignment_5_0_1(), "rule__PropertyContextDeclCS__RulesAssignment_5_0_1");
					put(grammarAccess.getPropertyContextDeclCSAccess().getRulesAssignment_5_1_0(), "rule__PropertyContextDeclCS__RulesAssignment_5_1_0");
					put(grammarAccess.getPropertyContextDeclCSAccess().getRulesAssignment_5_1_1(), "rule__PropertyContextDeclCS__RulesAssignment_5_1_1");
