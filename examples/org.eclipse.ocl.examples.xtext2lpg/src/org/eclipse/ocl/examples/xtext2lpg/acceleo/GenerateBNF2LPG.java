 ...
 *******************************************************************************/
package org.eclipse.ocl.examples.xtext2lpg.acceleo;
...
/**
 * Entry point of the 'GenerateBNF2LPG' generation module.
 *
 * @generated
 */
public class GenerateBNF2LPG extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/org/eclipse/ocl/examples/xtext2lpg/acceleo/generateBNF2LPG";
     ...
     * @generated
     */
    public GenerateBNF2LPG(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public GenerateBNF2LPG(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                GenerateBNF2LPG generator = new GenerateBNF2LPG(modelURI, folder, arguments);
...
//        if (!isInWorkspace(BNFPackage.class)) {
//            resourceSet.getPackageRegistry().put(BNFPackage.eINSTANCE.getNsURI(), BNFPackage.eINSTANCE);
//        }
    ...
    public void registerResourceFactories(ResourceSet resourceSet) {
        ...
        resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put("XBNF", new XMIResourceFactoryImpl());
    }
