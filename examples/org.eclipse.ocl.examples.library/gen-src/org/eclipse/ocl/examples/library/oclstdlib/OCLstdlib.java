 ...
 * Do not edit it.
 *
 * $Id: OCLstdlib.java,v 1.1.2.11 2010/12/28 12:21:49 ewillink Exp $
 */
...
public class OCLstdlib extends XMLResourceImpl
{
	...
	public static Library create()
	{
		...
		Precedence symbol_3 = PivotFactory.eINSTANCE.createPrecedence(); // OR
		Precedence symbol_4 = PivotFactory.eINSTANCE.createPrecedence(); // EQUALITY
		Precedence symbol_5 = PivotFactory.eINSTANCE.createPrecedence(); // ADDITIVE
		Precedence symbol_6 = PivotFactory.eINSTANCE.createPrecedence(); // AND
		Precedence symbol_7 = PivotFactory.eINSTANCE.createPrecedence(); // XOR
		Precedence symbol_8 = PivotFactory.eINSTANCE.createPrecedence(); // MULTIPLICATIVE
		Precedence symbol_9 = PivotFactory.eINSTANCE.createPrecedence(); // RELATIONAL
		Precedence symbol_10 = PivotFactory.eINSTANCE.createPrecedence(); // NAVIGATION
		Precedence symbol_11 = PivotFactory.eINSTANCE.createPrecedence(); // UNARY
		...
		CollectionType symbol_103 = PivotFactory.eINSTANCE.createCollectionType(); // ocl|Collection[ocl|Collection{T}|product{T2}(ocl|Collection[T2])?T2]
		
		CollectionType symbol_104 = PivotFactory.eINSTANCE.createCollectionType(); // ocl|Collection[ocl|Collection{T}|includesAll{T2}(ocl|Collection[T2])?T2]
		
		CollectionType symbol_105 = PivotFactory.eINSTANCE.createCollectionType(); // ocl|Collection[ocl|UniqueCollection{T}?T]
		
		CollectionType symbol_106 = PivotFactory.eINSTANCE.createCollectionType(); // ocl|Collection[ocl|NonOrderedCollection{T}?T]
		
		CollectionType symbol_107 = PivotFactory.eINSTANCE.createCollectionType(); // ocl|Collection[ocl|OrderedCollection{T}?T]
		...
		CollectionType symbol_115 = PivotFactory.eINSTANCE.createCollectionType(); // ocl|OrderedCollection[ocl|OrderedCollection{T}?T]
		
		CollectionType symbol_116 = PivotFactory.eINSTANCE.createCollectionType(); // ocl|OrderedCollection[ocl|OrderedSet{T}?T]
		
		CollectionType symbol_117 = PivotFactory.eINSTANCE.createCollectionType(); // ocl|OrderedCollection[ocl|Collection{T}?T]
		
		CollectionType symbol_118 = PivotFactory.eINSTANCE.createCollectionType(); // ocl|OrderedCollection[ocl|Sequence{T}?T]
		
		OrderedSetType symbol_119 = PivotFactory.eINSTANCE.createOrderedSetType(); // ocl|OrderedSet[ocl|UniqueCollection{T}?T]
		
		OrderedSetType symbol_120 = PivotFactory.eINSTANCE.createOrderedSetType(); // ocl|OrderedSet[ocl|OrderedSet{T}?T]
		
		OrderedSetType symbol_121 = PivotFactory.eINSTANCE.createOrderedSetType(); // ocl|OrderedSet[ocl|OrderedCollection{T}?T]
		
		OrderedSetType symbol_122 = PivotFactory.eINSTANCE.createOrderedSetType(); // ocl|OrderedSet[ocl|Collection{T}?T]
		
		SequenceType symbol_123 = PivotFactory.eINSTANCE.createSequenceType(); // ocl|Sequence[ocl|OrderedCollection{T}?T]
		...
		SequenceType symbol_126 = PivotFactory.eINSTANCE.createSequenceType(); // ocl|Sequence[ocl|String]
		
		SequenceType symbol_127 = PivotFactory.eINSTANCE.createSequenceType(); // ocl|Sequence[ocl|Sequence{T}?T]
		
		SequenceType symbol_128 = PivotFactory.eINSTANCE.createSequenceType(); // ocl|Sequence[ocl|Collection{T}?T]
		
		SetType symbol_129 = PivotFactory.eINSTANCE.createSetType(); // ocl|Set[ocl|Tuple[ocl|Collection{T}?T,ocl|Collection{T}|product{T2}(ocl|Collection[T2])?T2]]
		
		SetType symbol_130 = PivotFactory.eINSTANCE.createSetType(); // ocl|Set[ocl|OrderedSet{T}?T]
		
		SetType symbol_131 = PivotFactory.eINSTANCE.createSetType(); // ocl|Set[ocl|OclAny]
		
		SetType symbol_132 = PivotFactory.eINSTANCE.createSetType(); // ocl|Set[ocl|Set{T}|flatten{T2}()?T2]
		
		SetType symbol_133 = PivotFactory.eINSTANCE.createSetType(); // ocl|Set[ocl|Enumeration]
		
		SetType symbol_134 = PivotFactory.eINSTANCE.createSetType(); // ocl|Set[ocl|Collection{T}?T]
		
		SetType symbol_135 = PivotFactory.eINSTANCE.createSetType(); // ocl|Set[ocl|Classifier]
		
		SetType symbol_136 = PivotFactory.eINSTANCE.createSetType(); // ocl|Set[ocl|NonOrderedCollection{T}?T]
		
		SetType symbol_137 = PivotFactory.eINSTANCE.createSetType(); // ocl|Set[ocl|Boolean]
		
		SetType symbol_138 = PivotFactory.eINSTANCE.createSetType(); // ocl|Set[ocl|OclVoid]
		
		SetType symbol_139 = PivotFactory.eINSTANCE.createSetType(); // ocl|Set[ocl|Set{T}?T]
		...
		{	// ocl::Bag::excluding() ocl|Bag{T}|excluding(ocl|OclAny)
			...
			symbol_148.setType(symbol_100);  // ocl|Bag[ocl|Bag{T}?T]
			Parameter symbol_149 = PivotFactory.eINSTANCE.createParameter();
			symbol_149.setName("object");
			symbol_149.setType(symbol_50);  // ocl|OclAny
		...
		{	// ocl::Bag::flatten() ocl|Bag{T}|flatten{T2}()
			...
			symbol_150.setType(symbol_99);  // ocl|Bag[ocl|Bag{T}|flatten{T2}()?T2]
		...
		{	// ocl::Bag::including() ocl|Bag{T}|including(ocl|Bag{T}?T)
			...
			symbol_151.setType(symbol_100);  // ocl|Bag[ocl|Bag{T}?T]
			Parameter symbol_152 = PivotFactory.eINSTANCE.createParameter();
			symbol_152.setName("object");
			symbol_152.setType(symbol_15);  // ocl|Bag{T}?T
		...
		{	// ocl::Bag::reject() ocl|Bag{T}|reject(ocl|Bag{T}?T)
			...
			symbol_153.setType(symbol_100);  // ocl|Bag[ocl|Bag{T}?T]
			Parameter symbol_154 = PivotFactory.eINSTANCE.createParameter();
			symbol_154.setName("i");
			symbol_154.setType(symbol_15);  // ocl|Bag{T}?T
		...
		{	// ocl::Bag::select() ocl|Bag{T}|select(ocl|Bag{T}?T)
			...
			symbol_155.setType(symbol_100);  // ocl|Bag[ocl|Bag{T}?T]
			Parameter symbol_156 = PivotFactory.eINSTANCE.createParameter();
			symbol_156.setName("i");
			symbol_156.setType(symbol_15);  // ocl|Bag{T}?T
		...
		{	// ocl::Boolean::allInstances() ocl|Boolean|allInstances()
			...
			symbol_161.setType(symbol_137);  // ocl|Set[ocl|Boolean]
		...
		{	// ocl::Boolean::not() ocl|Boolean|not()
			...
			symbol_166.setType(symbol_19);  // ocl|Boolean
			symbol_166.setPrecedence(symbol_11);
		...
		{	// ocl::Boolean::toString() ocl|Boolean|toString()
			...
			symbol_169.setType(symbol_85);  // ocl|String
		...
		{	// ocl::Classifier::allInstances() ocl|Classifier|allInstances()
			...
			symbol_172.setType(symbol_135);  // ocl|Set[ocl|Classifier]
		...
		{	// ocl::Collection::any() ocl|Collection{T}|any(ocl|Collection{T}?T)
			...
			symbol_177.setType(symbol_24);  // ocl|Collection{T}?T
			Parameter symbol_178 = PivotFactory.eINSTANCE.createParameter();
			symbol_178.setName("i");
			symbol_178.setType(symbol_24);  // ocl|Collection{T}?T
		...
		{	// ocl::Collection::asBag() ocl|Collection{T}|asBag()
			...
			symbol_179.setType(symbol_98);  // ocl|Bag[ocl|Collection{T}?T]
		...
		{	// ocl::Collection::asOrderedSet() ocl|Collection{T}|asOrderedSet()
			...
			symbol_180.setType(symbol_122);  // ocl|OrderedSet[ocl|Collection{T}?T]
		...
		{	// ocl::Collection::asSequence() ocl|Collection{T}|asSequence()
			...
			symbol_181.setType(symbol_128);  // ocl|Sequence[ocl|Collection{T}?T]
		...
		{	// ocl::Collection::asSet() ocl|Collection{T}|asSet()
			...
			symbol_182.setType(symbol_134);  // ocl|Set[ocl|Collection{T}?T]
		...
		{	// ocl::Collection::collect() ocl|Collection{T}|collect(ocl|Collection{T}?T)
			...
			symbol_183.setType(symbol_102);  // ocl|Collection[ocl|Collection{T}?T]
			Parameter symbol_184 = PivotFactory.eINSTANCE.createParameter();
			symbol_184.setName("i");
			symbol_184.setType(symbol_24);  // ocl|Collection{T}?T
		...
		{	// ocl::Collection::collectNested() ocl|Collection{T}|collectNested(ocl|Collection{T}?T)
			...
			symbol_185.setType(symbol_102);  // ocl|Collection[ocl|Collection{T}?T]
			Parameter symbol_186 = PivotFactory.eINSTANCE.createParameter();
			symbol_186.setName("i");
			symbol_186.setType(symbol_24);  // ocl|Collection{T}?T
		...
		{	// ocl::Collection::excludesAll() ocl|Collection{T}|excludesAll{T2}(ocl|Collection[T2])
			...
			symbol_191.setType(symbol_19);  // ocl|Boolean
			Parameter symbol_192 = PivotFactory.eINSTANCE.createParameter();
			symbol_192.setName("c2");
			symbol_192.setType(symbol_110);  // ocl|Collection[ocl|Collection{T}|excludesAll{T2}(ocl|Collection[T2])?T2]
		...
		{	// ocl::Collection::excluding() ocl|Collection{T}|excluding(ocl|OclAny)
			...
			symbol_193.setType(symbol_102);  // ocl|Collection[ocl|Collection{T}?T]
		...
		{	// ocl::Collection::exists() ocl|Collection{T}|exists(ocl|Collection{T}?T)
			...
			symbol_195.setType(symbol_19);  // ocl|Boolean
			Parameter symbol_196 = PivotFactory.eINSTANCE.createParameter();
			symbol_196.setName("i");
			symbol_196.setType(symbol_24);  // ocl|Collection{T}?T
		...
		{	// ocl::Collection::exists() ocl|Collection{T}|exists(ocl|Collection{T}?T,T)
			...
			symbol_197.setType(symbol_19);  // ocl|Boolean
			Parameter symbol_198 = PivotFactory.eINSTANCE.createParameter();
			symbol_198.setName("i");
			symbol_198.setType(symbol_24);  // ocl|Collection{T}?T
			...
			symbol_199.setType(symbol_24);  // ocl|Collection{T}?T
		...
		{	// ocl::Collection::flatten() ocl|Collection{T}|flatten{T2}()
			...
			symbol_200.setType(symbol_108);  // ocl|Collection[ocl|Collection{T}|flatten{T2}()?T2]
		...
		{	// ocl::Collection::forAll() ocl|Collection{T}|forAll(ocl|Collection{T}?T)
			...
			symbol_201.setType(symbol_19);  // ocl|Boolean
			Parameter symbol_202 = PivotFactory.eINSTANCE.createParameter();
			symbol_202.setName("i");
			symbol_202.setType(symbol_24);  // ocl|Collection{T}?T
		...
		{	// ocl::Collection::forAll() ocl|Collection{T}|forAll(ocl|Collection{T}?T,T)
			...
			symbol_203.setType(symbol_19);  // ocl|Boolean
			Parameter symbol_204 = PivotFactory.eINSTANCE.createParameter();
			symbol_204.setName("j");
			symbol_204.setType(symbol_24);  // ocl|Collection{T}?T
			...
			symbol_205.setType(symbol_24);  // ocl|Collection{T}?T
		...
		{	// ocl::Collection::includes() ocl|Collection{T}|includes(ocl|OclAny)
			...
			symbol_206.setType(symbol_19);  // ocl|Boolean
		...
		{	// ocl::Collection::includesAll() ocl|Collection{T}|includesAll{T2}(ocl|Collection[T2])
			...
			symbol_208.setType(symbol_19);  // ocl|Boolean
			Parameter symbol_209 = PivotFactory.eINSTANCE.createParameter();
			symbol_209.setName("c2");
			symbol_209.setType(symbol_104);  // ocl|Collection[ocl|Collection{T}|includesAll{T2}(ocl|Collection[T2])?T2]
		...
		{	// ocl::Collection::including() ocl|Collection{T}|including(ocl|Collection{T}?T)
			...
			symbol_210.setType(symbol_102);  // ocl|Collection[ocl|Collection{T}?T]
			Parameter symbol_211 = PivotFactory.eINSTANCE.createParameter();
			symbol_211.setName("object");
			symbol_211.setType(symbol_24);  // ocl|Collection{T}?T
		...
		{	// ocl::Collection::isEmpty() ocl|Collection{T}|isEmpty()
			...
			symbol_212.setType(symbol_19);  // ocl|Boolean
		...
		{	// ocl::Collection::isUnique() ocl|Collection{T}|isUnique(ocl|Collection{T}?T)
			...
			symbol_213.setType(symbol_19);  // ocl|Boolean
			Parameter symbol_214 = PivotFactory.eINSTANCE.createParameter();
			symbol_214.setName("i");
			symbol_214.setType(symbol_24);  // ocl|Collection{T}?T
		...
		{	// ocl::Collection::iterate() ocl|Collection{T}|iterate{Tacc}(ocl|Collection{T}?T;Tacc)
			...
			symbol_215.setType(symbol_36);  // ocl|Collection{T}|iterate{Tacc}(ocl|Collection{T}?T;Tacc)?Tacc
			Parameter symbol_216 = PivotFactory.eINSTANCE.createParameter();
			symbol_216.setName("i");
			symbol_216.setType(symbol_24);  // ocl|Collection{T}?T
			...
			symbol_217.setType(symbol_36);  // ocl|Collection{T}|iterate{Tacc}(ocl|Collection{T}?T;Tacc)?Tacc
		...
		{	// ocl::Collection::max() ocl|Collection{T}|max()
			...
			symbol_218.setType(symbol_24);  // ocl|Collection{T}?T
		...
		{	// ocl::Collection::min() ocl|Collection{T}|min()
			...
			symbol_219.setType(symbol_24);  // ocl|Collection{T}?T
		...
		{	// ocl::Collection::notEmpty() ocl|Collection{T}|notEmpty()
			...
			symbol_220.setType(symbol_19);  // ocl|Boolean
		...
		{	// ocl::Collection::one() ocl|Collection{T}|one(ocl|Collection{T}?T)
			...
			symbol_221.setType(symbol_19);  // ocl|Boolean
		...
		{	// ocl::Collection::product() ocl|Collection{T}|product{T2}(ocl|Collection[T2])
			...
			symbol_223.setType(symbol_129);  // ocl|Set[ocl|Tuple[ocl|Collection{T}?T,ocl|Collection{T}|product{T2}(ocl|Collection[T2])?T2]]
			Parameter symbol_224 = PivotFactory.eINSTANCE.createParameter();
			symbol_224.setName("c2");
			symbol_224.setType(symbol_103);  // ocl|Collection[ocl|Collection{T}|product{T2}(ocl|Collection[T2])?T2]
		...
		{	// ocl::Collection::reject() ocl|Collection{T}|reject(ocl|Collection{T}?T)
			...
			symbol_225.setType(symbol_102);  // ocl|Collection[ocl|Collection{T}?T]
			Parameter symbol_226 = PivotFactory.eINSTANCE.createParameter();
			symbol_226.setName("i");
			symbol_226.setType(symbol_24);  // ocl|Collection{T}?T
		...
		{	// ocl::Collection::select() ocl|Collection{T}|select(ocl|Collection{T}?T)
			...
			symbol_227.setType(symbol_102);  // ocl|Collection[ocl|Collection{T}?T]
		...
		{	// ocl::Collection::size() ocl|Collection{T}|size()
			...
			symbol_229.setType(symbol_41);  // ocl|Integer
		...
		{	// ocl::Collection::sortedBy() ocl|Collection{T}|sortedBy(ocl|Collection{T}?T)
			...
			symbol_230.setType(symbol_117);  // ocl|OrderedCollection[ocl|Collection{T}?T]
		...
		{	// ocl::Enumeration::allInstances() ocl|Enumeration|allInstances()
			...
			symbol_233.setType(symbol_133);  // ocl|Set[ocl|Enumeration]
		...
		{	// ocl::Integer::+() ocl|Integer|+(ocl|Integer)
			...
			symbol_236.setName("+");
			symbol_236.setType(symbol_41);  // ocl|Integer
			Parameter symbol_237 = PivotFactory.eINSTANCE.createParameter();
			symbol_237.setName("i");
			symbol_237.setType(symbol_41);  // ocl|Integer
		...
		{	// ocl::Integer::-() ocl|Integer|-()
			...
			symbol_238.setName("-");
			symbol_238.setType(symbol_41);  // ocl|Integer
			symbol_238.setPrecedence(symbol_11);
		...
		{	// ocl::Integer::-() ocl|Integer|-(ocl|Integer)
			...
			symbol_239.setName("-");
			symbol_239.setType(symbol_41);  // ocl|Integer
			Parameter symbol_240 = PivotFactory.eINSTANCE.createParameter();
			symbol_240.setName("i");
			symbol_240.setType(symbol_41);  // ocl|Integer
		...
		{	// ocl::Integer::abs() ocl|Integer|abs()
			...
			symbol_243.setType(symbol_41);  // ocl|Integer
		...
		{	// ocl::Integer::div() ocl|Integer|div(ocl|Integer)
			...
			symbol_244.setType(symbol_41);  // ocl|Integer
			Parameter symbol_245 = PivotFactory.eINSTANCE.createParameter();
			symbol_245.setName("i");
			symbol_245.setType(symbol_41);  // ocl|Integer
		...
		{	// ocl::Integer::max() ocl|Integer|max(ocl|Integer)
			...
			symbol_246.setType(symbol_41);  // ocl|Integer
			Parameter symbol_247 = PivotFactory.eINSTANCE.createParameter();
			symbol_247.setName("i");
			symbol_247.setType(symbol_41);  // ocl|Integer
		...
		{	// ocl::Integer::min() ocl|Integer|min(ocl|Integer)
			...
			symbol_248.setType(symbol_41);  // ocl|Integer
			Parameter symbol_249 = PivotFactory.eINSTANCE.createParameter();
			symbol_249.setName("i");
			symbol_249.setType(symbol_41);  // ocl|Integer
		...
		{	// ocl::Integer::mod() ocl|Integer|mod(ocl|Integer)
			...
			symbol_250.setType(symbol_41);  // ocl|Integer
			Parameter symbol_251 = PivotFactory.eINSTANCE.createParameter();
			symbol_251.setName("i");
			symbol_251.setType(symbol_41);  // ocl|Integer
		...
		{	// ocl::Integer::toString() ocl|Integer|toString()
			...
			symbol_252.setType(symbol_85);  // ocl|String
		...
		symbol_42.getSuperClasses().add(symbol_106);
		{	// ocl::NonOrderedCollection::closure() ocl|NonOrderedCollection{T}|closure(ocl|NonOrderedCollection{T}?T)
			...
			symbol_253.setType(symbol_136);  // ocl|Set[ocl|NonOrderedCollection{T}?T]
			Parameter symbol_254 = PivotFactory.eINSTANCE.createParameter();
			symbol_254.setName("i");
			symbol_254.setType(symbol_45);  // ocl|NonOrderedCollection{T}?T
		...
		{	// ocl::NonOrderedCollection::collect() ocl|NonOrderedCollection{T}|collect(ocl|NonOrderedCollection{T}?T)
			...
			symbol_255.setType(symbol_101);  // ocl|Bag[ocl|NonOrderedCollection{T}?T]
			Parameter symbol_256 = PivotFactory.eINSTANCE.createParameter();
			symbol_256.setName("i");
			symbol_256.setType(symbol_45);  // ocl|NonOrderedCollection{T}?T
		...
		{	// ocl::NonOrderedCollection::collectNested() ocl|NonOrderedCollection{T}|collectNested(ocl|NonOrderedCollection{T}?T)
			...
			symbol_257.setType(symbol_101);  // ocl|Bag[ocl|NonOrderedCollection{T}?T]
			Parameter symbol_258 = PivotFactory.eINSTANCE.createParameter();
			symbol_258.setName("i");
			symbol_258.setType(symbol_45);  // ocl|NonOrderedCollection{T}?T
		...
		{	// ocl::NonOrderedCollection::intersection() ocl|NonOrderedCollection{T}|intersection(ocl|Bag[ocl|NonOrderedCollection{T}?T])
			...
			symbol_259.setType(symbol_101);  // ocl|Bag[ocl|NonOrderedCollection{T}?T]
			Parameter symbol_260 = PivotFactory.eINSTANCE.createParameter();
			symbol_260.setName("bag");
			symbol_260.setType(symbol_101);  // ocl|Bag[ocl|NonOrderedCollection{T}?T]
		...
		{	// ocl::NonOrderedCollection::intersection() ocl|NonOrderedCollection{T}|intersection(ocl|Set[ocl|NonOrderedCollection{T}?T])
			...
			symbol_261.setType(symbol_136);  // ocl|Set[ocl|NonOrderedCollection{T}?T]
			Parameter symbol_262 = PivotFactory.eINSTANCE.createParameter();
			symbol_262.setName("s");
			symbol_262.setType(symbol_136);  // ocl|Set[ocl|NonOrderedCollection{T}?T]
		...
		{	// ocl::NonOrderedCollection::union() ocl|NonOrderedCollection{T}|union(ocl|Bag[ocl|NonOrderedCollection{T}?T])
			...
			symbol_263.setType(symbol_101);  // ocl|Bag[ocl|NonOrderedCollection{T}?T]
			Parameter symbol_264 = PivotFactory.eINSTANCE.createParameter();
			symbol_264.setName("bag");
			symbol_264.setType(symbol_101);  // ocl|Bag[ocl|NonOrderedCollection{T}?T]
		...
		{	// ocl::NonOrderedCollection::union() ocl|NonOrderedCollection{T}|union(ocl|Set[ocl|NonOrderedCollection{T}?T])
			...
			symbol_265.setType(symbol_136);  // ocl|Set[ocl|NonOrderedCollection{T}?T]
			Parameter symbol_266 = PivotFactory.eINSTANCE.createParameter();
			symbol_266.setName("s");
			symbol_266.setType(symbol_136);  // ocl|Set[ocl|NonOrderedCollection{T}?T]
		...
		{	// ocl::NonUniqueCollection::sortedBy() ocl|NonUniqueCollection{T}|sortedBy(ocl|NonUniqueCollection{T}?T)
			...
			symbol_267.setType(symbol_125);  // ocl|Sequence[ocl|NonUniqueCollection{T}?T]
			Parameter symbol_268 = PivotFactory.eINSTANCE.createParameter();
			symbol_268.setName("i");
			symbol_268.setType(symbol_49);  // ocl|NonUniqueCollection{T}?T
		...
		{	// ocl::OclAny::oclAsSet() ocl|OclAny|oclAsSet()
			...
			symbol_273.setType(symbol_131);  // ocl|Set[ocl|OclAny]
		...
		{	// ocl::OclAny::oclAsType() ocl|OclAny|oclAsType{T}(ocl|Classifier)
			...
			symbol_274.setType(symbol_53);  // ocl|OclAny|oclAsType{T}(ocl|Classifier)?T
			Parameter symbol_275 = PivotFactory.eINSTANCE.createParameter();
			symbol_275.setName("type");
			symbol_275.setType(symbol_20);  // ocl|Classifier
		...
		{	// ocl::OclAny::oclIsInvalid() ocl|OclAny|oclIsInvalid()
			...
			symbol_278.setType(symbol_19);  // ocl|Boolean
		...
		{	// ocl::OclAny::oclIsKindOf() ocl|OclAny|oclIsKindOf(ocl|Classifier)
			...
			symbol_279.setType(symbol_19);  // ocl|Boolean
			Parameter symbol_280 = PivotFactory.eINSTANCE.createParameter();
			symbol_280.setName("type");
			symbol_280.setType(symbol_20);  // ocl|Classifier
		...
		{	// ocl::OclAny::oclIsNew() ocl|OclAny|oclIsNew()
			...
			symbol_281.setType(symbol_19);  // ocl|Boolean
		...
		{	// ocl::OclAny::oclIsTypeOf() ocl|OclAny|oclIsTypeOf(ocl|Classifier)
			...
			symbol_282.setType(symbol_19);  // ocl|Boolean
			Parameter symbol_283 = PivotFactory.eINSTANCE.createParameter();
			symbol_283.setName("type");
			symbol_283.setType(symbol_20);  // ocl|Classifier
		...
		{	// ocl::OclAny::oclIsUndefined() ocl|OclAny|oclIsUndefined()
			...
			symbol_284.setType(symbol_19);  // ocl|Boolean
		...
		{	// ocl::OclAny::oclType() ocl|OclAny|oclType()
			...
			symbol_285.setType(symbol_20);  // ocl|Classifier
		...
		{	// ocl::OclInvalid::allInstances() ocl|OclInvalid|allInstances()
			...
			symbol_290.setType(symbol_140);  // ocl|Set[ocl|OclInvalid]
		...
		{	// ocl::OclInvalid::toString() ocl|OclInvalid|toString()
			...
			symbol_291.setType(symbol_85);  // ocl|String
		...
		{	// ocl::OclMessage::hasReturned() ocl|OclMessage|hasReturned()
			...
			symbol_292.setType(symbol_19);  // ocl|Boolean
		...
		{	// ocl::OclMessage::isOperationCall() ocl|OclMessage|isOperationCall()
			...
			symbol_293.setType(symbol_19);  // ocl|Boolean
		...
		{	// ocl::OclMessage::isSignalSent() ocl|OclMessage|isSignalSent()
			...
			symbol_294.setType(symbol_19);  // ocl|Boolean
		...
		{	// ocl::OclMessage::result() ocl|OclMessage|result()
			...
			symbol_295.setType(symbol_50);  // ocl|OclAny
		...
		{	// ocl::OclVoid::allInstances() ocl|OclVoid|allInstances()
			...
			symbol_304.setType(symbol_138);  // ocl|Set[ocl|OclVoid]
		...
		{	// ocl::OclVoid::and() ocl|OclVoid|and(ocl|Boolean)
			...
			symbol_305.setType(symbol_19);  // ocl|Boolean
			Parameter symbol_306 = PivotFactory.eINSTANCE.createParameter();
			symbol_306.setName("b");
			symbol_306.setType(symbol_19);  // ocl|Boolean
		...
		{	// ocl::OclVoid::or() ocl|OclVoid|or(ocl|Boolean)
			...
			symbol_309.setType(symbol_19);  // ocl|Boolean
			Parameter symbol_310 = PivotFactory.eINSTANCE.createParameter();
			symbol_310.setName("b");
			symbol_310.setType(symbol_19);  // ocl|Boolean
		...
		{	// ocl::OclVoid::toString() ocl|OclVoid|toString()
			...
			symbol_311.setType(symbol_85);  // ocl|String
		...
		{	// ocl::OrderedCollection::at() ocl|OrderedCollection{T}|at(ocl|Integer)
			...
			symbol_312.setType(symbol_62);  // ocl|OrderedCollection{T}?T
			Parameter symbol_313 = PivotFactory.eINSTANCE.createParameter();
			symbol_313.setName("index");
			symbol_313.setType(symbol_41);  // ocl|Integer
		...
		{	// ocl::OrderedCollection::closure() ocl|OrderedCollection{T}|closure(ocl|OrderedCollection{T}?T)
			...
			symbol_314.setType(symbol_121);  // ocl|OrderedSet[ocl|OrderedCollection{T}?T]
			Parameter symbol_315 = PivotFactory.eINSTANCE.createParameter();
			symbol_315.setName("i");
			symbol_315.setType(symbol_62);  // ocl|OrderedCollection{T}?T
		...
		{	// ocl::OrderedCollection::collect() ocl|OrderedCollection{T}|collect(ocl|OrderedCollection{T}?T)
			...
			symbol_316.setType(symbol_123);  // ocl|Sequence[ocl|OrderedCollection{T}?T]
			Parameter symbol_317 = PivotFactory.eINSTANCE.createParameter();
			symbol_317.setName("i");
			symbol_317.setType(symbol_62);  // ocl|OrderedCollection{T}?T
		...
		{	// ocl::OrderedCollection::collectNested() ocl|OrderedCollection{T}|collectNested(ocl|OrderedCollection{T}?T)
			...
			symbol_318.setType(symbol_123);  // ocl|Sequence[ocl|OrderedCollection{T}?T]
			Parameter symbol_319 = PivotFactory.eINSTANCE.createParameter();
			symbol_319.setName("i");
			symbol_319.setType(symbol_62);  // ocl|OrderedCollection{T}?T
		...
		{	// ocl::OrderedCollection::first() ocl|OrderedCollection{T}|first()
			...
			symbol_320.setType(symbol_62);  // ocl|OrderedCollection{T}?T
		...
		{	// ocl::OrderedCollection::indexOf() ocl|OrderedCollection{T}|indexOf(ocl|OclAny)
			...
			symbol_321.setType(symbol_41);  // ocl|Integer
		...
		{	// ocl::OrderedCollection::last() ocl|OrderedCollection{T}|last()
			...
			symbol_323.setType(symbol_62);  // ocl|OrderedCollection{T}?T
		...
		{	// ocl::OrderedCollection::reverse() ocl|OrderedCollection{T}|reverse()
			...
			symbol_324.setType(symbol_115);  // ocl|OrderedCollection[ocl|OrderedCollection{T}?T]
		...
		{	// ocl::OrderedSet::-() ocl|OrderedSet{T}|-(ocl|Set[ocl|OrderedSet{T}?T])
			...
			symbol_325.setName("-");
			symbol_325.setType(symbol_120);  // ocl|OrderedSet[ocl|OrderedSet{T}?T]
			Parameter symbol_326 = PivotFactory.eINSTANCE.createParameter();
			symbol_326.setName("s");
			symbol_326.setType(symbol_130);  // ocl|Set[ocl|OrderedSet{T}?T]
		...
		{	// ocl::OrderedSet::append() ocl|OrderedSet{T}|append(ocl|OrderedSet{T}?T)
			...
			symbol_331.setType(symbol_120);  // ocl|OrderedSet[ocl|OrderedSet{T}?T]
			Parameter symbol_332 = PivotFactory.eINSTANCE.createParameter();
			symbol_332.setName("object");
			symbol_332.setType(symbol_66);  // ocl|OrderedSet{T}?T
		...
		{	// ocl::OrderedSet::excluding() ocl|OrderedSet{T}|excluding(ocl|OclAny)
			...
			symbol_333.setType(symbol_120);  // ocl|OrderedSet[ocl|OrderedSet{T}?T]
		...
		{	// ocl::OrderedSet::including() ocl|OrderedSet{T}|including(ocl|OrderedSet{T}?T)
			...
			symbol_335.setType(symbol_120);  // ocl|OrderedSet[ocl|OrderedSet{T}?T]
			Parameter symbol_336 = PivotFactory.eINSTANCE.createParameter();
			symbol_336.setName("object");
			symbol_336.setType(symbol_66);  // ocl|OrderedSet{T}?T
		...
		{	// ocl::OrderedSet::insertAt() ocl|OrderedSet{T}|insertAt(ocl|Integer,ocl|OrderedSet{T}?T)
			...
			symbol_337.setType(symbol_120);  // ocl|OrderedSet[ocl|OrderedSet{T}?T]
			Parameter symbol_338 = PivotFactory.eINSTANCE.createParameter();
			symbol_338.setName("index");
			symbol_338.setType(symbol_41);  // ocl|Integer
			...
			symbol_339.setType(symbol_66);  // ocl|OrderedSet{T}?T
		...
		{	// ocl::OrderedSet::intersection() ocl|OrderedSet{T}|intersection(ocl|Set[ocl|OrderedSet{T}?T])
			...
			symbol_340.setType(symbol_120);  // ocl|OrderedSet[ocl|OrderedSet{T}?T]
			Parameter symbol_341 = PivotFactory.eINSTANCE.createParameter();
			symbol_341.setName("o");
			symbol_341.setType(symbol_130);  // ocl|Set[ocl|OrderedSet{T}?T]
		...
		{	// ocl::OrderedSet::prepend() ocl|OrderedSet{T}|prepend(ocl|OrderedSet{T}?T)
			...
			symbol_342.setType(symbol_120);  // ocl|OrderedSet[ocl|OrderedSet{T}?T]
			Parameter symbol_343 = PivotFactory.eINSTANCE.createParameter();
			symbol_343.setName("object");
			symbol_343.setType(symbol_66);  // ocl|OrderedSet{T}?T
		...
		{	// ocl::OrderedSet::reject() ocl|OrderedSet{T}|reject(ocl|OrderedSet{T}?T)
			...
			symbol_344.setType(symbol_120);  // ocl|OrderedSet[ocl|OrderedSet{T}?T]
			Parameter symbol_345 = PivotFactory.eINSTANCE.createParameter();
			symbol_345.setName("i");
			symbol_345.setType(symbol_66);  // ocl|OrderedSet{T}?T
		...
		{	// ocl::OrderedSet::reverse() ocl|OrderedSet{T}|reverse()
			...
			symbol_346.setType(symbol_120);  // ocl|OrderedSet[ocl|OrderedSet{T}?T]
		...
		{	// ocl::OrderedSet::select() ocl|OrderedSet{T}|select(ocl|OrderedSet{T}?T)
			...
			symbol_347.setType(symbol_120);  // ocl|OrderedSet[ocl|OrderedSet{T}?T]
			Parameter symbol_348 = PivotFactory.eINSTANCE.createParameter();
			symbol_348.setName("i");
			symbol_348.setType(symbol_66);  // ocl|OrderedSet{T}?T
		...
		{	// ocl::OrderedSet::subOrderedSet() ocl|OrderedSet{T}|subOrderedSet(ocl|Integer,ocl|Integer)
			...
			symbol_349.setType(symbol_120);  // ocl|OrderedSet[ocl|OrderedSet{T}?T]
			Parameter symbol_350 = PivotFactory.eINSTANCE.createParameter();
			symbol_350.setName("lower");
			symbol_350.setType(symbol_41);  // ocl|Integer
			...
			symbol_351.setType(symbol_41);  // ocl|Integer
		...
		{	// ocl::OrderedSet::symmetricDifference() ocl|OrderedSet{T}|symmetricDifference(ocl|Set[ocl|OrderedSet{T}?T])
			...
			symbol_352.setType(symbol_120);  // ocl|OrderedSet[ocl|OrderedSet{T}?T]
			Parameter symbol_353 = PivotFactory.eINSTANCE.createParameter();
			symbol_353.setName("s");
			symbol_353.setType(symbol_130);  // ocl|Set[ocl|OrderedSet{T}?T]
		...
		{	// ocl::OrderedSet::union() ocl|OrderedSet{T}|union(ocl|OrderedSet[ocl|OrderedSet{T}?T])
			...
			symbol_354.setType(symbol_120);  // ocl|OrderedSet[ocl|OrderedSet{T}?T]
			Parameter symbol_355 = PivotFactory.eINSTANCE.createParameter();
			symbol_355.setName("o");
			symbol_355.setType(symbol_120);  // ocl|OrderedSet[ocl|OrderedSet{T}?T]
		...
		{	// ocl::OrderedSet::union() ocl|OrderedSet{T}|union(ocl|Set[ocl|OrderedSet{T}?T])
			...
			symbol_356.setType(symbol_130);  // ocl|Set[ocl|OrderedSet{T}?T]
			Parameter symbol_357 = PivotFactory.eINSTANCE.createParameter();
			symbol_357.setName("s");
			symbol_357.setType(symbol_130);  // ocl|Set[ocl|OrderedSet{T}?T]
		...
		{	// ocl::Real::-() ocl|Real|-()
			...
			symbol_364.setName("-");
			symbol_364.setType(symbol_67);  // ocl|Real
			symbol_364.setPrecedence(symbol_11);
		...
		{	// ocl::Real::<>() ocl|Real|<>(ocl|OclAny)
			...
			symbol_371.setName("<>");
			symbol_371.setType(symbol_19);  // ocl|Boolean
		...
		{	// ocl::Real::=() ocl|Real|=(ocl|OclAny)
			...
			symbol_373.setName("=");
			symbol_373.setType(symbol_19);  // ocl|Boolean
			...
			symbol_373.setPrecedence(symbol_4);
		...
		{	// ocl::Real::abs() ocl|Real|abs()
			...
			symbol_379.setType(symbol_67);  // ocl|Real
		...
		{	// ocl::Real::floor() ocl|Real|floor()
			...
			symbol_380.setType(symbol_41);  // ocl|Integer
		...
		{	// ocl::Real::oclAsType() ocl|Real|oclAsType{T}(ocl|Classifier)
			...
			symbol_385.setType(symbol_70);  // ocl|Real|oclAsType{T}(ocl|Classifier)?T
			Parameter symbol_386 = PivotFactory.eINSTANCE.createParameter();
			symbol_386.setName("type");
			symbol_386.setType(symbol_20);  // ocl|Classifier
		...
		{	// ocl::Real::round() ocl|Real|round()
			...
			symbol_387.setType(symbol_41);  // ocl|Integer
		...
		{	// ocl::Real::toString() ocl|Real|toString()
			...
			symbol_388.setType(symbol_85);  // ocl|String
		...
		{	// ocl::Sequence::append() ocl|Sequence{T}|append(ocl|Sequence{T}?T)
			...
			symbol_393.setType(symbol_127);  // ocl|Sequence[ocl|Sequence{T}?T]
			Parameter symbol_394 = PivotFactory.eINSTANCE.createParameter();
			symbol_394.setName("object");
			symbol_394.setType(symbol_74);  // ocl|Sequence{T}?T
		...
		{	// ocl::Sequence::excluding() ocl|Sequence{T}|excluding(ocl|OclAny)
			...
			symbol_395.setType(symbol_127);  // ocl|Sequence[ocl|Sequence{T}?T]
			Parameter symbol_396 = PivotFactory.eINSTANCE.createParameter();
			symbol_396.setName("object");
			symbol_396.setType(symbol_50);  // ocl|OclAny
		...
		{	// ocl::Sequence::flatten() ocl|Sequence{T}|flatten{T2}()
			...
			symbol_397.setType(symbol_124);  // ocl|Sequence[ocl|Sequence{T}|flatten{T2}()?T2]
		...
		{	// ocl::Sequence::including() ocl|Sequence{T}|including(ocl|Sequence{T}?T)
			...
			symbol_398.setType(symbol_127);  // ocl|Sequence[ocl|Sequence{T}?T]
			Parameter symbol_399 = PivotFactory.eINSTANCE.createParameter();
			symbol_399.setName("object");
			symbol_399.setType(symbol_74);  // ocl|Sequence{T}?T
		...
		{	// ocl::Sequence::insertAt() ocl|Sequence{T}|insertAt(ocl|Integer,ocl|Sequence{T}?T)
			...
			symbol_400.setType(symbol_127);  // ocl|Sequence[ocl|Sequence{T}?T]
			Parameter symbol_401 = PivotFactory.eINSTANCE.createParameter();
			symbol_401.setName("index");
			symbol_401.setType(symbol_41);  // ocl|Integer
			...
			symbol_402.setType(symbol_74);  // ocl|Sequence{T}?T
		...
		{	// ocl::Sequence::prepend() ocl|Sequence{T}|prepend(ocl|Sequence{T}?T)
			...
			symbol_403.setType(symbol_127);  // ocl|Sequence[ocl|Sequence{T}?T]
			Parameter symbol_404 = PivotFactory.eINSTANCE.createParameter();
			symbol_404.setName("object");
			symbol_404.setType(symbol_74);  // ocl|Sequence{T}?T
		...
		{	// ocl::Sequence::reject() ocl|Sequence{T}|reject(ocl|Sequence{T}?T)
			...
			symbol_405.setType(symbol_127);  // ocl|Sequence[ocl|Sequence{T}?T]
			Parameter symbol_406 = PivotFactory.eINSTANCE.createParameter();
			symbol_406.setName("i");
			symbol_406.setType(symbol_74);  // ocl|Sequence{T}?T
		...
		{	// ocl::Sequence::reverse() ocl|Sequence{T}|reverse()
			...
			symbol_407.setType(symbol_127);  // ocl|Sequence[ocl|Sequence{T}?T]
		...
		{	// ocl::Sequence::select() ocl|Sequence{T}|select(ocl|Sequence{T}?T)
			...
			symbol_408.setType(symbol_127);  // ocl|Sequence[ocl|Sequence{T}?T]
			Parameter symbol_409 = PivotFactory.eINSTANCE.createParameter();
			symbol_409.setName("i");
			symbol_409.setType(symbol_74);  // ocl|Sequence{T}?T
		...
		{	// ocl::Sequence::subSequence() ocl|Sequence{T}|subSequence(ocl|Integer,ocl|Integer)
			...
			symbol_410.setType(symbol_127);  // ocl|Sequence[ocl|Sequence{T}?T]
			Parameter symbol_411 = PivotFactory.eINSTANCE.createParameter();
			symbol_411.setName("lower");
			symbol_411.setType(symbol_41);  // ocl|Integer
			...
			symbol_412.setType(symbol_41);  // ocl|Integer
		...
		{	// ocl::Sequence::union() ocl|Sequence{T}|union(ocl|Sequence[ocl|Sequence{T}?T])
			...
			symbol_413.setType(symbol_127);  // ocl|Sequence[ocl|Sequence{T}?T]
			Parameter symbol_414 = PivotFactory.eINSTANCE.createParameter();
			symbol_414.setName("s");
			symbol_414.setType(symbol_127);  // ocl|Sequence[ocl|Sequence{T}?T]
		...
		{	// ocl::Set::-() ocl|Set{T}|-(ocl|Set[ocl|OclAny])
			...
			symbol_415.setName("-");
			symbol_415.setType(symbol_139);  // ocl|Set[ocl|Set{T}?T]
			Parameter symbol_416 = PivotFactory.eINSTANCE.createParameter();
			symbol_416.setName("s");
			symbol_416.setType(symbol_131);  // ocl|Set[ocl|OclAny]
		...
		{	// ocl::Set::<>() ocl|Set{T}|<>(ocl|OclAny)
			...
			symbol_417.setName("<>");
			symbol_417.setType(symbol_19);  // ocl|Boolean
		...
		{	// ocl::Set::=() ocl|Set{T}|=(ocl|OclAny)
			...
			symbol_419.setName("=");
			symbol_419.setType(symbol_19);  // ocl|Boolean
			...
			symbol_419.setPrecedence(symbol_4);
		...
		{	// ocl::Set::excluding() ocl|Set{T}|excluding(ocl|OclAny)
			...
			symbol_421.setType(symbol_139);  // ocl|Set[ocl|Set{T}?T]
		...
		{	// ocl::Set::flatten() ocl|Set{T}|flatten{T2}()
			...
			symbol_423.setType(symbol_132);  // ocl|Set[ocl|Set{T}|flatten{T2}()?T2]
		...
		{	// ocl::Set::including() ocl|Set{T}|including(ocl|Set{T}?T)
			...
			symbol_424.setType(symbol_139);  // ocl|Set[ocl|Set{T}?T]
			Parameter symbol_425 = PivotFactory.eINSTANCE.createParameter();
			symbol_425.setName("object");
			symbol_425.setType(symbol_81);  // ocl|Set{T}?T
		...
		{	// ocl::Set::intersection() ocl|Set{T}|intersection(ocl|Set[ocl|Set{T}?T])
			...
			symbol_426.setType(symbol_139);  // ocl|Set[ocl|Set{T}?T]
			Parameter symbol_427 = PivotFactory.eINSTANCE.createParameter();
			symbol_427.setName("s");
			symbol_427.setType(symbol_139);  // ocl|Set[ocl|Set{T}?T]
		...
		{	// ocl::Set::reject() ocl|Set{T}|reject(ocl|Set{T}?T)
			...
			symbol_428.setType(symbol_139);  // ocl|Set[ocl|Set{T}?T]
			Parameter symbol_429 = PivotFactory.eINSTANCE.createParameter();
			symbol_429.setName("i");
			symbol_429.setType(symbol_81);  // ocl|Set{T}?T
		...
		{	// ocl::Set::select() ocl|Set{T}|select(ocl|Set{T}?T)
			...
			symbol_430.setType(symbol_139);  // ocl|Set[ocl|Set{T}?T]
			Parameter symbol_431 = PivotFactory.eINSTANCE.createParameter();
			symbol_431.setName("i");
			symbol_431.setType(symbol_81);  // ocl|Set{T}?T
		...
		{	// ocl::Set::symmetricDifference() ocl|Set{T}|symmetricDifference(ocl|Set[ocl|OclAny])
			...
			symbol_432.setType(symbol_139);  // ocl|Set[ocl|Set{T}?T]
			Parameter symbol_433 = PivotFactory.eINSTANCE.createParameter();
			symbol_433.setName("s");
			symbol_433.setType(symbol_131);  // ocl|Set[ocl|OclAny]
		...
		{	// ocl::String::=() ocl|String|=(ocl|OclAny)
			...
			symbol_442.setName("=");
			symbol_442.setType(symbol_19);  // ocl|Boolean
			...
			symbol_442.setPrecedence(symbol_4);
		...
		{	// ocl::String::>() ocl|String|>(ocl|String)
			...
			symbol_444.setName(">");
			symbol_444.setType(symbol_19);  // ocl|Boolean
			Parameter symbol_445 = PivotFactory.eINSTANCE.createParameter();
			symbol_445.setName("s");
			symbol_445.setType(symbol_85);  // ocl|String
		...
		{	// ocl::String::at() ocl|String|at(ocl|Integer)
			...
			symbol_448.setType(symbol_85);  // ocl|String
			Parameter symbol_449 = PivotFactory.eINSTANCE.createParameter();
			symbol_449.setName("i");
			symbol_449.setType(symbol_41);  // ocl|Integer
		...
		{	// ocl::String::characters() ocl|String|characters()
			...
			symbol_450.setType(symbol_126);  // ocl|Sequence[ocl|String]
		...
		{	// ocl::String::equalsIgnoreCase() ocl|String|equalsIgnoreCase(ocl|String)
			...
			symbol_453.setType(symbol_19);  // ocl|Boolean
			Parameter symbol_454 = PivotFactory.eINSTANCE.createParameter();
			symbol_454.setName("s");
			symbol_454.setType(symbol_85);  // ocl|String
		...
		{	// ocl::String::indexOf() ocl|String|indexOf(ocl|String)
			...
			symbol_455.setType(symbol_41);  // ocl|Integer
			Parameter symbol_456 = PivotFactory.eINSTANCE.createParameter();
			symbol_456.setName("s");
			symbol_456.setType(symbol_85);  // ocl|String
		...
		{	// ocl::String::size() ocl|String|size()
			...
			symbol_457.setType(symbol_41);  // ocl|Integer
		...
		{	// ocl::String::substring() ocl|String|substring(ocl|Integer,ocl|Integer)
			...
			symbol_460.setType(symbol_41);  // ocl|Integer
		...
		{	// ocl::String::toBoolean() ocl|String|toBoolean()
			...
			symbol_461.setType(symbol_19);  // ocl|Boolean
		...
		{	// ocl::String::toInteger() ocl|String|toInteger()
			...
			symbol_462.setType(symbol_41);  // ocl|Integer
		...
		{	// ocl::String::toLowerCase() ocl|String|toLowerCase()
			...
			symbol_463.setType(symbol_85);  // ocl|String
		...
		{	// ocl::String::toReal() ocl|String|toReal()
			...
			symbol_464.setType(symbol_67);  // ocl|Real
		...
		{	// ocl::String::toString() ocl|String|toString()
			...
			symbol_465.setType(symbol_85);  // ocl|String
		...
		{	// ocl::String::toUpperCase() ocl|String|toUpperCase()
			...
			symbol_466.setType(symbol_85);  // ocl|String
		...
		{ // ocl::Tuple::first ocl|Tuple{T1,T2}|first
			...
			symbol_467.setType(symbol_89);  // ocl|Tuple{T1,T2}?T1
		...
		{ // ocl::Tuple::second ocl|Tuple{T1,T2}|second
			...
			symbol_468.setType(symbol_91);  // ocl|Tuple{T1,T2}?T2
		...
		{	// ocl::UniqueCollection::sortedBy() ocl|UniqueCollection{T}|sortedBy(ocl|UniqueCollection{T}?T)
			...
			symbol_469.setType(symbol_119);  // ocl|OrderedSet[ocl|UniqueCollection{T}?T]
			Parameter symbol_470 = PivotFactory.eINSTANCE.createParameter();
			symbol_470.setName("i");
			symbol_470.setType(symbol_95);  // ocl|UniqueCollection{T}?T
		...
		symbol_98.setElementType(symbol_58);
		{
			...
			symbol_471.setSignature(symbol_13);
			{
				...
				symbol_472.setActual(symbol_24);	
		...
		symbol_100.setElementType(symbol_58);
		{
			...
			symbol_475.setSignature(symbol_13);
			{
				...
				symbol_476.setActual(symbol_15);	
		...
		symbol_101.setElementType(symbol_58);
		{
			...
			symbol_477.setSignature(symbol_13);
			{
				...
				symbol_478.setActual(symbol_45);	
		...
		symbol_102.setElementType(symbol_58);
		{
			...
			symbol_479.setSignature(symbol_22);
			{
				...
				symbol_480.setActual(symbol_24);	
		...
		symbol_103.setElementType(symbol_58);
		{
			...
			symbol_481.setSignature(symbol_22);
			{
				...
				symbol_482.setActual(symbol_39);	
		...
		symbol_104.setElementType(symbol_58);
		{
			...
			symbol_483.setSignature(symbol_22);
			{
				...
				symbol_484.setActual(symbol_33);	
		...
		symbol_106.setElementType(symbol_58);
		{
			...
			symbol_487.setSignature(symbol_22);
			{
				...
				symbol_488.setActual(symbol_45);	
		...
		symbol_107.setElementType(symbol_58);
		{
			...
			symbol_489.setSignature(symbol_22);
			{
				...
				symbol_490.setActual(symbol_62);	
		...
		symbol_108.setElementType(symbol_58);
		{
			...
			symbol_491.setSignature(symbol_22);
			{
				...
				symbol_492.setActual(symbol_30);	
		...
		symbol_110.setElementType(symbol_58);
		{
			...
			symbol_495.setSignature(symbol_22);
			{
				...
				symbol_496.setActual(symbol_27);	
		...
		symbol_111.setElementType(symbol_58);
		{
			...
			symbol_497.setSignature(symbol_43);
			{
				...
				symbol_498.setActual(symbol_81);	
		...
		symbol_112.setElementType(symbol_58);
		{
			...
			symbol_499.setSignature(symbol_43);
			{
				...
				symbol_500.setActual(symbol_15);	
		...
		symbol_116.setElementType(symbol_58);
		{
			...
			symbol_507.setSignature(symbol_60);
			{
				...
				symbol_508.setActual(symbol_66);	
		...
		symbol_117.setElementType(symbol_58);
		{
			...
			symbol_509.setSignature(symbol_60);
			{
				...
				symbol_510.setActual(symbol_24);	
		...
		symbol_119.setElementType(symbol_58);
		{
			...
			symbol_513.setSignature(symbol_64);
			{
				...
				symbol_514.setActual(symbol_95);	
		...
		symbol_120.setElementType(symbol_58);
		{
			...
			symbol_515.setSignature(symbol_64);
			{
				...
				symbol_516.setActual(symbol_66);	
		...
		symbol_121.setElementType(symbol_58);
		{
			...
			symbol_517.setSignature(symbol_64);
			{
				...
				symbol_518.setActual(symbol_62);	
		...
		symbol_123.setElementType(symbol_58);
		{
			...
			symbol_521.setSignature(symbol_72);
			{
				...
				symbol_522.setActual(symbol_62);	
		...
		symbol_124.setElementType(symbol_58);
		{
			...
			symbol_523.setSignature(symbol_72);
			{
				...
				symbol_524.setActual(symbol_77);	
		...
		symbol_125.setElementType(symbol_58);
		{
			...
			symbol_525.setSignature(symbol_72);
			{
				...
				symbol_526.setActual(symbol_49);	
		...
		symbol_129.setElementType(symbol_58);
		{
			...
			symbol_533.setSignature(symbol_79);
			{
				...
				symbol_534.setActual(symbol_141);	
		...
		symbol_131.setElementType(symbol_58);
		{
			...
			symbol_537.setSignature(symbol_79);
			{
				...
				symbol_538.setActual(symbol_50);	
		...
		symbol_133.setElementType(symbol_58);
		{
			...
			symbol_541.setSignature(symbol_79);
			{
				...
				symbol_542.setActual(symbol_40);	
		...
		symbol_135.setElementType(symbol_58);
		{
			...
			symbol_545.setSignature(symbol_79);
			{
				...
				symbol_546.setActual(symbol_20);	
		...
		symbol_136.setElementType(symbol_58);
		{
			...
			symbol_547.setSignature(symbol_79);
			{
				...
				symbol_548.setActual(symbol_45);	
		...
		symbol_137.setElementType(symbol_58);
		{
			...
			symbol_549.setSignature(symbol_79);
			{
				...
				symbol_550.setActual(symbol_19);	
		...
		symbol_138.setElementType(symbol_58);
		{
			...
			symbol_551.setSignature(symbol_79);
			{
				...
				symbol_552.setActual(symbol_58);	
