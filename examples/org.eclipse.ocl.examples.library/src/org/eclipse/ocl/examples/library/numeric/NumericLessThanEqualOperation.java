 ...
 * </copyright>
 *
 * $Id: NumericLessThanEqualOperation.java,v 1.1.2.4 2011/01/08 15:34:42 ewillink Exp $
 */
...
{
	public static final NumericLessThanEqualOperation INSTANCE = new NumericLessThanEqualOperation();
	...
	protected BooleanValue evaluateUnlimited(ValueFactory valueFactory, Value left, Value right) {
		return valueFactory.booleanValueOf(right.isUnlimited());
	}
}
