 ...
 * </copyright>
 *
 * $Id: OclAnyOclIsTypeOfOperation.java,v 1.1.2.6 2011/01/08 15:34:42 ewillink Exp $
 */
...
public class OclAnyOclIsTypeOfOperation extends AbstractOperation
{
	...
	public Value evaluate(EvaluationVisitor evaluationVisitor, Value sourceVal, OperationCallExp operationCall) {
		...
		return valueFactory.booleanValueOf(stdlib.conformsTo(sourceType, argType) && stdlib.conformsTo(argType, sourceType));
	}
}
