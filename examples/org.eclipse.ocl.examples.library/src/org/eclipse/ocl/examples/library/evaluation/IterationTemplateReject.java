 ...
 * </copyright>
 *
 * $Id: IterationTemplateReject.java,v 1.1.2.1 2010/10/01 13:28:35 ewillink Exp $
 */
...
public class IterationTemplateReject extends IterationTemplate {
	...
	private IterationTemplateReject(EvaluationContext evaluationContext) {
		super(evaluationContext);
	}
	
	public static IterationTemplate getInstance(EvaluationContext evaluationContext) {
		return new IterationTemplateReject(evaluationContext);
	}
