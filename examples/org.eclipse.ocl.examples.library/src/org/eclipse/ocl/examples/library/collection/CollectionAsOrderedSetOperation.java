 ...
 * </copyright>
 *
 * $Id: CollectionAsOrderedSetOperation.java,v 1.1.2.1 2010/10/01 13:28:35 ewillink Exp $
 */
 ...
 * @since 3.1
 */
public class CollectionAsOrderedSetOperation extends AbstractCollectionUnaryOperation
{
	...
	protected Object evaluateCollection(Collection<?> sourceVal) {
		return CollectionUtil.asOrderedSet(sourceVal);
	}
}
