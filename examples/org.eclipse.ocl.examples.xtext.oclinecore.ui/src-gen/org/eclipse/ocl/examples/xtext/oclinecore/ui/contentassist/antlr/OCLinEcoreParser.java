		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getNavigatingExpCSAccess().getGroup_1_2_1(), "rule__NavigatingExpCS__Group_1_2_1__0");
					put(grammarAccess.getNavigatingExpCSAccess().getGroup_1_2_2(), "rule__NavigatingExpCS__Group_1_2_2__0");
					put(grammarAccess.getNavigatingExpCSAccess().getGroup_1_2_2_2(), "rule__NavigatingExpCS__Group_1_2_2_2__0");
					put(grammarAccess.getNavigatingExpCSAccess().getGroup_1_2_3(), "rule__NavigatingExpCS__Group_1_2_3__0");
					put(grammarAccess.getNavigatingExpCSAccess().getGroup_1_2_3_2(), "rule__NavigatingExpCS__Group_1_2_3_2__0");
					put(grammarAccess.getNavigatingArgOrBodyCSAccess().getGroup(), "rule__NavigatingArgOrBodyCS__Group__0");
					put(grammarAccess.getNavigatingArgOrBodyCSAccess().getGroup_1(), "rule__NavigatingArgOrBodyCS__Group_1__0");
					put(grammarAccess.getNavigatingAccCSAccess().getGroup(), "rule__NavigatingAccCS__Group__0");
					...
					put(grammarAccess.getNavigatingExpCSAccess().getArgumentAssignment_1_2_1_1(), "rule__NavigatingExpCS__ArgumentAssignment_1_2_1_1");
					...
					put(grammarAccess.getNavigatingExpCSAccess().getArgumentAssignment_1_2_2_2_1(), "rule__NavigatingExpCS__ArgumentAssignment_1_2_2_2_1");
					...
					put(grammarAccess.getNavigatingExpCSAccess().getArgumentAssignment_1_2_3_2_1(), "rule__NavigatingExpCS__ArgumentAssignment_1_2_3_2_1");
					put(grammarAccess.getNavigatingArgOrBodyCSAccess().getNameAssignment_0(), "rule__NavigatingArgOrBodyCS__NameAssignment_0");
					put(grammarAccess.getNavigatingArgOrBodyCSAccess().getOwnedTypeAssignment_1_1(), "rule__NavigatingArgOrBodyCS__OwnedTypeAssignment_1_1");
					put(grammarAccess.getNavigatingAccCSAccess().getNameAssignment_0(), "rule__NavigatingAccCS__NameAssignment_0");
					put(grammarAccess.getNavigatingAccCSAccess().getOwnedTypeAssignment_2(), "rule__NavigatingAccCS__OwnedTypeAssignment_2");
					put(grammarAccess.getNavigatingAccCSAccess().getInitAssignment_4(), "rule__NavigatingAccCS__InitAssignment_4");
					put(grammarAccess.getNavigatingBodyCSAccess().getNameAssignment(), "rule__NavigatingBodyCS__NameAssignment");
