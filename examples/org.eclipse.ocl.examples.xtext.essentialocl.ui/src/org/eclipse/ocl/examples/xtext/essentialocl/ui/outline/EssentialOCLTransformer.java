 ...
 * </copyright>
 *
 * $Id: EssentialOCLTransformer.java,v 1.3.6.1 2010/10/01 15:04:04 ewillink Exp $
 */
 ...
 * 
 */
public class EssentialOCLTransformer extends BaseTransformer
{
	public List<EObject> getChildren(CollectionLiteralExpCS csElement) {
		List<EObject> contents = new ArrayList<EObject>();
		addContents(contents, csElement.getOwnedParts());
		return contents;
	}
...
/*	public List<EObject> getChildren(RoundBracketExpCS csElement) {
	...
	public List<EObject> getChildren(LetVariableCS csElement) {
		List<EObject> contents = new ArrayList<EObject>();
