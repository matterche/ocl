 ...
 * </copyright>
 *
 * $Id: NullLiteralExpCSImpl.java,v 1.2.6.1 2010/12/06 18:03:07 ewillink Exp $
 */
...
public class NullLiteralExpCSImpl extends PrimitiveLiteralExpCSImpl implements NullLiteralExpCS {
	...
	protected EClass eStaticClass() {
		return EssentialOCLCSTPackage.Literals.NULL_LITERAL_EXP_CS;
	}

	@SuppressWarnings("unchecked")
	@Override
	public <R, C> R accept(BaseCSVisitor<R, C> visitor) {
		return (R) visitor.getAdapter(EssentialOCLCSVisitor.class).visitNullLiteralExpCS(this);
	}
