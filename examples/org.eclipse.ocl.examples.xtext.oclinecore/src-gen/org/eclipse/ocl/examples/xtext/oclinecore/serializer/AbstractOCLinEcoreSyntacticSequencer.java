...
public class AbstractOCLinEcoreSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_OperationCS_ColonKeyword_7_0_q;
	...
	protected void init(IGrammarAccess access) {
		...
		match_AttributeCS_CommaKeyword_5_1_1_q = new TokenAlias(true, false, grammarAccess.getAttributeCSAccess().getCommaKeyword_5_1_1());
		...
		match_DataTypeCS___LeftCurlyBracketKeyword_4_0_RightCurlyBracketKeyword_4_2__q = new GroupAlias(true, false, new TokenAlias(false, false, grammarAccess.getDataTypeCSAccess().getLeftCurlyBracketKeyword_4_0()), new TokenAlias(false, false, grammarAccess.getDataTypeCSAccess().getRightCurlyBracketKeyword_4_2()));
		...
		match_EnumerationCS___LeftCurlyBracketKeyword_4_0_RightCurlyBracketKeyword_4_2__q = new GroupAlias(true, false, new TokenAlias(false, false, grammarAccess.getEnumerationCSAccess().getLeftCurlyBracketKeyword_4_0()), new TokenAlias(false, false, grammarAccess.getEnumerationCSAccess().getRightCurlyBracketKeyword_4_2()));
		...
		match_InvariantConstraintCS_ColonKeyword_3_0_q = new TokenAlias(true, false, grammarAccess.getInvariantConstraintCSAccess().getColonKeyword_3_0());
		match_OperationCS_ColonKeyword_7_0_q = new TokenAlias(true, false, grammarAccess.getOperationCSAccess().getColonKeyword_7_0());
		match_OperationCS_CommaKeyword_9_1_1_q = new TokenAlias(true, false, grammarAccess.getOperationCSAccess().getCommaKeyword_9_1_1());
		...
		match_ParameterCS_CommaKeyword_2_1_1_q = new TokenAlias(true, false, grammarAccess.getParameterCSAccess().getCommaKeyword_2_1_1());
		match_ParameterCS___LeftCurlyBracketKeyword_3_0_RightCurlyBracketKeyword_3_2__q = new GroupAlias(true, false, new TokenAlias(false, false, grammarAccess.getParameterCSAccess().getLeftCurlyBracketKeyword_3_0()), new TokenAlias(false, false, grammarAccess.getParameterCSAccess().getRightCurlyBracketKeyword_3_2()));
		match_ReferenceCS_CommaKeyword_6_1_1_q = new TokenAlias(true, false, grammarAccess.getReferenceCSAccess().getCommaKeyword_6_1_1());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if(match_OperationCS_ColonKeyword_7_0_q.equals(syntax))
				emit_OperationCS_ColonKeyword_7_0_q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     ':'?
	 */
	protected void emit_OperationCS_ColonKeyword_7_0_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
