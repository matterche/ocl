...
(
		{ 
	        newCompositeNode(grammarAccess.getLibraryAccess().getOwnedLibraryLibraryCSParserRuleCall_0_0_0()); 
	    }
		lv_ownedLibrary_0_0=ruleLibraryCS		{
	        if ($current==null) {
...
(
		{ 
	        newCompositeNode(grammarAccess.getLibraryAccess().getNameNameParserRuleCall_2_0()); 
	    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getLibraryAccess().getNsPrefixIdentifierParserRuleCall_3_1_0()); 
	    }
		lv_nsPrefix_5_0=ruleIdentifier		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getLibraryRule());
	        }
       		set(
...
(
		{ 
	        newCompositeNode(grammarAccess.getLibraryAccess().getNsURIURIParserRuleCall_3_3_0()); 
	    }
		lv_nsURI_7_0=ruleURI		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getLibraryRule());
	        }
       		set(
...
(
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getRestrictedKeywordsAccess().getIterationKeyword_6()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getRestrictedKeywordsAccess().getLeftKeyword_7()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getRestrictedKeywordsAccess().getLibraryKeyword_8()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getRestrictedKeywordsAccess().getOperationKeyword_9()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getRestrictedKeywordsAccess().getPackageKeyword_10()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getRestrictedKeywordsAccess().getPostKeyword_11()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getRestrictedKeywordsAccess().getPreKeyword_12()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getRestrictedKeywordsAccess().getPrecedenceKeyword_13()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getRestrictedKeywordsAccess().getPropertyKeyword_14()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getRestrictedKeywordsAccess().getRightKeyword_15()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getRestrictedKeywordsAccess().getStaticKeyword_16()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getRestrictedKeywordsAccess().getSuperKeyword_17()); 
    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getLibPathNameCSAccess().getPathLibPathElementCSParserRuleCall_0_0()); 
	    }
		lv_path_0_0=ruleLibPathElementCS		{
	        if ($current==null) {
...
(
		{ 
	        newCompositeNode(grammarAccess.getLibPathNameCSAccess().getPathLibPathElementCSParserRuleCall_1_1_0()); 
	    }
		lv_path_2_0=ruleLibPathElementCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getLibPathNameCSRule());
	        }
       		add(
...
(
		...
		{ 
	        newCompositeNode(grammarAccess.getLibPathElementCSAccess().getElementNamedElementCrossReference_0()); 
	    }
		ruleName		{ 
	        afterParserOrEnumRuleCall();
	    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getLibTupleCSAccess().getOwnedPartsLibTuplePartCSParserRuleCall_2_0_0()); 
	    }
		lv_ownedParts_2_0=ruleLibTuplePartCS		{
	        if ($current==null) {
...
(
		{ 
	        newCompositeNode(grammarAccess.getLibTupleCSAccess().getOwnedPartsLibTuplePartCSParserRuleCall_2_1_1_0()); 
	    }
		lv_ownedParts_4_0=ruleLibTuplePartCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getLibTupleCSRule());
	        }
       		add(
