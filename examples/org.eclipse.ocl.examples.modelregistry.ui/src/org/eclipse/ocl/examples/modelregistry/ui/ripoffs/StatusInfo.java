 ...
 * </copyright>
 *
 * $Id: StatusInfo.java,v 1.2 2010/04/08 06:25:59 ewillink Exp $
 */
...
public class StatusInfo implements IStatus {
	...
	public StatusInfo(Exception e) {
		fStatusMessage= e.getClass().getName() + ":" + e.getMessage();
		fSeverity= ERROR;
	}
	...
	public String getPlugin() {
		return ModelRegistryUIPlugin.PLUGIN_ID;
	}
