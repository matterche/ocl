...
/**
 * Entry point of the 'GenerateJavaTables' generation module.
 *
 * @generated
 */
public class GenerateJavaTables extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/org/eclipse/ocl/examples/build/acceleo/generateJavaTables";
     ...
     * @generated
     */
    public GenerateJavaTables(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public GenerateJavaTables(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                GenerateJavaTables generator = new GenerateJavaTables(modelURI, folder, arguments);
