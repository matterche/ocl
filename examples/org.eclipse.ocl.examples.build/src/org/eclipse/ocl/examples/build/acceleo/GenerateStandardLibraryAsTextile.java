 ...
 * @generated
 */
public class GenerateStandardLibraryAsTextile extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/org/eclipse/ocl/examples/build/acceleo/generateStandardLibraryAsTextile";
     ...
     * @generated
     */
    public GenerateStandardLibraryAsTextile() {
     ...
     * @generated
     */
    public GenerateStandardLibraryAsTextile(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public GenerateStandardLibraryAsTextile(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                GenerateStandardLibraryAsTextile generator = new GenerateStandardLibraryAsTextile(modelURI, folder, arguments);
...
//	    }
	...
	/**
	 * Overridden to replace loaded Xtext CST model by Pivot AST model.
	 */
	@Override
	public void initialize(EObject element, File folder, List<? extends Object> arguments) throws IOException {
		...
		if (model instanceof ModelElementCS) {
			model = ((ModelElementCS)model).getPivot();
		}
	}
