...
/**
 * Entry point of the 'GenerateGenModel' generation module.
 *
 * @generated
 */
public class GenerateGenModel extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/org/eclipse/ocl/examples/build/acceleo/generateGenModel";
     ...
     * @generated
     */
    public GenerateGenModel(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public GenerateGenModel(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                GenerateGenModel generator = new GenerateGenModel(modelURI, folder, arguments);
