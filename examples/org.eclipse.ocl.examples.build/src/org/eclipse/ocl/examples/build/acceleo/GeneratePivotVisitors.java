...
/**
 * Entry point of the 'GeneratePivotVisitors' generation module.
 *
 * @generated
 */
public class GeneratePivotVisitors extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "/org/eclipse/ocl/examples/build/acceleo/generatePivotVisitors";
  ...
  /**
	 ...
	 * @generated
	 */
	public GeneratePivotVisitors(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public GeneratePivotVisitors(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
	...
	public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                GeneratePivotVisitors generator = new GeneratePivotVisitors(modelURI, folder, arguments);
