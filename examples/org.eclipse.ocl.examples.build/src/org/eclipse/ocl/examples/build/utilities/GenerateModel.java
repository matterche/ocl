 ...
 * </copyright>
 *
 * $Id: GenerateModel.java,v 1.1.2.1 2010/08/08 11:15:11 ewillink Exp $
 */
...
{	
	...
	public void invokeInternal(WorkflowContext ctx, ProgressMonitor arg1, Issues arg2) {
		ASTFacadeHelper.class.getClass();
...
//			EcoreUtil.resolveAll(resourceSet); -- genModel can fail if proxies resolved here
//				problem arises if genmodel has an obsolete feature for a feature moved up the inheritance hierarchy
//				since the proxy seems to be successfully resolved giving a double feature
...
//			genModel.setRootExtendsClass("org.eclipse.emf.ecore.impl.MinimalEObjectImpl$Container");
	...
	/*		JavaModelManager.getJavaModelManager().initializePreferences();
			...
			String complianceLevel = JavaCore.VERSION_1_5;
			switch (genSDKcomplianceLevel) {
				case JDK60_LITERAL:
					complianceLevel = JavaCore.VERSION_1_6;
				case JDK14_LITERAL:
					complianceLevel = JavaCore.VERSION_1_4;
				default:
					complianceLevel = JavaCore.VERSION_1_5;
			}
