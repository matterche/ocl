...
/**
 * Entry point of the 'GenerateJavaOperations' generation module.
 *
 * @generated
 */
public class GenerateJavaOperations extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/org/eclipse/ocl/examples/build/acceleo/generateJavaOperations";
     ...
     * @generated
     */
    public GenerateJavaOperations(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public GenerateJavaOperations(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                GenerateJavaOperations generator = new GenerateJavaOperations(modelURI, folder, arguments);
