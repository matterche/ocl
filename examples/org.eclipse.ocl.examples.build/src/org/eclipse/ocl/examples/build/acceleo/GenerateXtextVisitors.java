...
/**
 * Entry point of the 'GenerateXtextVisitors' generation module.
 *
 * @generated
 */
public class GenerateXtextVisitors extends AbstractAcceleoGenerator {
	/**
  ...
  /**
	 ...
	 * @generated
	 */
	public GenerateXtextVisitors(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public GenerateXtextVisitors(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
	...
	public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                GenerateXtextVisitors generator = new GenerateXtextVisitors(modelURI, folder, arguments);
