...
protected class ThisRootNode extends RootToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			...
			case 51: return new BinaryOperatorCS_NameAssignment(this, this, 51, inst);
			case 52: return new PrefixedExpCS_Alternatives(this, this, 52, inst);
			...
			case 55: return new NameExpCS_Alternatives(this, this, 55, inst);
			case 56: return new IndexExpCS_Group(this, this, 56, inst);
...
protected class NavigatingExpCS_Base_Group extends GroupToken {
	...
	public IEObjectConsumer tryConsume() {
		if(getEObject().eClass() != grammarAccess.getIndexExpCSAccess().getIndexExpCSNameAction_1_0().getType().getClassifier() && 
		   ...
		   getEObject().eClass() != grammarAccess.getNavigatingExpCS_BaseAccess().getPreExpCSNameAction_1_0().getType().getClassifier())
			return null;
		return eObjectConsumer;
	}
...
protected class NavigatingExpCS_Base_Group_1 extends GroupToken {
    ...
    @Override
	public IEObjectConsumer tryConsume() {
		if(getEObject().eClass() != grammarAccess.getNavigatingExpCS_BaseAccess().getPreExpCSNameAction_1_0().getType().getClassifier())
			return null;
		return eObjectConsumer;
	}
...
protected class NavigatingExpCS_Base_PreExpCSNameAction_1_0 extends ActionToken  {

	public NavigatingExpCS_Base_PreExpCSNameAction_1_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Action getGrammarElement() {
		return grammarAccess.getNavigatingExpCS_BaseAccess().getPreExpCSNameAction_1_0();
	}
...
protected class NavigatingExpCS_Base_CommercialAtKeyword_1_1 extends KeywordToken  {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new NavigatingExpCS_Base_PreExpCSNameAction_1_0(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
