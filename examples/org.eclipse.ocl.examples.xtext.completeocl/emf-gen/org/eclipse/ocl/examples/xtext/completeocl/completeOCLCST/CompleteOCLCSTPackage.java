...
public interface CompleteOCLCSTPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int CONTEXT_DECL_CS__ERROR = BaseCSTPackage.MODEL_ELEMENT_CS__ERROR;
	 ...
	 * @ordered
	 */
	int CONTEXT_DECL_CS_FEATURE_COUNT = BaseCSTPackage.MODEL_ELEMENT_CS_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int CLASSIFIER_CONTEXT_DECL_CS__ERROR = CONTEXT_DECL_CS__ERROR;
	 ...
	 * @ordered
	 */
	int COMPLETE_OCL_DOCUMENT_CS__ERROR = BaseCSTPackage.ROOT_PACKAGE_CS__ERROR;
	 ...
	 * @ordered
	 */
	int FEATURE_CONTEXT_DECL_CS__ERROR = CONTEXT_DECL_CS__ERROR;
	 ...
	 * @ordered
	 */
	int OCL_MESSAGE_ARG_CS__ERROR = EssentialOCLCSTPackage.EXP_CS__ERROR;
	 ...
	 * @ordered
	 */
	int OPERATION_CONTEXT_DECL_CS__ERROR = FEATURE_CONTEXT_DECL_CS__ERROR;
	 ...
	 * @ordered
	 */
	int PACKAGE_DECLARATION_CS__ERROR = BaseCSTPackage.MONIKERED_ELEMENT_CS__ERROR;
	 ...
	 * @ordered
	 */
	int PACKAGE_DECLARATION_CS__PACKAGE = BaseCSTPackage.MONIKERED_ELEMENT_CS_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int PACKAGE_DECLARATION_CS__CONTEXTS = BaseCSTPackage.MONIKERED_ELEMENT_CS_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int PACKAGE_DECLARATION_CS_FEATURE_COUNT = BaseCSTPackage.MONIKERED_ELEMENT_CS_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int PROPERTY_CONTEXT_DECL_CS__ERROR = FEATURE_CONTEXT_DECL_CS__ERROR;
