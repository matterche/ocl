 ...
 * </copyright>
 *
 * $Id: ClosureIteration.java,v 1.1.2.1 2010/01/31 22:23:44 ewillink Exp $
 */
...
//		boolean isUnique = sourceType.isUnique();
		Object initResultVal = CollectionUtil.createNewCollection(isOrdered, true);
		...
		IterationTemplate<PK, C, O, P, EL, PM, S, COA, SSA, CT, CLS, E> template =
			IterationTemplateClosure.getInstance(evaluationVisitor, body);
