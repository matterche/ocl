 ...
 * </copyright>
 *
 * $Id: OCLMetaModelOperationImpl.java,v 1.1.2.1 2010/01/30 07:49:13 ewillink Exp $
 */
...
import org.eclipse.ocl.library.impl.OCLOperationImpl;
 ...
 * <ul>
 *   <li>{@link org.eclipse.ocl.library.merged.impl.OCLMetaModelOperationImpl#getMetaModelElement <em>Meta Model Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class OCLMetaModelOperationImpl extends OCLOperationImpl implements OCLMetaModelOperation {
	...
	protected EClass eStaticClass() {
		return OCLMergedLibraryPackage.Literals.OCL_META_MODEL_OPERATION;
	}
		...
		if (metaModelElement != null && metaModelElement.eIsProxy()) {
			...
			if (metaModelElement != oldMetaModelElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OCLMergedLibraryPackage.OCL_META_MODEL_OPERATION__META_MODEL_ELEMENT, oldMetaModelElement, metaModelElement));
			}
		}
	...
	public void setMetaModelElement(EObject newMetaModelElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OCLMergedLibraryPackage.OCL_META_MODEL_OPERATION__META_MODEL_ELEMENT, oldMetaModelElement, metaModelElement));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OCLMergedLibraryPackage.OCL_META_MODEL_OPERATION__META_MODEL_ELEMENT:
