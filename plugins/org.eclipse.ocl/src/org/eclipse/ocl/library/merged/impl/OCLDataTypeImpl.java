 ...
 * </copyright>
 *
 * $Id: OCLDataTypeImpl.java,v 1.1.2.1 2010/01/30 07:49:14 ewillink Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.ocl.library.merged.impl.OCLDataTypeImpl#getMetaModelElement <em>Meta Model Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class OCLDataTypeImpl extends OCLConcreteTypeImpl implements OCLDataType {
	/**
	...
	protected EClass eStaticClass() {
		return OCLMergedLibraryPackage.Literals.OCL_DATA_TYPE;
	}
		...
		if (metaModelElement != null && metaModelElement.eIsProxy()) {
			...
			if (metaModelElement != oldMetaModelElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OCLMergedLibraryPackage.OCL_DATA_TYPE__META_MODEL_ELEMENT, oldMetaModelElement, metaModelElement));
			}
		}
	...
	public void setMetaModelElement(EObject newMetaModelElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OCLMergedLibraryPackage.OCL_DATA_TYPE__META_MODEL_ELEMENT, oldMetaModelElement, metaModelElement));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OCLMergedLibraryPackage.OCL_DATA_TYPE__META_MODEL_ELEMENT:
