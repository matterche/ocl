 ...
 * <ul>
 *   <li>{@link org.eclipse.ocl.library.impl.OCLMetaModelOperationImpl#getMetaModelElement <em>Meta Model Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class OCLMetaModelOperationImpl extends OCLOperationImpl implements OCLMetaModelOperation {
	/**
		...
		if (metaModelElement != null && metaModelElement.eIsProxy()) {
			...
			if (metaModelElement != oldMetaModelElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LibraryPackage.OCL_META_MODEL_OPERATION__META_MODEL_ELEMENT, oldMetaModelElement, metaModelElement));
			}
		}
	...
	public void setMetaModelElement(EObject newMetaModelElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LibraryPackage.OCL_META_MODEL_OPERATION__META_MODEL_ELEMENT, oldMetaModelElement, metaModelElement));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LibraryPackage.OCL_META_MODEL_OPERATION__META_MODEL_ELEMENT:
