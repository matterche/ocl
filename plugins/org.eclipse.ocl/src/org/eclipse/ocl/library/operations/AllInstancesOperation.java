 ...
 * </copyright>
 *
 * $Id: AllInstancesOperation.java,v 1.1.2.1 2010/01/20 06:08:19 ewillink Exp $
 */
...
/**
 * AllInstancesOperation realises the allInstances() library operation.
 * 
 * @since 3.0
 */
public class AllInstancesOperation extends AbstractOperation
{
	@Override
	public Object evaluate(EvaluationVisitor<?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?> visitor, Object sourceVal, OperationCallExp<?, ?> operationCall) {
		...
		if (sourceType instanceof OCLEnumeration) {
			...
			result.add(library.getInvalid());		// FIXME investigate/test
		}
