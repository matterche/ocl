 ...
 * </copyright>
 *
 * $Id: CollectionSumOperation.java,v 1.1.2.2 2010/01/31 08:43:26 ewillink Exp $
 */
...
import org.eclipse.ocl.library.operations.numeric.NumericPlusOperation;
...
public class CollectionSumOperation extends AbstractCollectionUnaryOperation
{
	...
	protected Object evaluateCollection(Collection<?> sourceVal) {
		...
		return CollectionUtil.sum(sourceVal, new NumericPlusOperation(), BigInteger.ZERO);
	}
}
