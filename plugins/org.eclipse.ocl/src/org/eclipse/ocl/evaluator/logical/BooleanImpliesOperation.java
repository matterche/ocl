 ...
 * </copyright>
 *
 * $Id: BooleanImpliesOperation.java,v 1.1.2.1 2010/01/18 08:57:53 ewillink Exp $
 */
 ...
 * @since 3.0
 */
public class BooleanImpliesOperation extends AbstractOperation
{
	@Override
	public Object evaluate(EvaluationVisitor<?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?> visitor, Object sourceVal, OperationCallExp<?, ?> operationCall) {
		...
		else if ((sourceVal == Boolean.TRUE) && (argVal == Boolean.FALSE)) {
