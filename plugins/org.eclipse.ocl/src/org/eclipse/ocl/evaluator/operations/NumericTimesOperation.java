 ...
 * </copyright>
 *
 * $Id: NumericTimesOperation.java,v 1.1.2.1 2010/01/03 22:53:49 ewillink Exp $
 */
 ...
 * @since 3.0
 */
public class NumericTimesOperation extends NumericBinaryOperation
{
	@Override
	protected Object evaluateBigDecimal(Limitation limitation, BigDecimal left, BigDecimal right, Object leftVal, Object rightVal) {
		switch (limitation) {
			case LIMITED_LIMITED: return left.multiply(right);
			default: return null;
		}
	}
