 ...
 * </copyright>
 *
 * $Id: NumericModOperation.java,v 1.1.2.1 2010/01/03 22:53:48 ewillink Exp $
 */
 ...
 * @since 3.0
 */
public class NumericModOperation extends NumericBinaryOperation
{
	@Override
	protected Object evaluateBigInteger(Limitation limitation, BigInteger left, BigInteger right, Object leftVal, Object rightVal) {
		switch (limitation) {
			case LIMITED_LIMITED: return left.mod(right);
			default: return null;
		}
	}
