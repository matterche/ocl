 ...
 * </copyright>
 *
 * $Id: StringConcatOperation.java,v 1.1.2.1 2010/01/03 22:53:49 ewillink Exp $
 */
 ...
 * @since 3.0
 */
public class StringConcatOperation extends AbstractOperation
{
	@Override
	public Object evaluate(EvaluationVisitor<?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?> visitor, OperationCallExp<?, ?> operationCall) {
		...
		if (isString(sourceVal) && isString(argVal)) {
			return String.valueOf(sourceVal).concat(String.valueOf(argVal));
		}			
		return null;
	}
}
