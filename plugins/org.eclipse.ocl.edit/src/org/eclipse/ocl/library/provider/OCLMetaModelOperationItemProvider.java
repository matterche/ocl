 ...
 * </copyright>
 *
 * $Id: OCLMetaModelOperationItemProvider.java,v 1.1.2.1 2009/12/13 21:20:34 ewillink Exp $
 */
...
public class OCLMetaModelOperationItemProvider
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/OCLMetaModelOperation"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_OCLMetaModelOperation_type") :
			getString("_UI_OCLMetaModelOperation_type") + " " + label;
	}
