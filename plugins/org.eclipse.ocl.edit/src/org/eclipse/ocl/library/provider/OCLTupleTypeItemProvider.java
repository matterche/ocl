 ...
 * </copyright>
 *
 * $Id: OCLTupleTypeItemProvider.java,v 1.1.2.2 2010/01/24 07:40:31 ewillink Exp $
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OCLTupleType_metaModelElement_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_OCLTupleType_metaModelElement_feature", "_UI_OCLTupleType_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 LibraryPackage.Literals.OCL_TUPLE_TYPE__META_MODEL_ELEMENT,
				 true,
				 false,
				 true,
				 null,
