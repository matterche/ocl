 ...
 * </copyright>
 *
 * $Id: OCLElementItemProvider.java,v 1.1.2.1 2009/12/13 21:20:34 ewillink Exp $
 */
...
public class OCLElementItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OCLElement_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OCLElement_name_feature", "_UI_OCLElement_type"),
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/OCLElement"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_OCLElement_type") :
			getString("_UI_OCLElement_type") + " " + label;
	}
